...
tag @s[scores={Time=61}] remove idle
...
execute if entity @s[scores={Time=71},tag=has_target] run playsound medabots_server:entity.crazy_hand.grab hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=71},tag=!has_target] run playsound medabots_server:entity.crazy_hand.grab_miss hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={Time=90},tag=has_target] run playsound medabots_server:entity.crazy_hand.grab_hit hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=110}] run effect give @e[tag=target,limit=1] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=110}] run playsound medabots_server:entity.crazy_hand.grab_hit hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=130}] run effect give @e[tag=target,limit=1] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=130}] run playsound medabots_server:entity.crazy_hand.grab_hit hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={Time=150}] run playsound medabots_server:entity.crazy_hand.grab_throw hostile @a ~ ~ ~ 1
