...
execute if entity @s[scores={Time=1}] run playsound medabots_server:entity.crazy_hand.rocket_start hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={Time=31}] run playsound medabots_server:entity.crazy_hand.rocket_background hostile @a ^ ^-10 ^17 1
...
execute if entity @s[scores={Time=50}] run playsound medabots_server:entity.crazy_hand.rocket_foreground hostile @a ^ ^ ^ 1
...
execute at @s[scores={Time=81}] run playsound medabots_server:entity.crazy_hand.rocket_stop hostile @a ~ ~ ~ 1
execute at @s[scores={Time=81}] at @s run teleport @s ^ ^ ^-20
