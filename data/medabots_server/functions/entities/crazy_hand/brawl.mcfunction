...
execute if entity @s[tag=dying,tag=!dead] run playsound medabots_server:entity.crazy_hand.final_hit3 hostile @a ~ ~ ~ 1
execute if entity @s[tag=dying,tag=!dead] run playsound medabots_server:entity.crazy_hand.death3 hostile @a ~ ~ ~ 1
...
# Set bossbar health
execute store result bossbar medabots_server:crazy_hand/3 value run data get entity @s AbsorptionAmount