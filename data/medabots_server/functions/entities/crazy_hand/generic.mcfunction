...
execute if entity @s[scores={Dialog=30}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","fake_out"],Duration:1}
#execute if entity @s[scores={Dialog=30}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","triple_punch"],Duration:1}
...
#execute if entity @s[scores={Dialog=29}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","rip"],Duration:1}
#execute if entity @s[scores={Dialog=29}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","pink_pillar"],Duration:1}
#execute if entity @s[scores={Dialog=29}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","shadowball_bash"],Duration:1}
...
execute if entity @s[scores={Dialog=29}] if entity @e[distance=..1,tag=random_select,tag=selected,tag=triple_punch] run tag @s add attack_triple_punch
...
execute if entity @s[scores={Dialog=29}] if entity @e[distance=..1,tag=random_select,tag=selected,tag=rip] run tag @s add attack_rip
execute if entity @s[scores={Dialog=29}] if entity @e[distance=..1,tag=random_select,tag=selected,tag=pink_pillars] run tag @s add attack_pink_pillars
execute if entity @s[scores={Dialog=29}] if entity @e[distance=..1,tag=random_select,tag=selected,tag=shadowball_bash] run tag @s add attack_shadowball_bash
...
execute if entity @s[tag=attack_ball_throw] run function medabots_server:entities/crazy_hand/juggle
...
execute if entity @s[tag=attack_triple_punch] run function medabots_server:entities/crazy_hand/triple_punch
