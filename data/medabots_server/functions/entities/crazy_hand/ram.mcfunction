...
execute if entity @s[scores={Time=31}] run playsound medabots_server:entity.crazy_hand.background_punch hostile @a ^ ^-10 ^17 1
...
execute if entity @s[scores={Time=21..80}] run effect give @e[tag=potential_target,distance=..3] minecraft:instant_damage 1 1 true
...
execute at @s[scores={Time=81}] run playsound medabots_server:entity.crazy_hand.background_punch_stop hostile @a ~ ~ ~ 1
