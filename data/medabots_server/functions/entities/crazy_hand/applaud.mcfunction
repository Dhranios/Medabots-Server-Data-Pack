...
execute if entity @s[scores={Time=35}] as @e[tag=master_hand] if score @s Stage = #temp Stage run playsound medabots_server:entity.crazy_hand.fake_out_land hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=45}] as @e[tag=master_hand] if score @s Stage = #temp Stage run playsound medabots_server:entity.crazy_hand.fake_out_land hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=55}] as @e[tag=master_hand] if score @s Stage = #temp Stage run playsound medabots_server:entity.crazy_hand.fake_out_land hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=65}] as @e[tag=master_hand] if score @s Stage = #temp Stage run playsound medabots_server:entity.crazy_hand.fake_out_land hostile @a ~ ~ ~ 1
