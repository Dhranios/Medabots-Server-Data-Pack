...
execute if entity @s[tag=dying,tag=!dead] run playsound medabots_server:entity.master_hand.final_hit3 hostile @a ~ ~ ~ 1
execute if entity @s[tag=dying,tag=!dead] run playsound medabots_server:entity.master_hand.death3 hostile @a ~ ~ ~ 1
...
# Set bossbar health
execute store result bossbar medabots_server:master_hand/3 value run data get entity @s AbsorptionAmount