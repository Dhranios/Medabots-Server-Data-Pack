...
execute if entity @e[tag=random_select,tag=selected,tag=gun] run tag @s[scores={Health=181..}] add attack_gun_1
execute if entity @e[tag=random_select,tag=selected,tag=gun] run tag @s[scores={Health=..180}] add attack_gun_3
