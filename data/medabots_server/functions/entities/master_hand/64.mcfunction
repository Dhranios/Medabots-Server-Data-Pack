...
execute if entity @s[scores={Dialog=30}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","dash"],Duration:1}
...
execute if entity @s[scores={Dialog=30}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","gun"],Duration:1}
...
execute if entity @s[scores={Dialog=30}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","walk"],Duration:1}
...
execute if entity @s[scores={Dialog=30}] if entity @e[distance=..1,tag=random_select,tag=selected,tag=gun] run tag @s[scores={Health=151..}] add attack_gun_1
execute if entity @s[scores={Dialog=30}] if entity @e[distance=..1,tag=random_select,tag=selected,tag=gun] run tag @s[scores={Health=..150}] add attack_gun_3
...
tag @s[scores={Dialog=30}] remove idle
