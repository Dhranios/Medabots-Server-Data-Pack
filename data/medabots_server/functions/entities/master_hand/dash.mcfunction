...
execute if entity @s[scores={Time=20..39}] run effect give @e[tag=potential_target,distance=..2] minecraft:instant_damage 1 1 true
execute if entity @s[scores={Time=20..39}] as @e[tag=potential_target,distance=..2] positioned as @s if block ^ ^ ^1 minecraft:air run teleport @s ^ ^ ^2
