...
execute if entity @s[scores={Time=61}] as @e[tag=potential_target,distance=..3] at @s facing entity @e[type=minecraft:ghast,tag=master_hand,limit=1,scores={Time=61}] feet facing ^ ^-3 ^3 if block ^ ^ ^-1 minecraft:air if block ^ ^ ^-2 minecraft:air if block ^ ^ ^-3 minecraft:air run teleport @s ^ ^ ^-3
execute if entity @s[scores={Time=61}] as @e[tag=potential_target,distance=..3] at @s facing entity @e[type=minecraft:ghast,tag=master_hand,limit=1,scores={Time=61}] feet facing ^ ^-3 ^3 if block ^ ^ ^-1 minecraft:air if block ^ ^ ^-2 minecraft:air unless block ^ ^ ^-3 minecraft:air run teleport @s ^ ^ ^-2
execute if entity @s[scores={Time=61}] as @e[tag=potential_target,distance=..3] at @s facing entity @e[type=minecraft:ghast,tag=master_hand,limit=1,scores={Time=61}] feet facing ^ ^-3 ^3 if block ^ ^ ^-1 minecraft:air unless block ^ ^ ^-2 minecraft:air run teleport @s ^ ^ ^-1
