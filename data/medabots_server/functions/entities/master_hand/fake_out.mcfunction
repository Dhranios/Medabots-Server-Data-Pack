...
execute if entity @s[scores={Time=55}] run playsound medabots_server:entity.master_hand.fake_out hostile @a ~ ~-3 ~ 1
execute if entity @s[scores={Time=60}] run playsound medabots_server:entity.master_hand.fake_out_land hostile @a ~ ~-3 ~ 1
