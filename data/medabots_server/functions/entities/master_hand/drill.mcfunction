...
execute if entity @s[scores={Time=10}] if entity @e[tag=target,limit=1] store result entity @s Pos[0] double 1 run data get entity @e[tag=target,limit=1] Pos[0]
execute if entity @s[scores={Time=10}] if entity @e[tag=target,limit=1] store result entity @s Pos[2] double 1 run data get entity @e[tag=target,limit=1] Pos[2]
...
execute if entity @s[scores={Time=60}] run playsound medabots_server:entity.master_hand.spin_return hostile @a ~ ~ ~ 1
