...
execute if entity @e[tag=target,limit=1] facing entity @e[tag=target,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.3,type=!minecraft:area_effect_cloud,tag=!floor_switch,limit=1] positioned as @s run function medabots_server:entities/guard/can_move_start
