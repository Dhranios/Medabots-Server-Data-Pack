...
execute if entity @s[scores={Moving=1}] positioned ~0.8 ~ ~ if entity @e[tag=raft,distance=..0.7] run tag @s remove valid_move
...
execute if entity @s[scores={Moving=2}] positioned ~ ~ ~0.8 if entity @e[tag=raft,distance=..0.7] run tag @s remove valid_move
...
execute if entity @s[scores={Moving=3}] positioned ~-0.8 ~ ~ if entity @e[tag=raft,distance=..0.7] run tag @s remove valid_move
...
execute if entity @s[scores={Moving=4}] positioned ~ ~ ~-0.8 if entity @e[tag=raft,distance=..0.7] run tag @s remove valid_move