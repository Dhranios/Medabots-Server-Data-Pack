...
execute if entity @s[scores={Time=11}] rotated ~ 0 positioned ~ ~-0.4 ~ positioned ^ ^ ^1 if block ~0.5 ~ ~0.5 minecraft:air if block ~-0.5 ~ ~0.5 minecraft:air if block ~0.5 ~ ~-0.5 minecraft:air if block ~-0.5 ~ ~-0.5 minecraft:air run tag @s add continue
