...
execute if entity @s[tag=smash_bros,tag=!dying,tag=!appeared] run function medabots_server:entities/master_hand/appear_1
execute if entity @s[tag=smash_melee,tag=!dying,tag=!appeared] run function medabots_server:entities/master_hand/appear_2
execute if entity @s[tag=smash_brawl,tag=!dying,tag=!appeared] run function medabots_server:entities/master_hand/appear_3
