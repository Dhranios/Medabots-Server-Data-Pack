...
tag @e[distance=..0.4,tag=bomb] add me
...
execute if entity @s[scores={Moving=1}] positioned ~0.6 ~ ~ align xyz if entity @e[dx=0,dy=0,dz=0,tag=bomb,tag=!me] run tag @s remove valid_move
...
execute if entity @s[scores={Moving=2}] positioned ~ ~ ~0.6 align xyz if entity @e[dx=0,dy=0,dz=0,tag=bomb,tag=!me] run tag @s remove valid_move
...
execute if entity @s[scores={Moving=3}] positioned ~-0.6 ~ ~ align xyz if entity @e[dx=0,dy=0,dz=0,tag=bomb,tag=!me] run tag @s remove valid_move
...
execute if entity @s[scores={Moving=4}] positioned ~ ~ ~-0.6 align xyz if entity @e[dx=0,dy=0,dz=0,tag=bomb,tag=!me] run tag @s remove valid_move
