...
execute as @e[distance=..0.4,tag=balloon_bomb,type=minecraft:shulker] run data merge entity @s {Rotation:[0.0d,0.0d]}
...
execute as @e[distance=..0.4,tag=balloon_bomb,type=minecraft:shulker,tag=should_burst] run tag @s remove should_burst
execute as @e[distance=..0.4,tag=balloon_bomb,type=minecraft:shulker,tag=potential_burst] run tag @s add should_burst
execute as @e[distance=..0.4,tag=balloon_bomb,type=minecraft:shulker,tag=potential_burst] run tag @s remove potential_burst
