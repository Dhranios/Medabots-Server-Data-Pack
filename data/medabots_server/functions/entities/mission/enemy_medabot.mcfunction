...
execute as @a[tag=enemy_medabot,scores={State=3}] if score @s Stage = #temp Stage if score @s StageIndex = #temp StageIndex run tag @s add spawning_medabot
...
scoreboard players set @a[tag=spawning_medabot,limit=1] State 2
