...
execute store result score @s OtherX run data get entity @e[type=minecraft:area_effect_cloud,tag=cannon_fire,limit=1] Pos[0] 100
execute store result score @s OtherY run data get entity @e[type=minecraft:area_effect_cloud,tag=cannon_fire,limit=1] Pos[1] 100
execute store result score @s OtherZ run data get entity @e[type=minecraft:area_effect_cloud,tag=cannon_fire,limit=1] Pos[2] 100
