...
execute if entity @s[scores={Moving=1}] if block ~0.6 ~-1 ~ minecraft:black_stained_glass run tag @s add valid_move
...
execute if entity @s[scores={Moving=2}] if block ~ ~-1 ~0.6 minecraft:black_stained_glass run tag @s add valid_move
...
execute if entity @s[scores={Moving=3}] if block ~-0.6 ~-1 ~ minecraft:black_stained_glass run tag @s add valid_move
...
execute if entity @s[scores={Moving=4}] if block ~ ~-1 ~-0.6 minecraft:black_stained_glass run tag @s add valid_move
