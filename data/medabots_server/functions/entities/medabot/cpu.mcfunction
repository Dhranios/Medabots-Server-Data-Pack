...
execute if entity @s[scores={Dialog=60,LegsArmor=0..},tag=fly_legs,tag=!no_legs] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","legs"],Duration:1}
execute if entity @s[scores={Dialog=60,LegsArmor=0..},tag=!fly_legs,tag=!no_legs] unless entity @s[scores={NoDefendTime=1..}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"text":"Random Select"}',Tags:["random_select","legs"],Duration:1}
