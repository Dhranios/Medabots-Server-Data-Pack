...
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated,scores={Charge=50..},tag=ghost_medal] run tag @s add medaforce_activated
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated,scores={Charge=50..},tag=question_medal] run tag @s add medaforce_activated
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated,scores={Charge=50..},tag=devil_medal] run tag @s add medaforce_activated
...
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/no_defend
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/ineffective
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/medaforce_control
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/paralyze
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/freeze
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/hold
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/destroy
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/infect
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/wave
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/hammer
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/sword
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/melt
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/falling
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/bug
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run function medabots_server:entities/medabot/cpu/preference_selection/melee/confuse
...
execute if entity @s[tag=!right_arm_activated,tag=!left_arm_activated,tag=!head_activated,tag=!medaforce_activated] run tag @s add preference_ranged