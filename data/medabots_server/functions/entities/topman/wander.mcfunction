...
execute at @s rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..1,type=!minecraft:area_effect_cloud,type=!minecraft:armor_stand,tag=!me] positioned as @s run function medabots_server:entities/topman/can_move
