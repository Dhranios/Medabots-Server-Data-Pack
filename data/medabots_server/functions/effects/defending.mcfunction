...
replaceitem entity @s[scores={DefenseTime=2..},type=!minecraft:player] weapon.offhand minecraft:shield{Unbreakable:1b,display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:move.defense"}'},BlockEntityTag:{Base:11,Patterns:[{Color:4,Pattern:"flo"},{Color:4,Pattern:"mr"},{Color:4,Pattern:"mr"},{Color:4,Pattern:"mr"},{Color:4,Pattern:"mr"},{Color:5,Pattern:"mc"}]}}
replaceitem entity @s[scores={DefenseTime=2..},type=minecraft:player] hotbar.7 minecraft:shield{Unbreakable:1b,display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:move.defense"}'},BlockEntityTag:{Base:11,Patterns:[{Color:4,Pattern:"flo"},{Color:4,Pattern:"mr"},{Color:4,Pattern:"mr"},{Color:4,Pattern:"mr"},{Color:4,Pattern:"mr"},{Color:5,Pattern:"mc"}]}}
