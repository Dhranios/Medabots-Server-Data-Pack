...
execute if entity @s[tag=!not_valid_ally_tinpet,tag=!not_valid_tinpet,tag=!not_high_enough_level,tag=!not_high_enough_ally_level,advancements={medabots_server:stages/wave_1/lagdou_ruins_7_second_go=true}] run function medabots_server:stage/create/lagdou_ruins_8/empty_initialization
