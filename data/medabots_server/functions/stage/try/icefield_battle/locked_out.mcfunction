...
execute if entity @s[tag=!not_valid_ally_tinpet,tag=!not_valid_tinpet] run function medabots_server:stage/create/icefield_battle/locked_out_initialization
