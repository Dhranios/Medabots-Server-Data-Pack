...
execute if entity @s[tag=!not_valid_tinpet] unless entity @s[scores={MedabotLevel=15..}] run tag @s add not_high_enough_level
tellraw @s[tag=not_high_enough_level] {"translate":"medabots_server:message.stage.requires.not_matching","with":[{"translate":"medabots_server:message.stage.requirements.lagdou_ruins_3.0"}]}
execute if entity @s[tag=!not_valid_tinpet] unless entity @s[advancements={medabots_server:stages/wave_1/lagdou_ruins_2_second_go=true}] run tellraw @s {"translate":"medabots_server:message.stage.requires.not_matching","with":[{"translate":"medabots_server:message.stage.requirements.lagdou_ruins_3.1"}]}
...
execute if entity @s[tag=!not_valid_ally_tinpet,tag=!not_valid_tinpet,tag=vs_cpus,scores={ArenaType=2}] unless entity @s[scores={MedabotLevel=15..}] run tag @s add not_high_enough_ally_level
tellraw @s[tag=not_high_enough_ally_level] {"translate":"medabots_server:message.stage.requires.not_matching.ally","with":[{"translate":"medabots_server:message.stage.requirements.lagdou_ruins_3.0"}]}
execute if entity @s[tag=!not_valid_ally_tinpet,tag=!not_valid_tinpet,tag=!not_high_enough_level,tag=!not_high_enough_ally_level,advancements={medabots_server:stages/wave_1/lagdou_ruins_2_second_go=true}] run function medabots_server:stage/create/lagdou_ruins_3/empty_initialization
