...
execute if entity @s[tag=!not_valid_ally_tinpet,tag=!not_valid_tinpet] run function medabots_server:stage/create/woods_battle/action_floors_2_initialization
