...
execute if block -1854 43 -773 minecraft:lime_wool run scoreboard players set @e[x=-1854.5,y=44,z=-773.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1854 43 -773 minecraft:lime_wool run scoreboard players set @e[x=-1847.5,y=44,z=-773.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1854 43 -770 minecraft:lime_wool run scoreboard players set @e[x=-1853.5,y=44,z=-768.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1854 43 -770 minecraft:lime_wool run scoreboard players set @e[x=-1846.5,y=44,z=-768.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1854 43 -775 minecraft:lime_wool run scoreboard players set @e[x=-1845.5,y=44,z=-782.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1854 43 -768 minecraft:lime_wool run scoreboard players set @e[x=-1846.5,y=44,z=-782.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1848 43 -784 minecraft:lime_wool run scoreboard players set @e[x=-1823.5,y=44,z=-793.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1848 43 -784 minecraft:lime_wool run scoreboard players set @e[x=-1823.5,y=44,z=-805.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1797 43 -784 minecraft:lime_wool run scoreboard players set @e[x=-1806.5,y=44,z=-793.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1797 43 -784 minecraft:lime_wool run scoreboard players set @e[x=-1806.5,y=44,z=-805.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1807 44 -761 minecraft:iron_trapdoor[open=true] if block -1810 44 -754 minecraft:barrier if entity @s[x=-1807,y=44,z=-763,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_d/first_go_battle/0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1806.5,y=44,z=-760.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1809.5,y=44,z=-753.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1810.5,y=44,z=-765.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1845 44 -788 minecraft:iron_trapdoor[open=true] if entity @s[x=-1846,y=44,z=-791,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_d/first_go_battle/1
...
execute as @e[x=-1856,y=41,z=-811,dx=61,dy=7,dz=78,type=!minecraft:player] unless entity @s[scores={Stage=0..}] run scoreboard players set @s Stage 35
