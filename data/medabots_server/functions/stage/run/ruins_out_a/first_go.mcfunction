...
execute if block -1622 45 -300 minecraft:iron_door[open=false] if block -1602 44 -286 minecraft:lime_wool run scoreboard players set @e[x=-1601.5,y=45,z=-301.5,distance=..0.7,tag=press_wall,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if block -1622 45 -300 minecraft:iron_door[open=true] run scoreboard players set @e[x=-1601.5,y=45,z=-301.5,distance=..0.7,tag=press_wall,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if block -1622 45 -300 minecraft:iron_door[open=false] if block -1602 44 -286 minecraft:lime_wool run scoreboard players set @e[x=-1596.5,y=45,z=-284.5,distance=..0.7,tag=press_wall,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if block -1622 45 -300 minecraft:iron_door[open=true] run scoreboard players set @e[x=-1596.5,y=45,z=-284.5,distance=..0.7,tag=press_wall,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
