...
execute if block -1511 44 -296 minecraft:lime_wool run scoreboard players set @e[x=-1616.5,y=45,z=-309.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1622 44 -303 minecraft:orange_wool run scoreboard players set @e[x=-1621.5,y=45,z=-299.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if block -1622 44 -303 minecraft:yellow_wool run scoreboard players set @e[x=-1621.5,y=45,z=-299.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
