...
tag @s[scores={BattlingMedabots=1,State=1..},tag=story_battle,advancements={medabots_server:story_progression/infinity={vs_gillgirl=true,vs_gillgirl_battle=false}}] add dialog_infinity_vs_gillgirl_battle
tag @s[scores={BattlingMedabots=1,State=1..,KillStreak=1},tag=story_battle] add dialog_infinity_postgame_sloan_battle
