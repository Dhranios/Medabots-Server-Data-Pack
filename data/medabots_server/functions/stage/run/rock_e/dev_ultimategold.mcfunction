...
execute if block -1823 44 -322 minecraft:light_blue_wool run scoreboard players set @e[x=-1817.5,y=45,z=-320.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1823 44 -322 minecraft:blue_wool run scoreboard players set @e[x=-1817.5,y=45,z=-320.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1849 44 -326 minecraft:blue_wool run scoreboard players set @e[x=-1831.5,y=45,z=-318.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
