...
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/rock_e
...
execute if block -1829 45 -266 minecraft:iron_door[open=true] if block -1825 45 -278 minecraft:iron_door[open=false] if entity @s[x=-1829,y=45,z=-267,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/0
execute if entity @e[x=-1820.5,y=45,z=-267.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
execute if entity @e[x=-1820.5,y=45,z=-267.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[scores={Stage=53},tag=cannon,type=minecraft:zombie,tag=mission_entity] run tag @s add mission_success
...
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=53,Medabot=0..,Battle=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=53,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
...
execute if block -1820 45 -312 minecraft:iron_door[open=true] if block -1819 45 -314 minecraft:air if entity @s[x=-1821,y=45,z=-315,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/1
execute if entity @e[x=-1817.5,y=45,z=-313.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s BattlingMedabots
execute if block -1840 45 -285 minecraft:iron_door[open=true] if block -1852 45 -295 minecraft:iron_door[open=false] if entity @s[x=-1843,y=45,z=-287,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/2
execute if entity @e[x=-1842.5,y=45,z=-287.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s BattlingMedabots
execute if block -1868 45 -273 minecraft:iron_door[open=true] if block -1874 45 -274 minecraft:iron_door[open=false] if entity @s[x=-1871,y=45,z=-275,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/3
execute if entity @e[x=-1871.5,y=45,z=-268.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
...
scoreboard players reset @s BattlingMedabots
execute if block -1885 45 -272 minecraft:iron_door[open=true] if block -1903 45 -272 minecraft:iron_door[open=false] if entity @s[x=-1888,y=45,z=-274,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/4
execute if entity @e[x=-1893.5,y=45,z=-265.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1893.5,y=45,z=-265.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission_entity,scores={Stage=53}] run tag @s remove run_until_the_time_is_up
...
execute if block -1874 45 -302 minecraft:iron_door[open=true] if block -1873 45 -305 minecraft:iron_door[open=false] if entity @s[x=-1876,y=45,z=-302,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/5
execute if entity @e[x=-1874.5,y=45,z=-298.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s BattlingMedabots
execute if block -1854 45 -315 minecraft:iron_door[open=true] if block -1861 45 -317 minecraft:iron_door[open=false] if entity @s[x=-1854,y=45,z=-316,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/6
execute if entity @e[x=-1845.5,y=45,z=-310.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
execute if entity @s[scores={BattlingMedabots=1}] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
...
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:rock_e/robattle players
scoreboard players reset @s BattlingMedabots
execute if block -1861 45 -317 minecraft:iron_door[open=true] if block -1854 45 -334 minecraft:iron_door[open=false] if entity @s[x=-1862,y=45,z=-320,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/7
execute if entity @e[x=-1858.5,y=45,z=-319.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
execute if entity @e[x=-1858.5,y=45,z=-319.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[scores={Stage=53},tag=cannon,type=minecraft:zombie,tag=mission_entity] run tag @s add mission_success
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s BattlingMedabots
execute if block -1835 45 -335 minecraft:iron_door[open=true] if block -1864 45 -336 minecraft:iron_door[open=false] if entity @s[x=-1835,y=45,z=-336,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_e/dev_ultimategold_battle/8
execute if entity @e[x=-1832.5,y=45,z=-335.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
...
execute if entity @e[x=-1906,y=42,z=-345,dx=93,dy=7,dz=95,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=53,Medabot=0..,Battle=1..2}]
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/rock_e
advancement grant @s[scores={BattlingMedabots=1,Battle=1..}] only medabots_server:developer_challenge/rock_e_ultimategold
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run bossbar set medabots_server:rock_e/robattle players
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:story_progression/other={rock_e_ultimategold=true,rock_e_ultimategold_cleared=false}}] add dialog_rock_e_ultimategold_cleared
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] positioned -1860 51 -298 run function medabots_server:stage/clear
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots