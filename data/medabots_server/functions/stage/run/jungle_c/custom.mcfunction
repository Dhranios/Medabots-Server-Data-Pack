...
execute if entity @s[tag=add_bossbar] store result bossbar medabots_server:jungle_c/robattle max run scoreboard players get @s MissionTime
execute if entity @s[tag=add_bossbar] store result bossbar medabots_server:jungle_c/robattle value run scoreboard players get @s MissionTime
