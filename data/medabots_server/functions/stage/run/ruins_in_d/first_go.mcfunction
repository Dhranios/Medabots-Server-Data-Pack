...
execute if block -1747 43 -736 minecraft:yellow_wool if block -1739 43 -736 minecraft:orange_wool run scoreboard players set @e[x=-1737.5,y=44,z=-744.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1738 43 -735 minecraft:yellow_wool if block -1739 43 -736 minecraft:orange_wool run scoreboard players set @e[x=-1737.5,y=44,z=-744.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1739 43 -736 minecraft:yellow_wool run scoreboard players set @e[x=-1737.5,y=44,z=-744.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1747 43 -736 minecraft:orange_wool if block -1738 43 -735 minecraft:orange_wool run scoreboard players set @e[x=-1737.5,y=44,z=-744.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1738 43 -736 minecraft:lime_wool run scoreboard players set @e[x=-1738.5,y=44,z=-751.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1739 43 -735 minecraft:lime_wool run scoreboard players set @e[x=-1761.5,y=44,z=-744.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1739 43 -772 minecraft:lime_wool run scoreboard players set @e[x=-1746.5,y=44,z=-774.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1776 43 -774 minecraft:lime_wool run scoreboard players set @e[x=-1774.5,y=44,z=-773.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1776 43 -774 minecraft:lime_wool run scoreboard players set @e[x=-1774.5,y=44,z=-793.5,distance=..2,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1754 44 -752 minecraft:iron_trapdoor[open=true] if block -1753 44 -745 minecraft:barrier if entity @s[x=-1755,y=44,z=-755,dx=3,dy=3,dz=3] run function medabots_server:stage/create/ruins_in_d/first_go_battle/1
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1752.5,y=44,z=-744.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run kill @e[x=-1793,y=41,z=-795,dx=62,dy=7,dz=62,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:ruins_in_d/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
...
title @s[tag=mission_success] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1777.5,y=44,z=-790.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1762.5,y=44,z=-777.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=-1793,y=41,z=-795,dx=62,dy=7,dz=62,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission_success] run bossbar set medabots_server:ruins_in_d/robattle players
tag @s[tag=mission_success] remove mission_success
