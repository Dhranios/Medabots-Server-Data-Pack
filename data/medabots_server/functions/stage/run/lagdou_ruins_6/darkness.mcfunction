...
execute as @e[x=-1267,y=42,z=-139,dx=60,dy=7,dz=77,type=!minecraft:player] unless entity @s[scores={Stage=0..}] run scoreboard players set @s Stage 41
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] as @a[scores={Stage=41}] positioned -1236 51 -99 run function medabots_server:stage/clear
