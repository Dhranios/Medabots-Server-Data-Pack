...
execute if entity @s[tag=add_bossbar] store result bossbar medabots_server:ruins_in_a/robattle max run scoreboard players get @s MissionTime
execute if entity @s[tag=add_bossbar] store result bossbar medabots_server:ruins_in_a/robattle value run scoreboard players get @s MissionTime
