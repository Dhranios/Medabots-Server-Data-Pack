...
execute if block -1655 43 -296 minecraft:lime_wool run scoreboard players set @e[x=-1648.5,y=44,z=-320.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1726 43 -255 minecraft:yellow_wool run scoreboard players set @e[x=-1715.5,y=44,z=-253.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1726 43 -255 minecraft:orange_wool if block -1702 43 -260 minecraft:orange_wool run scoreboard players set @e[x=-1715.5,y=44,z=-253.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1715 43 -260 minecraft:yellow_wool run scoreboard players set @e[x=-1712.5,y=44,z=-262.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1715 43 -260 minecraft:orange_wool run scoreboard players set @e[x=-1712.5,y=44,z=-262.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1716 43 -297 minecraft:orange_wool run scoreboard players set @e[x=-1716.5,y=44,z=-298.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1694 44 -259 minecraft:iron_trapdoor[open=true] run scoreboard players set @e[x=-1646.5,y=44,z=-289.5,distance=..0.7,tag=action_floor,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1651 44 -326 minecraft:iron_trapdoor[open=true] if block -1694 44 -259 minecraft:barrier if entity @s[x=-1652,y=44,z=-329,dx=3,dy=3,dz=3] run function medabots_server:stage/create/ruins_in_a/rubberobo_battle/0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1693.5,y=44,z=-258.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
