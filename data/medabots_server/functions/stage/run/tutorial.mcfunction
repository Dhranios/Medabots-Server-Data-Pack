...
scoreboard players add @s[x=12,y=53,z=14,dx=7,dy=4,dz=3,scores={Dialog=624}] Dialog 1
scoreboard players add @s[scores={Dialog=625..895}] Dialog 1
teleport @s[scores={Dialog=626}] 17 53 22
...
execute if block ~ ~ ~ minecraft:water run teleport @s[scores={Dialog=1101..}] 4 53 15
...
execute if entity @s[scores={Dialog=1467}] positioned 4 53 3 run tag @e[distance=..0.7,tag=enemy_medabot] add dead
...
execute in minecraft:overworld run teleport @s[scores={Dialog=1467}] -286 55 -52 -90 0
