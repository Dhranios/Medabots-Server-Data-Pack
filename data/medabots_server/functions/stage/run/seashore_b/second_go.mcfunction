...
execute if block -1747 45 -413 minecraft:iron_trapdoor[open=true] if entity @s[x=-1748,y=45,z=-416,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/second_go_battle/1
