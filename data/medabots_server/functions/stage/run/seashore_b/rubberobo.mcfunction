...
execute if block -1747 45 -354 minecraft:iron_trapdoor[open=true] if block -1760 44 -368 minecraft:water if entity @s[x=-1750,y=44,z=-356,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/rubberobo_battle/0
...
execute if block -1747 45 -413 minecraft:iron_trapdoor[open=true] if entity @s[x=-1748,y=45,z=-416,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/rubberobo_battle/1
