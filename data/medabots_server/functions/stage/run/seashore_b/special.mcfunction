...
execute if block -1741 44 -402 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1727 44 -388 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1716 44 -402 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1702 44 -395 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1698 44 -403 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1690 44 -403 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1689 44 -394 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1672 44 -411 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1683 44 -393 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1690 44 -420 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1698 44 -420 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1686 44 -436 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1711 44 -417 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1717 44 -438 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1747 45 -413 minecraft:iron_trapdoor[open=true] if entity @s[x=-1748,y=45,z=-416,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/special_battle/0
...
execute as @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,type=!minecraft:player] unless entity @s[scores={Stage=0..}] run scoreboard players set @s Stage 13
