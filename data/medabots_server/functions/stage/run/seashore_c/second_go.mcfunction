...
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/seashore_c
execute if entity @s[scores={Battle=0}] run function medabots_server:other/death
execute if block -1565 43 -592 minecraft:lime_wool run scoreboard players set @e[x=-1541.5,y=44,z=-602.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1521 43 -556 minecraft:yellow_wool run scoreboard players set @e[x=-1520.5,y=44,z=-556.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if block -1518 43 -565 minecraft:green_wool if block -1521 43 -556 minecraft:orange_wool run scoreboard players set @e[x=-1520.5,y=44,z=-556.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if block -1557 43 -596 minecraft:lime_wool run scoreboard players add @e[x=-1556.5,y=44,z=-594.5,distance=..0.7,tag=fan,type=minecraft:area_effect_cloud,tag=!changed] Moving 1
execute if block -1557 43 -596 minecraft:lime_wool run tag @e[x=-1556.5,y=44,z=-594.5,distance=..0.7,tag=fan,type=minecraft:area_effect_cloud,tag=!changed] add changed
...
execute if entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=25,Medabot=0..,Battle=1..2}]
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/seashore_c
