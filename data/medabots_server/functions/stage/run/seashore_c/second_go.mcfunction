...
execute if entity @e[x=-1564.5,y=44,z=-591.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=-1541.5,y=44,z=-602.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @e[x=-1556.5,y=44,z=-595.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add @e[x=-1556.5,y=44,z=-594.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] Moving 1
execute if entity @e[x=-1556.5,y=44,z=-595.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run tag @e[x=-1556.5,y=44,z=-594.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] add changed
