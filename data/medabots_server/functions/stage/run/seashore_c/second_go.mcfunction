...
execute if entity @e[x=5.5,y=53,z=16.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=28.5,y=53,z=5.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @e[x=13.5,y=53,z=12.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add @e[x=13.5,y=53,z=13.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] Moving 1
execute if entity @e[x=13.5,y=53,z=12.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run tag @e[x=13.5,y=53,z=13.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] add changed
...
execute if block 40 53 21 minecraft:iron_trapdoor[open=true] if entity @s[x=39,y=53,z=18,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_c/second_go_battle/0
execute if entity @e[x=0,y=51,z=0,dx=60,dy=7,dz=60,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=25,Medabot=0..,State=1}]
