...
execute if block -1541 44 -327 minecraft:orange_wool run scoreboard players set @e[x=-1542.5,y=45,z=-326.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1541 44 -327 minecraft:yellow_wool run scoreboard players set @e[x=-1542.5,y=45,z=-326.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1564 44 -337 minecraft:orange_wool run scoreboard players set @e[x=-1559.5,y=45,z=-340.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1564 44 -337 minecraft:yellow_wool run scoreboard players set @e[x=-1559.5,y=45,z=-340.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1567 44 -366 minecraft:light_blue_wool run scoreboard players set @e[x=-1555.5,y=45,z=-367.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1567 44 -366 minecraft:blue_wool if block -1559 44 -344 minecraft:lime_wool run scoreboard players set @e[x=-1555.5,y=45,z=-367.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1522 44 -365 minecraft:orange_wool run scoreboard players set @e[x=-1543.5,y=45,z=-360.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1522 44 -365 minecraft:yellow_wool run scoreboard players set @e[x=-1543.5,y=45,z=-360.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1522 44 -367 minecraft:orange_wool run scoreboard players set @e[x=-1543.5,y=45,z=-362.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1522 44 -367 minecraft:yellow_wool run scoreboard players set @e[x=-1543.5,y=45,z=-362.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1544 44 -374 minecraft:lime_wool run scoreboard players set @e[x=-1557.5,y=45,z=-383.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1522 45 -340 minecraft:iron_trapdoor[open=true] if block -1518 45 -335 minecraft:air if entity @s[x=-1524,y=45,z=-340,dx=3,dy=3,dz=3] run function medabots_server:stage/create/grassland_b/first_go_battle/0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1521.5,y=45,z=-339.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1538 45 -403 minecraft:iron_trapdoor[open=true] if block -1520 45 -389 minecraft:barrier if entity @s[x=-1538,y=45,z=-404,dx=3,dy=3,dz=3] run function medabots_server:stage/create/grassland_b/first_go_battle/1
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1537.5,y=45,z=-402.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1519.5,y=45,z=-388.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1559 45 -385 minecraft:iron_trapdoor[open=true] if entity @s[x=-1560,y=45,z=-388,dx=3,dy=3,dz=3] run function medabots_server:stage/create/grassland_b/first_go_battle/2
...
advancement grant @s[scores={BattlingMedabots=1,State=1..}] only medabots_server:stages/wave_1/grassland_b_first_go
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:grassland_b/robattle players
tag @s[scores={BattlingMedabots=1,State=1..},advancements={medabots_server:story_progression/infinity={vs_koji_battle=true,vs_sloan_begin=false}}] add dialog_infinity_vs_sloan_begin
