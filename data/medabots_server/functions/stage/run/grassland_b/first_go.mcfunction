...
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/grassland_b
...
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=10,Medabot=0..,Battle=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=10,Medabot=0..,Battle=1..},tag=enemy_medabot] run function medabots_server:stage/leave_server_enforced
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/grassland_b
