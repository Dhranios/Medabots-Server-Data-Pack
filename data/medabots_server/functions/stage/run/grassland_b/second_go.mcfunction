...
execute if block -1522 45 -340 minecraft:iron_trapdoor[open=true] if block -1518 45 -335 minecraft:air if entity @s[x=-1524,y=45,z=-340,dx=3,dy=3,dz=3] run function medabots_server:stage/create/grassland_b/second_go_battle/0
...
execute if block -1538 45 -403 minecraft:iron_trapdoor[open=true] if block -1520 45 -389 minecraft:barrier if entity @s[x=-1538,y=45,z=-404,dx=3,dy=3,dz=3] run function medabots_server:stage/create/grassland_b/second_go_battle/1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1559 45 -385 minecraft:iron_trapdoor[open=true] if entity @s[x=-1560,y=45,z=-388,dx=3,dy=3,dz=3] run function medabots_server:stage/create/grassland_b/second_go_battle/2
