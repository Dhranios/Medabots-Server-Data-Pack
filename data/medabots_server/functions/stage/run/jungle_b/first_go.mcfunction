...
execute if block -1645 44 -408 minecraft:blue_wool if block -1629 44 -420 minecraft:blue_wool if block -1629 44 -421 minecraft:yellow_wool run scoreboard players set @e[x=-1626.5,y=45,z=-424.5,distance=..0.7,tag=alarm,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if block -1645 44 -408 minecraft:light_blue_wool run scoreboard players set @e[x=-1626.5,y=45,z=-424.5,distance=..0.7,tag=alarm,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if block -1629 44 -420 minecraft:light_blue_wool run scoreboard players set @e[x=-1626.5,y=45,z=-424.5,distance=..0.7,tag=alarm,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
