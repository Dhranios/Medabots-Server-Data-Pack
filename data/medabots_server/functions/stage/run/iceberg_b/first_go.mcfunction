...
execute if entity @e[x=16.5,y=53,z=26.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=16.5,y=53,z=40.5,distance=..0.7,tag=action_floor,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=16.5,y=53,z=26.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=17.5,y=53,z=38.5,distance=..0.7,tag=action_floor,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=16.5,y=53,z=26.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=14.5,y=53,z=36.5,distance=..0.7,tag=action_floor,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @e[x=23.5,y=53,z=42.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=12.5,y=53,z=42.5,distance=..0.7,tag=action_floor,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=23.5,y=53,z=42.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=14.5,y=53,z=39.5,distance=..0.7,tag=action_floor,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @e[x=23.5,y=53,z=42.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=13.5,y=53,z=33.5,distance=..0.7,tag=action_floor,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block 49 53 69 minecraft:iron_trapdoor[open=true] if block 52 53 58 minecraft:air if entity @s[x=48,y=53,z=66,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_b/first_go_battle/0
execute if entity @e[x=51.5,y=53,z=61.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=15,Medabot=0..,State=1..2}]
...
execute if block 15 53 14 minecraft:iron_trapdoor[open=true] if block 17 53 3 minecraft:black_stained_glass if entity @s[x=14,y=53,z=11,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_b/first_go_battle/1
execute if entity @e[x=7.5,y=53,z=6.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=15,Medabot=0..,State=1..2}]
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 51 53 47 minecraft:iron_trapdoor[open=true] if block 36 50 27 minecraft:cobblestone if entity @s[x=51,y=53,z=46,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_b/first_go_battle/2
execute if entity @e[x=59.5,y=53,z=38.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=15,Medabot=0..,State=1..2}]
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 45 53 23 minecraft:iron_trapdoor[open=true] if entity @s[x=44,y=53,z=20,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_b/first_go_battle/3
execute if entity @e[x=0,y=50,z=0,dx=60,dy=7,dz=90,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=15,Medabot=0..,State=1..2}]
