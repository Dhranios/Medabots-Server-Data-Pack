...
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/iceberg_b
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1772.5,y=44,z=-376.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission_entity,scores={Stage=15}] run tag @s remove run_until_the_time_is_up
...
execute if entity @e[x=-1816.5,y=44,z=-431.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[scores={Stage=15},tag=cannon,type=minecraft:zombie,tag=mission_entity] run tag @s add mission_success
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1808.5,y=44,z=-423.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1806.5,y=44,z=-434.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=15,Medabot=0..,Battle=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=15,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/leave_server_enforced
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1772.5,y=44,z=-390.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/iceberg_b
