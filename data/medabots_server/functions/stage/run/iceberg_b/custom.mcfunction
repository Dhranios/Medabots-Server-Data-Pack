...
execute if entity @s[tag=add_bossbar] store result bossbar medabots_server:iceberg_b/robattle max run scoreboard players get @s MissionTime
execute if entity @s[tag=add_bossbar] store result bossbar medabots_server:iceberg_b/robattle value run scoreboard players get @s MissionTime
