...
execute if entity @e[x=44.5,y=53,z=75.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 1
execute if entity @e[x=33.5,y=53,z=47.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 1
execute if entity @e[x=51.5,y=53,z=28.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 1
execute if entity @e[x=59.5,y=53,z=24.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 1
execute if entity @e[x=11.5,y=53,z=83.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 2
execute if entity @e[x=16.5,y=53,z=41.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 2
...
execute if entity @e[x=76.5,y=53,z=3.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 2
...
execute if block 25 53 77 minecraft:iron_trapdoor[open=true] unless block 11 52 83 minecraft:lime_wool if entity @s[x=22,y=53,z=75,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/second_go_battle/0
execute if entity @e[x=17.5,y=53,z=80.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=14,Medabot=0..,State=1}]
execute if entity @e[x=17.5,y=53,z=80.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] if entity @e[x=11.5,y=53,z=83.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run tag @s add mission_success
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=14,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=14,Medabot=0..,State=1},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
...
execute if block 11 53 50 minecraft:iron_trapdoor[open=true] unless block 16 52 41 minecraft:lime_wool if entity @s[x=8,y=53,z=48,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/second_go_battle/1
execute if entity @e[x=6.5,y=53,z=48.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=14,Medabot=0..,State=1}]
execute if entity @e[x=6.5,y=53,z=48.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] if entity @e[x=16.5,y=53,z=41.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run tag @s add mission_success
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=14,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=14,Medabot=0..,State=1},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 78 53 51 minecraft:iron_trapdoor[open=true] unless block 89 52 57 minecraft:lime_wool if entity @s[x=78,y=53,z=50,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/second_go_battle/2
execute if entity @e[x=86.5,y=53,z=53.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=14,Medabot=0..,State=1}]
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 81 53 21 minecraft:iron_trapdoor[open=true] unless block 76 52 3 minecraft:lime_wool if entity @s[x=80,y=53,z=18,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/second_go_battle/3
execute if entity @e[x=83.5,y=53,z=11.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=14,Medabot=0..,State=1}]
execute if entity @e[x=83.5,y=53,z=11.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] if entity @e[x=76.5,y=53,z=3.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run tag @s add mission_success
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=14,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=14,Medabot=0..,State=1},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 15 53 24 minecraft:iron_trapdoor[open=true] if entity @s[x=14,y=53,z=21,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/second_go_battle/4
execute if entity @e[x=0,y=50,z=0,dx=94,dy=7,dz=93,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=14,Medabot=0..,State=1}]
