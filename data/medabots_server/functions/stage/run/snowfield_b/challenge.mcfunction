...
execute if entity @e[x=58.5,y=53,z=22.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players add #temp PowerAmount 1
...
execute if block 25 53 77 minecraft:iron_trapdoor[open=true] unless block 13 52 83 minecraft:lime_wool if entity @s[x=22,y=53,z=75,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/challenge_battle/0
...
execute if block 11 53 50 minecraft:iron_trapdoor[open=true] unless block 16 52 42 minecraft:lime_wool if entity @s[x=8,y=53,z=48,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/challenge_battle/1
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 78 53 51 minecraft:iron_trapdoor[open=true] unless block 89 52 57 minecraft:lime_wool if entity @s[x=78,y=53,z=50,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/challenge_battle/2
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 81 53 21 minecraft:iron_trapdoor[open=true] unless block 76 52 4 minecraft:lime_wool if entity @s[x=80,y=53,z=18,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/challenge_battle/3
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 15 53 24 minecraft:iron_trapdoor[open=true] if entity @s[x=14,y=53,z=21,dx=3,dy=3,dz=3] run function medabots_server:stage/create/snowfield_b/challenge_battle/4
