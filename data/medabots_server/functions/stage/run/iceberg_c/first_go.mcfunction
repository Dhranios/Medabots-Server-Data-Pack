...
execute if entity @e[x=1.5,y=53,z=5.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=29.5,y=53,z=24.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=58.5,y=53,z=5.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=29.5,y=53,z=25.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block 17 53 60 minecraft:iron_trapdoor[open=true] if block 9 53 20 minecraft:black_stained_glass if entity @s[x=15,y=53,z=60,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_c/first_go_battle/0
execute if entity @e[x=17.5,y=53,z=66.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=26,Medabot=0..,State=1}]
...
execute if block 29 53 23 minecraft:iron_trapdoor[open=true] if entity @s[x=28,y=53,z=20,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_c/first_go_battle/1
execute if entity @e[x=0,y=51,z=0,dx=60,dy=7,dz=74,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=26,Medabot=0..,State=1}]
