...
execute if entity @e[x=-1567.5,y=44,z=-678.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=-1540.5,y=44,z=-660.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=-1512.5,y=44,z=-678.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=-1540.5,y=44,z=-659.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1553 44 -625 minecraft:iron_trapdoor[open=true] if block -1561 44 -665 minecraft:black_stained_glass if entity @s[x=-1555,y=44,z=-625,dx=3,dy=3,dz=3] run function medabots_server:stage/create/iceberg_c/second_go_battle/0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1553.5,y=44,z=-624.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
