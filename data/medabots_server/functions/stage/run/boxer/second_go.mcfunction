...
execute if block -1878 44 -561 minecraft:iron_trapdoor[open=true] if block -1876 44 -571 minecraft:barrier if entity @s[x=-1880,y=44,z=-561,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/0
...
execute if block -1875 44 -571 minecraft:iron_trapdoor[open=true] if block -1880 44 -582 minecraft:barrier if entity @s[x=-1875,y=44,z=-572,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/1
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:boxer/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1879 44 -583 minecraft:iron_trapdoor[open=true] if block -1889 44 -585 minecraft:barrier if entity @s[x=-1879,y=44,z=-584,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/2
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:boxer/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1889 44 -586 minecraft:iron_trapdoor[open=true] if block -1900 44 -581 minecraft:barrier if entity @s[x=-1889,y=44,z=-588,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/3
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:boxer/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1901 44 -582 minecraft:iron_trapdoor[open=true] if block -1903 44 -572 minecraft:barrier if entity @s[x=-1902,y=44,z=-585,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/4
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:boxer/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1904 44 -572 minecraft:iron_trapdoor[open=true] if block -1899 44 -561 minecraft:barrier if entity @s[x=-1907,y=44,z=-574,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/5
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:boxer/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1899 44 -561 minecraft:iron_trapdoor[open=true] if block -1890 44 -558 minecraft:barrier unless entity @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=mr_referee,type=minecraft:armor_stand] if entity @s[x=-1899,y=44,z=-562,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/second_go_battle/7
