...
execute if block 18 53 42 minecraft:quartz_pillar unless entity @e[x=15.5,y=53,z=48.5,distance=..0.7,tag=press_wall_timer,type=minecraft:area_effect_cloud] run summon minecraft:area_effect_cloud 15 53 48 {CustomName:'{"translate":"medabots_server:block.press_wall"}',Tags:["press_wall_timer"],Duration:400}
scoreboard players add @e[x=15.5,y=53,z=48.5,distance=..0.7,tag=press_wall_timer,type=minecraft:area_effect_cloud] Time 1
execute if entity @e[x=15.5,y=53,z=48.5,distance=..0.7,tag=press_wall_timer,type=minecraft:area_effect_cloud,scores={Time=1}] run scoreboard players set @e[x=0,y=51,z=0,dx=64,dy=7,dz=64,tag=press_wall,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=15.5,y=53,z=48.5,distance=..0.7,tag=press_wall_timer,type=minecraft:area_effect_cloud,scores={Time=81}] run scoreboard players set @e[x=0,y=51,z=0,dx=64,dy=7,dz=64,tag=press_wall,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=43.5,y=53,z=41.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
