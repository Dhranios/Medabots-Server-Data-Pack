...
execute if entity @e[x=15.5,y=53,z=48.5,distance=..0.7,tag=press_wall_timer,type=minecraft:area_effect_cloud,scores={Time=1}] run scoreboard players set @e[x=0,y=51,z=0,dx=64,dy=7,dz=64,tag=press_wall,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
