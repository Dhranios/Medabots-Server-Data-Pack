...
execute if block -1690 44 -156 minecraft:light_blue_wool run scoreboard players set @e[x=-1697.5,y=45,z=-144.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1690 44 -156 minecraft:blue_wool run scoreboard players set @e[x=-1697.5,y=45,z=-144.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1680 44 -168 minecraft:lime_wool run scoreboard players set @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1682 44 -170 minecraft:lime_wool run scoreboard players set @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1684 44 -169 minecraft:lime_wool run scoreboard players set @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1651 44 -156 minecraft:lime_wool run scoreboard players set @e[x=-1644.5,y=45,z=-153.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
