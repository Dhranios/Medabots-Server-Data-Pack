...
execute if entity @e[x=24.5,y=53,z=55.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=31,Medabot=0..,State=1..2}]
...
execute if entity @e[x=0,y=50,z=0,dx=61,dy=7,dz=61,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=31,Medabot=0..,State=1..2}]
