...
execute if block -1662 43 -511 minecraft:light_blue_wool run scoreboard players set @e[x=-1617.5,y=44,z=-501.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1663 43 -511 minecraft:light_blue_wool run scoreboard players set @e[x=-1617.5,y=44,z=-501.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1615 43 -502 minecraft:lime_wool run scoreboard players set @e[x=-1617.5,y=44,z=-501.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1615 43 -502 minecraft:green_wool if block -1662 43 -511 minecraft:blue_wool if block -1663 43 -511 minecraft:blue_wool run scoreboard players set @e[x=-1617.5,y=44,z=-501.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1663 43 -515 minecraft:light_blue_wool run scoreboard players set @e[x=-1626.5,y=44,z=-512.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1663 43 -515 minecraft:blue_wool run scoreboard players set @e[x=-1626.5,y=44,z=-512.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1590 43 -513 minecraft:lime_wool run scoreboard players set @e[x=-1613.5,y=44,z=-513.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1659 43 -547 minecraft:lime_wool run scoreboard players set @e[x=-1626.5,y=44,z=-525.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1594 43 -542 minecraft:light_blue_wool run scoreboard players set @e[x=-1613.5,y=44,z=-526.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1594 43 -542 minecraft:blue_wool run scoreboard players set @e[x=-1613.5,y=44,z=-526.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1638 43 -572 minecraft:blue_wool if block -1664 43 -561 minecraft:light_blue_wool run scoreboard players set @e[x=-1652.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1664 43 -561 minecraft:blue_wool run scoreboard players set @e[x=-1652.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:light_blue_wool run scoreboard players set @e[x=-1652.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:blue_wool if block -1664 43 -565 minecraft:light_blue_wool run scoreboard players set @e[x=-1650.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1664 43 -565 minecraft:blue_wool run scoreboard players set @e[x=-1650.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:light_blue_wool run scoreboard players set @e[x=-1650.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:blue_wool if block -1664 43 -568 minecraft:light_blue_wool run scoreboard players set @e[x=-1648.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1664 43 -568 minecraft:blue_wool run scoreboard players set @e[x=-1648.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:light_blue_wool run scoreboard players set @e[x=-1648.5,y=44,z=-571.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:blue_wool if block -1662 43 -561 minecraft:light_blue_wool run scoreboard players set @e[x=-1653.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1662 43 -561 minecraft:blue_wool run scoreboard players set @e[x=-1653.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:light_blue_wool run scoreboard players set @e[x=-1653.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:blue_wool if block -1662 43 -565 minecraft:light_blue_wool run scoreboard players set @e[x=-1651.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1662 43 -565 minecraft:blue_wool run scoreboard players set @e[x=-1651.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:light_blue_wool run scoreboard players set @e[x=-1651.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:blue_wool if block -1662 43 -568 minecraft:light_blue_wool run scoreboard players set @e[x=-1649.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1662 43 -568 minecraft:blue_wool run scoreboard players set @e[x=-1649.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1638 43 -572 minecraft:light_blue_wool run scoreboard players set @e[x=-1649.5,y=44,z=-560.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1612.5,y=44,z=-526.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
title @s[scores={BattlingMedabots=1,State=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1612.5,y=44,z=-513.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:ruins_in_b/robattle players
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run kill @e[x=-1666,y=0,z=-572,dx=92,dy=49,dz=92,tag=mission,type=minecraft:area_effect_cloud]
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
...
title @s[scores={BattlingMedabots=1,State=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1627.5,y=44,z=-525.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:ruins_in_b/robattle players
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run kill @e[x=-1666,y=0,z=-572,dx=92,dy=49,dz=92,tag=mission,type=minecraft:area_effect_cloud]
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
...
title @s[scores={BattlingMedabots=1,State=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1627.5,y=44,z=-512.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:ruins_in_b/robattle players
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run kill @e[x=-1666,y=0,z=-572,dx=92,dy=49,dz=92,tag=mission,type=minecraft:area_effect_cloud]
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
...
title @s[scores={BattlingMedabots=1,State=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1620.5,y=44,z=-551.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1619.5,y=44,z=-483.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:ruins_in_b/robattle players
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run kill @e[x=-1666,y=0,z=-572,dx=92,dy=49,dz=92,tag=mission,type=minecraft:area_effect_cloud]
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
