...
execute as @e[scores={Stage=37},tag=practise_battle] run tag @e[scores={Stage=37},tag=medabot] add practise_robattle
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/lagdou_ruins_2
