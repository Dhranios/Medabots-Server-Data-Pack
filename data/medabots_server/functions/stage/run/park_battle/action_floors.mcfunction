...
tag @s[scores={BattlingMedabots=1,State=1..},tag=story_battle,advancements={medabots_server:story_progression/other={salesman_chameleon_medal_vs=true,salesman_chameleon_medal_battle=false}}] add dialog_other_salesman_chameleon_medal_battle
