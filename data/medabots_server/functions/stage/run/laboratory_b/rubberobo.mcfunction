...
execute if block 35 53 73 minecraft:iron_trapdoor[open=true] if block 59 53 75 minecraft:black_stained_glass if entity @s[x=35,y=53,z=72,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/0
...
execute if block 63 53 73 minecraft:iron_trapdoor[open=true] if block 87 53 75 minecraft:black_stained_glass if entity @s[x=63,y=53,z=72,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 17 53 56 minecraft:iron_trapdoor[open=true] if block 17 53 32 minecraft:black_stained_glass if entity @s[x=16,y=53,z=53,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/2
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 17 53 28 minecraft:iron_trapdoor[open=true] if block 17 53 4 minecraft:black_stained_glass if entity @s[x=16,y=53,z=25,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/3
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 81 53 19 minecraft:iron_trapdoor[open=true] if entity @s[x=80,y=53,z=16,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/4
