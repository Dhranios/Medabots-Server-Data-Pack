...
execute if block -1725 44 -560 minecraft:iron_trapdoor[open=true] if block -1701 44 -558 minecraft:black_stained_glass if entity @s[x=-1725,y=44,z=-561,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/0
...
execute if block -1697 44 -560 minecraft:iron_trapdoor[open=true] if block -1673 44 -558 minecraft:black_stained_glass if entity @s[x=-1697,y=44,z=-561,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1743 44 -577 minecraft:iron_trapdoor[open=true] if block -1743 44 -601 minecraft:black_stained_glass if entity @s[x=-1744,y=44,z=-580,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/2
...
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1743 44 -605 minecraft:iron_trapdoor[open=true] if block -1743 44 -629 minecraft:black_stained_glass if entity @s[x=-1744,y=44,z=-608,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_b/rubberobo_battle/3
