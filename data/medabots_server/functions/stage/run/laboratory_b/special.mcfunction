...
execute if block -1703 43 -599 minecraft:blue_wool run scoreboard players set @e[x=-1678.5,y=44,z=-612.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1703 43 -599 minecraft:light_blue_wool run scoreboard players set @e[x=-1678.5,y=44,z=-612.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1759 43 -551 minecraft:blue_wool run scoreboard players set @e[x=-1757.5,y=44,z=-550.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1759 43 -551 minecraft:light_blue_wool run scoreboard players set @e[x=-1757.5,y=44,z=-550.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1759 43 -551 minecraft:blue_wool run scoreboard players set @e[x=-1758.5,y=44,z=-574.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1759 43 -551 minecraft:light_blue_wool run scoreboard players set @e[x=-1758.5,y=44,z=-574.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1759 43 -551 minecraft:blue_wool run scoreboard players set @e[x=-1758.5,y=44,z=-602.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1759 43 -551 minecraft:light_blue_wool run scoreboard players set @e[x=-1758.5,y=44,z=-602.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
execute if block -1759 43 -551 minecraft:blue_wool run scoreboard players set @e[x=-1758.5,y=44,z=-630.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1759 43 -551 minecraft:light_blue_wool run scoreboard players set @e[x=-1758.5,y=44,z=-630.5,distance=..0.7,tag=laser_trap,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if entity @e[x=-1712.5,y=44,z=-559.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1700.5,y=44,z=-558.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1672.5,y=44,z=-558.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
