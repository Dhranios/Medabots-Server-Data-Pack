...
execute as @e[scores={Stage=42},tag=practise_battle] run tag @e[scores={Stage=42},tag=medabot] add practise_robattle
execute as @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/lagdou_ruins_7
