...
execute if block -1597 44 -159 minecraft:lime_wool run scoreboard players set @e[x=-1585.5,y=45,z=-164.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
