...
execute if block -1617 44 -156 minecraft:lime_wool run scoreboard players set @e[x=-1616.5,y=45,z=-166.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
