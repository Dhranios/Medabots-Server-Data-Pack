...
execute if entity @e[x=72.5,y=53,z=89.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=63.5,y=53,z=17.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @e[x=33.5,y=53,z=88.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=31.5,y=53,z=18.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @e[x=64.5,y=53,z=2.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] if entity @e[x=27.5,y=53,z=15.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=46.5,y=53,z=24.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
execute if block 78 53 36 minecraft:iron_trapdoor[open=true] if block 72 53 85 minecraft:black_stained_glass if entity @s[x=76,y=53,z=36,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/0
execute if entity @e[x=88.5,y=53,z=81.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=77.5,y=53,z=36.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=72.5,y=53,z=84.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
execute if block 69 53 22 minecraft:iron_trapdoor[open=true] unless block 72 52 15 minecraft:lime_wool if entity @s[x=69,y=53,z=21,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/1
execute if entity @e[x=73.5,y=53,z=16.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=69.5,y=53,z=22.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,State=1..2},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 52 53 18 minecraft:iron_trapdoor[open=true] unless block 39 52 12 minecraft:lime_wool if entity @s[x=51,y=53,z=15,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/2
execute if entity @e[x=43.5,y=53,z=11.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
execute if entity @e[x=43.5,y=53,z=11.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] if entity @e[x=48.5,y=53,z=7.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] if entity @e[x=31.5,y=53,z=2.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] if entity @e[x=39.5,y=53,z=6.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] if entity @e[x=36.5,y=53,z=8.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] if entity @e[x=30.5,y=53,z=12.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] if entity @e[x=28.5,y=53,z=2.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run tag @s add mission_success
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=52.5,y=53,z=18.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,State=1..2},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 21 53 22 minecraft:iron_trapdoor[open=true] if block 12 52 6 minecraft:water if entity @s[x=20,y=53,z=19,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/3
execute if entity @e[x=18.5,y=53,z=17.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=21.5,y=53,z=22.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,State=1..2},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 47 53 25 minecraft:iron_trapdoor[open=true] if block 51 53 29 minecraft:air if entity @s[x=45,y=53,z=25,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/4
execute if entity @e[x=47.5,y=53,z=31.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=46.5,y=53,z=25.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 21 53 48 minecraft:iron_trapdoor[open=true] if block 18 53 67 minecraft:black_stained_glass if entity @s[x=19,y=53,z=48,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/5
execute if entity @e[x=15.5,y=53,z=60.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=20.5,y=53,z=48.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=18.5,y=53,z=67.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,State=1..2},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 19 53 68 minecraft:iron_trapdoor[open=true] if block 36 53 81 minecraft:black_stained_glass if entity @s[x=17,y=53,z=68,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/6
execute if entity @e[x=16.5,y=53,z=77.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=18.5,y=53,z=68.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=36.5,y=53,z=81.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,State=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,State=1..2},tag=enemy_medabot] run function medabots_server:stage/exit/enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
tag @s[tag=mission_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 37 53 80 minecraft:iron_trapdoor[open=true] if block 46 53 67 minecraft:black_stained_glass if entity @s[x=37,y=53,z=79,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/7
execute if entity @e[x=47.5,y=53,z=81.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
title @s[scores={BattlingMedabots=1,State=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=37.5,y=53,z=80.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=46.5,y=53,z=67.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run kill @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:paradise_a/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 46 53 64 minecraft:iron_trapdoor[open=true] if entity @s[x=45,y=53,z=61,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_a/first_go_battle/8
execute if entity @e[x=0,y=8,z=0,dx=94,dy=49,dz=94,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,State=1..2}]
