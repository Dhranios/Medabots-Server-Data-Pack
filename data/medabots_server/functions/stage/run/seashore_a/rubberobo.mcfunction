...
execute if entity @e[x=7.5,y=53,z=12.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=55.5,y=53,z=17.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute as @e[x=0,y=51,z=0,dx=63,dy=7,dz=63] unless entity @s[scores={Stage=0..}] run scoreboard players set @s Stage 4
