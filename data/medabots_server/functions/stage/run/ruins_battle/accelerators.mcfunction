...
tag @s[scores={BattlingMedabots=1,State=1..},tag=story_battle,advancements={medabots_server:story_progression/infinity={vs_jaxy=true,vs_jaxy_battle=false}}] add dialog_infinity_vs_jaxy_battle
tag @s[scores={BattlingMedabots=1,State=1..,KillStreak=3},tag=story_battle] add dialog_infinity_postgame_doctor_haru_battle
