...
execute as @e[x=-1972,y=43,z=-640,dx=48,dy=7,dz=48,type=!minecraft:player] unless entity @s[scores={Stage=0..}] run scoreboard players set @s Stage 47
...
tag @s[scores={BattlingMedabots=1,State=1..},tag=story_battle,advancements={medabots_server:story_progression/infinity={opening=true,opening_battle=false}}] add dialog_infinity_opening_battle
tag @s[scores={BattlingMedabots=1,State=1..,KillStreak=3},tag=story_battle] add dialog_infinity_postgame_director_tune_battle
