...
execute if block -1646 44 -632 minecraft:lime_wool run scoreboard players set @e[x=-1644.5,y=45,z=-628.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if block -1643 44 -623 minecraft:lime_wool run scoreboard players set @e[x=-1647.5,y=45,z=-612.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
execute if block -1638 44 -636 minecraft:yellow_wool run scoreboard players remove @e[x=-1635.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] Moving 1
execute if block -1638 44 -636 minecraft:yellow_wool run tag @e[x=-1635.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] add changed
execute if block -1638 44 -636 minecraft:yellow_wool run scoreboard players add @e[x=-1653.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] Moving 1
execute if block -1638 44 -636 minecraft:yellow_wool run tag @e[x=-1653.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=!changed] add changed
execute if block -1638 44 -636 minecraft:orange_wool run scoreboard players add @e[x=-1635.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=changed] Moving 1
execute if block -1638 44 -636 minecraft:orange_wool run tag @e[x=-1635.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=changed] remove changed
execute if block -1638 44 -636 minecraft:orange_wool run scoreboard players remove @e[x=-1653.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=changed] Moving 1
execute if block -1638 44 -636 minecraft:orange_wool run tag @e[x=-1653.5,y=45,z=-634.5,distance=..0.7,tag=fan,type=minecraft:armor_stand,tag=changed] remove changed
execute if block -1618 45 -589 minecraft:iron_trapdoor[open=true] if block -1613 45 -593 minecraft:air if entity @s[x=-1619,y=45,z=-592,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_b/first_go_battle/0
...
execute if entity @e[x=-1609.5,y=45,z=-590.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1617.5,y=45,z=-588.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
execute if block -1656 45 -589 minecraft:iron_trapdoor[open=true] if block -1659 45 -586 minecraft:air if entity @s[x=-1658,y=45,z=-589,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_b/first_go_battle/1
...
execute if entity @e[x=-1657.5,y=45,z=-582.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1655.5,y=45,z=-588.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1650 45 -600 minecraft:iron_trapdoor[open=true] if block -1648 45 -601 minecraft:air if entity @s[x=-1651,y=45,z=-603,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_b/first_go_battle/2
...
execute if entity @e[x=-1651.5,y=45,z=-601.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1649.5,y=45,z=-599.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1644 45 -607 minecraft:iron_trapdoor[open=true] if block -1646 45 -609 minecraft:air if entity @s[x=-1645,y=44,z=-610,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_b/first_go_battle/3
...
execute if entity @e[x=-1640.5,y=45,z=-608.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1643.5,y=45,z=-606.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerNeeded=1}] PowerAmount 1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1659 45 -628 minecraft:iron_trapdoor[open=true] if entity @s[x=-1661,y=45,z=-628,dx=3,dy=3,dz=3] run function medabots_server:stage/create/paradise_b/first_go_battle/4
