...
execute as @e[x=-1376,y=39,z=-205,dx=62,dy=10,dz=86,type=!minecraft:player] unless entity @s[scores={Stage=0..}] run scoreboard players set @s Stage 39
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] as @a[scores={Stage=39}] positioned -1345 51 -127 run function medabots_server:stage/clear
