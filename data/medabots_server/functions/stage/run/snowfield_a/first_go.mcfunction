...
execute if entity @e[x=39.5,y=53,z=40.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=5,Medabot=0..,State=1}]
...
execute if entity @e[x=0,y=50,z=0,dx=105,dy=7,dz=63,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=5,Medabot=0..,State=1}]
