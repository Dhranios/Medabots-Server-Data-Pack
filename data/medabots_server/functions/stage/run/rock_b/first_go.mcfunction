...
execute if block -1595 45 -344 minecraft:iron_trapdoor[open=true] if block -1583 45 -343 minecraft:black_stained_glass if entity @s[x=-1595,y=45,z=-345,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/first_go_battle/0
...
execute if block -1622 45 -359 minecraft:iron_trapdoor[open=true] if block -1634 42 -381 minecraft:cobblestone if entity @s[x=-1621,y=45,z=-360,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/first_go_battle/1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1615 45 -372 minecraft:iron_trapdoor[open=true] if entity @s[x=-1615,y=45,z=-373,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/first_go_battle/2
