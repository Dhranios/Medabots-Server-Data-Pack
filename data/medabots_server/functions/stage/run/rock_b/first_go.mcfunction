...
execute if block -1595 45 -344 minecraft:iron_trapdoor[open=true] if block -1583 45 -343 minecraft:barrier if entity @s[x=-1595,y=45,z=-345,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/first_go_battle/0
