...
execute if entity @e[x=-1604.5,y=45,z=-320.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=..0}] run scoreboard players set @e[x=-1604.5,y=45,z=-319.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if entity @e[x=-1605.5,y=45,z=-334.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=-1605.5,y=45,z=-335.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=-1605.5,y=45,z=-334.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=..0}] run scoreboard players set @e[x=-1605.5,y=45,z=-335.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if block -1595 45 -344 minecraft:iron_trapdoor[open=true] if block -1583 45 -343 minecraft:black_stained_glass if entity @s[x=-1595,y=45,z=-345,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/0
...
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1594.5,y=45,z=-343.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run scoreboard players set @e[x=-1582.5,y=45,z=-342.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1622 45 -359 minecraft:iron_trapdoor[open=true] if block -1634 42 -381 minecraft:cobblestone if entity @s[x=-1621,y=45,z=-360,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/1
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1621.5,y=45,z=-358.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1615 45 -372 minecraft:iron_trapdoor[open=true] if entity @s[x=-1615,y=45,z=-373,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/2
