...
execute if block -1603 44 -321 minecraft:lime_wool run scoreboard players set @e[x=-1589.5,y=45,z=-332.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1607 44 -321 minecraft:lime_wool run scoreboard players set @e[x=-1613.5,y=45,z=-331.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1576 44 -357 minecraft:yellow_wool run scoreboard players set @e[x=-1576.5,y=45,z=-357.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=0}] PowerAmount 1
execute if block -1576 44 -357 minecraft:orange_wool run scoreboard players set @e[x=-1576.5,y=45,z=-357.5,distance=..0.7,tag=door,type=minecraft:armor_stand,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1595 45 -344 minecraft:iron_trapdoor[open=true] if block -1583 45 -343 minecraft:barrier if entity @s[x=-1595,y=45,z=-345,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/0
