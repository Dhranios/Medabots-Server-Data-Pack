...
execute if entity @e[x=31.5,y=53,z=61.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=31.5,y=53,z=62.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=31.5,y=53,z=61.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=..0}] run scoreboard players set @e[x=31.5,y=53,z=62.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if entity @e[x=30.5,y=53,z=47.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=1..}] run scoreboard players set @e[x=30.5,y=53,z=46.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @e[x=30.5,y=53,z=47.5,distance=..0.7,tag=floor_switch,type=minecraft:armor_stand,scores={Time=..0}] run scoreboard players set @e[x=30.5,y=53,z=46.5,distance=..0.7,tag=hammer_punch,type=minecraft:area_effect_cloud,scores={PowerAmount=1}] PowerAmount 0
execute if block 41 53 38 minecraft:iron_trapdoor[open=true] if block 53 53 39 minecraft:black_stained_glass if entity @s[x=41,y=53,z=37,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/0
execute if entity @e[x=48.5,y=53,z=37.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=11,Medabot=0..,State=1..2}]
...
execute if block 14 53 23 minecraft:iron_trapdoor[open=true] if block 2 50 1 minecraft:cobblestone if entity @s[x=15,y=53,z=22,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/1
execute if entity @e[x=21.5,y=53,z=26.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=11,Medabot=0..,State=1..2}]
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 21 53 10 minecraft:iron_trapdoor[open=true] if entity @s[x=21,y=53,z=9,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/rubberobo_battle/2
execute if entity @e[x=0,y=51,z=0,dx=63,dy=7,dz=63,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=11,Medabot=0..,State=1..2}]
...
advancement grant @s[scores={BattlingMedabots=1,State=1..}] only medabots_server:stages/wave_1/rock_b_rubberobo
execute if entity @s[scores={BattlingMedabots=1,State=1..}] run bossbar set medabots_server:rock_b/robattle players
tag @s[scores={BattlingMedabots=1,State=1..},advancements={medabots_server:story_progression/infinity={rubberobo_enters_rock_b=true,rubberobo_leaves_rock_b=false}}] add dialog_infinity_rubberobo_leaves_rock_b
