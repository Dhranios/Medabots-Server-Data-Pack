...
execute if block 41 53 38 minecraft:iron_trapdoor[open=true] if block 53 53 39 minecraft:black_stained_glass if entity @s[x=41,y=53,z=37,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/second_go_battle/0
...
execute if block 14 53 23 minecraft:iron_trapdoor[open=true] if block 2 50 1 minecraft:cobblestone if entity @s[x=15,y=53,z=22,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/second_go_battle/1
...
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block 21 53 10 minecraft:iron_trapdoor[open=true] if entity @s[x=21,y=53,z=9,dx=3,dy=3,dz=3] run function medabots_server:stage/create/rock_b/second_go_battle/2
