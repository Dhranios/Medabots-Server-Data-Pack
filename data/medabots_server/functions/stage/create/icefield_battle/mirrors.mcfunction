execute positioned 26 53 24 run function medabots_server:set_blocks/glass
execute positioned 21 53 23 run function medabots_server:set_blocks/glass
execute positioned 20 53 27 run function medabots_server:set_blocks/mirror/45
execute positioned 27 53 20 run function medabots_server:set_blocks/mirror/45
execute positioned 24 53 9 run function medabots_server:set_blocks/mirror/45
execute positioned 9 53 24 run function medabots_server:set_blocks/mirror/45
execute positioned 15 53 32 run function medabots_server:set_blocks/mirror/45
execute positioned 23 53 38 run function medabots_server:set_blocks/mirror/45
execute positioned 38 53 23 run function medabots_server:set_blocks/mirror/45
execute positioned 32 53 15 run function medabots_server:set_blocks/mirror/45
execute positioned 20 53 20 run function medabots_server:set_blocks/mirror/-45
execute positioned 27 53 27 run function medabots_server:set_blocks/mirror/-45
execute positioned 23 53 9 run function medabots_server:set_blocks/mirror/-45
execute positioned 15 53 15 run function medabots_server:set_blocks/mirror/-45
execute positioned 9 53 23 run function medabots_server:set_blocks/mirror/-45
execute positioned 24 53 38 run function medabots_server:set_blocks/mirror/-45
execute positioned 32 53 32 run function medabots_server:set_blocks/mirror/-45
execute positioned 38 53 24 run function medabots_server:set_blocks/mirror/-45
