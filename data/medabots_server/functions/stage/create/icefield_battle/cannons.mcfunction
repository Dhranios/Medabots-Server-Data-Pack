execute positioned 9 53 6 run function medabots_server:spawn_entities/cannon/still/east/delay_4
execute positioned 6 53 9 run function medabots_server:spawn_entities/cannon/still/south/delay_4
execute positioned 6 53 38 run function medabots_server:spawn_entities/cannon/still/north/delay_4
execute positioned 9 53 41 run function medabots_server:spawn_entities/cannon/still/east/delay_4
execute positioned 38 53 41 run function medabots_server:spawn_entities/cannon/still/west/delay_4
execute positioned 41 53 38 run function medabots_server:spawn_entities/cannon/still/north/delay_4
execute positioned 41 53 9 run function medabots_server:spawn_entities/cannon/still/south/delay_4
execute positioned 38 53 6 run function medabots_server:spawn_entities/cannon/still/west/delay_4
execute positioned 13 53 8 run function medabots_server:set_blocks/accelerator/east
execute positioned 7 53 13 run function medabots_server:set_blocks/accelerator/south
execute positioned 8 53 34 run function medabots_server:set_blocks/accelerator/north
execute positioned 13 53 40 run function medabots_server:set_blocks/accelerator/east
execute positioned 34 53 39 run function medabots_server:set_blocks/accelerator/west
execute positioned 40 53 34 run function medabots_server:set_blocks/accelerator/north
execute positioned 39 53 13 run function medabots_server:set_blocks/accelerator/south
execute positioned 34 53 7 run function medabots_server:set_blocks/accelerator/west
