...
execute if entity @s[scores={ArenaType=0}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=0}] -1264 41 5 0 0
...
execute if entity @s[scores={ArenaType=1}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=0}] -1264 41 5 0 0
execute if entity @s[scores={ArenaType=1}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=1}] -1263 41 3 0 0
execute if entity @s[scores={ArenaType=1}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=2}] -1262 40.6 7 0 0
...
execute if entity @s[scores={ArenaType=2}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=0}] -1312 41 3 0 0
execute if entity @s[scores={ArenaType=2}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=1}] -1264 41 5 0 0
execute if entity @s[scores={ArenaType=2}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=2}] -1264 41 3 0 0
...
execute if entity @s[scores={ArenaType=3}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=0}] -1264 41 5 0 0
execute if entity @s[scores={ArenaType=3}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=1}] -1270 41 50 0 0
execute if entity @s[scores={ArenaType=3}] run teleport @a[x=-1319,y=50,z=-2,dx=59,dy=4,dz=62,scores={StageIndex=2}] -1306 44 35 0 0
