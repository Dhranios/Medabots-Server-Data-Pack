...
execute if entity @s[tag=vs_cpus,scores={ArenaType=0..1}] run function medabots_server:stage/create/lagdou_ruins_4/darkness
...
execute if entity @s[tag=!vs_cpus] run data merge block -1344 52 -133 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/lagdou_ruins_4/try"}}'}
execute if entity @s[tag=!vs_cpus] run setblock -1346 53 -135 minecraft:redstone_block
execute if entity @s[tag=!vs_cpus] run data merge block -1346 52 -133 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/join/lagdou_ruins_4/cancel"}}',Text3:'{"translate":"medabots_server:sign.stage.cancel"}'}
