scoreboard players set @a[distance=..10,tag=awaiting_challenge_response,scores={State=3}] State 1
scoreboard players set @a[distance=..10,tag=challenged_to_robattle,scores={State=3}] State 1
tag @a[distance=..10,tag=awaiting_challenge_response,scores={State=1}] add main
execute unless entity @s[scores={Jukebox=1..}] run scoreboard players set @a[distance=..10,tag=awaiting_challenge_response,scores={State=1}] Music 0
...
tag @a[distance=..10,tag=awaiting_challenge_response,scores={State=1}] remove awaiting_challenge_response
