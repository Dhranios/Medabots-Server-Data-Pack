...
execute if entity @s[tag=!vs_cpus] run data merge block -1538 52 -247 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/seashore_a/try"}}'}
execute if entity @s[tag=!vs_cpus] run setblock -1540 53 -249 minecraft:redstone_block
execute if entity @s[tag=!vs_cpus] run data merge block -1540 52 -247 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/join/seashore_a/cancel"}}',Text3:'{"translate":"medabots_server:sign.stage.cancel"}'}
