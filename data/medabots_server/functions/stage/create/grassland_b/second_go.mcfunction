...
execute positioned -1526 45 -345 run function medabots_server:spawn_entities/cannon/swiffle/east/delay_4
...
execute positioned -1538 45 -382 run function medabots_server:spawn_entities/cannon/swiffle/west/delay_3
...
execute positioned -1542 45 -390 run function medabots_server:spawn_entities/cannon/swiffle/east/delay_4
execute positioned -1542 45 -395 run function medabots_server:spawn_entities/cannon/swiffle/east/delay_4
execute positioned -1550 45 -405 run function medabots_server:spawn_entities/cannon/swiffle/south/delay_4
...
execute positioned -1568 45 -351 run function medabots_server:set_blocks/action_floor/round_stone/east/power_0
execute positioned -1569 45 -352 run function medabots_server:set_blocks/action_floor/round_stone/east/power_0
execute positioned -1569 45 -353 run function medabots_server:set_blocks/action_floor/round_stone/east/power_0
execute positioned -1569 45 -354 run function medabots_server:set_blocks/action_floor/round_stone/east/power_0
...
teleport @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=-1] -1538 45 -326 0 0
teleport @s[tag=-1] -1538 45 -326 0 0
