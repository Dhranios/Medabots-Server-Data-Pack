execute positioned 23 53 18 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 23 53 23 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 18 53 23 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 18 53 18 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 18 53 6 run function medabots_server:set_blocks/hammer_punch/south/delay_10/power_0
execute positioned 23 53 2 run function medabots_server:set_blocks/hammer_punch/south/delay_10/power_0
execute positioned 35 53 18 run function medabots_server:set_blocks/hammer_punch/west/delay_10/power_0
execute positioned 39 53 23 run function medabots_server:set_blocks/hammer_punch/west/delay_10/power_0
execute positioned 23 53 35 run function medabots_server:set_blocks/hammer_punch/north/delay_10/power_0
execute positioned 18 53 39 run function medabots_server:set_blocks/hammer_punch/north/delay_10/power_0
execute positioned 6 53 23 run function medabots_server:set_blocks/hammer_punch/east/delay_10/power_0
execute positioned 2 53 18 run function medabots_server:set_blocks/hammer_punch/east/delay_10/power_0
