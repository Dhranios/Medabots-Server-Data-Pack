execute positioned 33 53 19 run function medabots_server:set_blocks/stone
execute positioned 33 53 28 run function medabots_server:set_blocks/stone
execute positioned 28 53 33 run function medabots_server:set_blocks/stone
execute positioned 19 53 33 run function medabots_server:set_blocks/stone
execute positioned 14 53 28 run function medabots_server:set_blocks/stone
execute positioned 14 53 19 run function medabots_server:set_blocks/stone
execute positioned 19 53 14 run function medabots_server:set_blocks/stone
execute positioned 28 53 14 run function medabots_server:set_blocks/stone
execute positioned 41 53 32 run function medabots_server:set_blocks/stone
execute positioned 32 53 41 run function medabots_server:set_blocks/stone
execute positioned 15 53 41 run function medabots_server:set_blocks/stone
execute positioned 6 53 32 run function medabots_server:set_blocks/stone
execute positioned 6 53 15 run function medabots_server:set_blocks/stone
execute positioned 15 53 6 run function medabots_server:set_blocks/stone
execute positioned 32 53 6 run function medabots_server:set_blocks/stone
execute positioned 41 53 15 run function medabots_server:set_blocks/stone
