execute positioned 33 53 19 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 33 53 28 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 28 53 33 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 19 53 33 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 14 53 28 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 14 53 19 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 19 53 14 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
execute positioned 28 53 14 run function medabots_server:set_blocks/action_floor/bomb/delay_0/power_0
