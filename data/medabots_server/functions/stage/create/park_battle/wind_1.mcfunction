execute positioned 30 53 30 run function medabots_server:set_blocks/floor_switch/yellow/delay_20
execute positioned 45 53 30 run function medabots_server:set_blocks/floor_switch/yellow/delay_20
execute positioned 45 53 45 run function medabots_server:set_blocks/floor_switch/yellow/delay_20
execute positioned 30 53 45 run function medabots_server:set_blocks/floor_switch/yellow/delay_20
execute positioned 32 53 32 run function medabots_server:spawn_entities/raft
execute positioned 43 53 32 run function medabots_server:spawn_entities/raft
execute positioned 43 53 43 run function medabots_server:spawn_entities/raft
execute positioned 32 53 43 run function medabots_server:spawn_entities/raft
execute positioned 27 53 32 run function medabots_server:set_blocks/fan/east/slow/range_15
execute positioned 27 53 43 run function medabots_server:set_blocks/fan/east/off/range_15
execute positioned 48 53 43 run function medabots_server:set_blocks/fan/west/slow/range_15
execute positioned 48 53 32 run function medabots_server:set_blocks/fan/west/off/range_15
execute positioned 43 53 27 run function medabots_server:set_blocks/fan/south/slow/range_15
execute positioned 32 53 27 run function medabots_server:set_blocks/fan/south/off/range_15
execute positioned 32 53 48 run function medabots_server:set_blocks/fan/north/slow/range_15
execute positioned 43 53 48 run function medabots_server:set_blocks/fan/north/off/range_15
