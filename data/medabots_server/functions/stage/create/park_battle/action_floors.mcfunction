execute positioned 1 53 38 run function medabots_server:set_blocks/action_floor/round_stone/east/power_0
execute positioned 12 53 27 run function medabots_server:set_blocks/action_floor/round_stone/south/power_0
execute positioned 22 53 37 run function medabots_server:set_blocks/action_floor/round_stone/west/power_0
execute positioned 11 53 48 run function medabots_server:set_blocks/action_floor/round_stone/north/power_0
execute positioned 18 53 31 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 18 53 44 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 5 53 44 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
execute positioned 5 53 31 run function medabots_server:set_blocks/action_floor/bomb/delay_5/power_0
