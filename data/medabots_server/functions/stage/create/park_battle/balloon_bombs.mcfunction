...
execute positioned 31 53 14 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 31 53 9 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 31 53 5 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 35 53 5 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 35 53 9 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 35 53 14 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 35 53 18 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 40 53 18 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 40 53 14 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 40 53 9 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 40 53 5 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 44 53 5 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 44 53 9 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 44 53 14 run function medabots_server:spawn_entities/balloon_bomb
execute positioned 44 53 18 run function medabots_server:spawn_entities/balloon_bomb
...
execute if entity @s[scores={ArenaType=1}] run teleport @a[scores={StageIndex=2,Gamemode=0,Stage=50}] 29 53 9 0 0
...
execute if entity @s[scores={ArenaType=1},tag=vs_cpus,tag=!story_battle] positioned 29 53 9 run function medabots_server:stage/create/park_battle/random_enemy
