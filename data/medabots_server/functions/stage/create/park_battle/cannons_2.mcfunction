execute positioned 19 53 3 run function medabots_server:spawn_entities/cannon/swivel/west/delay_4
execute positioned 4 53 20 run function medabots_server:spawn_entities/cannon/swivel/east/delay_4
execute positioned 3 53 4 run function medabots_server:spawn_entities/cannon/swivel/south/delay_4
execute positioned 20 53 19 run function medabots_server:spawn_entities/cannon/swivel/north/delay_4
execute positioned 21 53 13 run function medabots_server:spawn_entities/cannon/still/west/delay_4
execute positioned 2 53 10 run function medabots_server:spawn_entities/cannon/still/east/delay_4
execute positioned 10 53 2 run function medabots_server:spawn_entities/cannon/still/south/delay_4
execute positioned 13 53 21 run function medabots_server:spawn_entities/cannon/still/north/delay_4
