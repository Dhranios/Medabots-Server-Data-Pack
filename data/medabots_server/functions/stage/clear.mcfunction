...
execute if entity @s[tag=cleared_custom_stage] run setblock -286 0 -52 minecraft:shulker_box{Items:[{Slot:0b,id:"minecraft:diamond_pickaxe",Count:1b,tag:{}}]}
execute if entity @s[tag=cleared_custom_stage] run data modify block -286 0 -52 Items[0].tag merge from entity @s Inventory[{Slot:-106b}].tag
