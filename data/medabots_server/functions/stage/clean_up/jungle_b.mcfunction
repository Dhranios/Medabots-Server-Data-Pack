...
scoreboard players set @a[scores={Stage=12},tag=medabot,distance=0.1..] Battle 0
teleport @a[scores={Stage=12},tag=medabot,distance=0.1..] -1620 51 -431 -180 0
scoreboard players set @s[scores={Stage=12,Battle=0}] Music 0
scoreboard players set @s[scores={Stage=12,Battle=0}] MusicType 1
scoreboard players set @s[scores={Stage=12,Battle=0}] Battle 0
teleport @s[scores={Stage=12,Battle=0}] -1620 51 -431 -180 0
