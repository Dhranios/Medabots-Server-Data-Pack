execute as @e[x=0,y=47,z=0,dx=74,dy=9,dz=77,type=!minecraft:player] unless entity @s[scores={Stage=42}] run scoreboard players set @s Stage 42
...
teleport @a[scores={Stage=42},tag=medabot,distance=0.1..] 31 58 49 -180 0
...
teleport @s[scores={Stage=42,State=0}] 31 58 49 -180 0
tag @e[scores={Stage=42},type=!minecraft:player] add dead
scoreboard players reset @a[scores={Stage=42},distance=0.1..] StageVersion
scoreboard players reset @a[scores={Stage=42},distance=0.1..] Stage
