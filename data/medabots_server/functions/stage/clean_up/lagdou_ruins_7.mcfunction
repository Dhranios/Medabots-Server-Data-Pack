...
scoreboard players set @a[scores={Stage=42},tag=enemy_medabot] Music 0
scoreboard players set @a[scores={Stage=42},tag=enemy_medabot] MusicType 1
scoreboard players set @a[scores={Stage=42},tag=enemy_medabot] Battle 0
teleport @a[scores={Stage=42},tag=enemy_medabot] -1280 51 -171 -180 0
