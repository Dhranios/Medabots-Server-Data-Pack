...
scoreboard players set @a[scores={Stage=62},tag=enemy_medabot] Music 0
scoreboard players set @a[scores={Stage=62},tag=enemy_medabot] MusicType 1
scoreboard players set @a[scores={Stage=62},tag=enemy_medabot] Battle 0
teleport @a[scores={Stage=62},tag=enemy_medabot] -1985 43 -196 -180 0
