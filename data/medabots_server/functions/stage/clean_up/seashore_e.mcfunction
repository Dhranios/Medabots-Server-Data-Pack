execute as @e[x=0,y=50,z=0,dx=93,dy=7,dz=78,type=!minecraft:player] unless entity @s[scores={Stage=55}] run scoreboard players set @s Stage 55
...
teleport @a[scores={Stage=55},tag=medabot,distance=0.1..] 46 59 39 -180 0
...
teleport @s[scores={Stage=55,State=0}] 46 59 39 -180 0
...
data merge block 45 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/seashore_e/play"}}'}
