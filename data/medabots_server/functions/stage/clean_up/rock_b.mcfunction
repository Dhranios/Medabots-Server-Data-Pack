execute as @e[x=0,y=51,z=0,dx=63,dy=7,dz=63,type=!minecraft:player] unless entity @s[scores={Stage=11}] run scoreboard players set @s Stage 11
...
teleport @a[scores={Stage=11},tag=medabot,distance=0.1..] 32 59 31 -180 0
...
teleport @s[scores={Stage=11,State=0}] 32 59 31 -180 0
...
data merge block 31 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/rock_b/play"}}'}
