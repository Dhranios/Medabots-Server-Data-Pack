...
scoreboard players set @a[scores={Stage=8},tag=medabot,distance=0.1..] Battle 0
teleport @a[scores={Stage=8},tag=medabot,distance=0.1..] -1683 50 -259 -180 0
...
scoreboard players reset @a[scores={Stage=8}] StageVersion
scoreboard players reset @a[scores={Stage=8}] Stage
