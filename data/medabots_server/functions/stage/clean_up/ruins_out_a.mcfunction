execute as @e[x=0,y=50,z=0,dx=127,dy=7,dz=64,type=!minecraft:player] unless entity @s[scores={Stage=7}] run scoreboard players set @s Stage 7
...
teleport @a[scores={Stage=7},tag=medabot,distance=0.1..] 64 59 31 -180 0
...
teleport @s[scores={Stage=7,State=0}] 64 59 31 -180 0
