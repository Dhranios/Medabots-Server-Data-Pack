execute as @e[x=0,y=50,z=0,dx=62,dy=7,dz=95,type=!minecraft:player] unless entity @s[scores={Stage=58}] run scoreboard players set @s Stage 58
...
teleport @a[scores={Stage=58},tag=medabot,distance=0.1..] 30 59 47 -180 0
...
teleport @s[scores={Stage=58,State=0}] 30 59 47 -180 0
...
data merge block 29 60 2 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ruins_out_e/play"}}'}
setblock 29 61 0 minecraft:stone_button[face=wall,facing=north,powered=true]
