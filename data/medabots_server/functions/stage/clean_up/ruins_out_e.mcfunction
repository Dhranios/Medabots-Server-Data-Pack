...
data merge block -1891 52 -534 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ruins_out_e/play"}}'}
setblock -1891 53 -536 minecraft:redstone_block
