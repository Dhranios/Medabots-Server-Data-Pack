...
scoreboard players set @a[scores={Stage=35},tag=medabot,distance=0.1..] Battle 0
...
scoreboard players reset @a[scores={Stage=35}] StageVersion
scoreboard players reset @a[scores={Stage=35}] Stage
