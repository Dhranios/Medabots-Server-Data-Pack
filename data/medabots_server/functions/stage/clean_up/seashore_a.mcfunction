...
scoreboard players set @a[scores={Stage=4},tag=medabot,distance=0.1..] Battle 0
teleport @a[scores={Stage=4},tag=medabot,distance=0.1..] -1539 51 -216 -180 0
...
scoreboard players reset @a[scores={Stage=4}] StageVersion
scoreboard players reset @a[scores={Stage=4}] Stage
