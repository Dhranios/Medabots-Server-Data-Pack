...
execute if entity @s[scores={Dialog=0,Verified=3},advancements={medabots_server:story_progression/infinity={bonus_area_pass=true,spykes_challenge=false}}] run tag @s add dialog_infinity_spykes_challenge