...
execute if entity @s[advancements={medabots_server:story_progression/other={ruins_in_b_fvbico=false},medabots_server:stages/wave_1/boxer_first_go=true}] run tag @s add dialog_other_ruins_in_b_fvbico