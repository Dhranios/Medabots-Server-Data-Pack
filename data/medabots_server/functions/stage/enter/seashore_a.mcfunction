...
execute if entity @s[advancements={medabots_server:story_progression/infinity={rubberobo_enters_seashore_a=false},medabots_server:stages/wave_1/rock_a_rubberobo=true,medabots_server:stages/wave_1/snowfield_a_rubberobo=true,medabots_server:stages/wave_1/ruins_in_a_rubberobo=true}] run tag @s add dialog_infinity_rubberobo_enters_seashore_a