...
execute if entity @s[advancements={medabots_server:story_progression/other={salesman_mermaid_medal=true,salesman_mermaid_medal_find=false}}] run tag @s add dialog_other_salesman_mermaid_medal_find