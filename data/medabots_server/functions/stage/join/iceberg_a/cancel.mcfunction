execute unless entity @a[scores={Stage=6,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1703 51 -244 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=6,Gamemode=0,StageIndex=-1},limit=1] run setblock -1703 52 -246 minecraft:red_wool
...
execute unless entity @a[scores={Stage=6,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1705 51 -244 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/iceberg_a/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block -1703 51 -244 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1703 52 -246 minecraft:red_wool
teleport @s[scores={StageIndex=-1}] -1721 29 -220 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block -1705 51 -244 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/iceberg_a/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1705 52 -246 minecraft:red_wool
