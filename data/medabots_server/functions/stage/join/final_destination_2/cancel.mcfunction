...
execute if entity @s[scores={StageIndex=-1}] run data merge block 50 44 33 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/final_destination_2/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
