execute unless entity @a[scores={Stage=2,Gamemode=0,StageIndex=-1},limit=1] run data merge block 33 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=2,Gamemode=0,StageIndex=-1},limit=1] run setblock 33 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=2,Gamemode=0,StageIndex=-1},limit=1] run data merge block 31 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/rock_a/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
teleport @s[scores={StageIndex=-1}] 52 45 37 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 31 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/rock_a/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
