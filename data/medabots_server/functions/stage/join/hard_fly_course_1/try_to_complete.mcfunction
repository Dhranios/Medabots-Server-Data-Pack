...
execute if score #temp NeededPlayers matches 0 run setblock -469 92 266 minecraft:stone_button[face=wall,facing=north,powered=true]
...
execute if score #temp NeededPlayers matches 0 run setblock -469 92 268 minecraft:stone_button[face=wall,facing=north,powered=true]
