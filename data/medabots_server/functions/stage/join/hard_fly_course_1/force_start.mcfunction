...
setblock -469 92 266 minecraft:stone_button[face=wall,facing=north,powered=true]
...
setblock -469 92 268 minecraft:stone_button[face=wall,facing=north,powered=true]
function medabots_server:stage/sign/hard_fly_course_1/race_starting