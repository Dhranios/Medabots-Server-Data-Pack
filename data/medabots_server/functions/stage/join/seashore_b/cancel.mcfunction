...
execute if entity @s[scores={StageIndex=-1}] run setblock 48 61 -3 minecraft:air
teleport @s[scores={StageIndex=-1}] 50 45 45 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 46 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/seashore_b/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
