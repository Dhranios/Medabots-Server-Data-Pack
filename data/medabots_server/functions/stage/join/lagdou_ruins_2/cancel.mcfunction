...
execute if entity @s[scores={StageIndex=-1}] run data merge block 35 62 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 35 63 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 44 35 28 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 33 62 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/lagdou_ruins_2/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 33 63 -2 minecraft:air
