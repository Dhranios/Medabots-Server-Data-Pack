execute unless entity @a[scores={Stage=46,Gamemode=0,StageIndex=-1},limit=1] run data merge block 65 93 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=46,Gamemode=0,StageIndex=-1},limit=1] run setblock 65 94 -2 minecraft:air
...
execute unless entity @a[scores={Stage=46,Gamemode=0,StageIndex=-1},limit=1] run data merge block 63 93 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ricco_harbor/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 65 93 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 65 94 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 72 43 48 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 63 93 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ricco_harbor/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 63 94 -2 minecraft:air
