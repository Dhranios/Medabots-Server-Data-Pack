...
execute if entity @s[tag=0] if entity @a[x=-1570,y=50,z=-545,dx=62,dy=4,dz=62,tag=1] run data merge block -1540 51 -545 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/jungle_c/second_go/1"}}'}
...
execute if entity @s[tag=0] unless entity @a[x=-1570,y=50,z=-545,dx=62,dy=4,dz=62,tag=1] run data merge block -1540 51 -545 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/jungle_c/second_go/0"}}'}
...
execute if entity @s[tag=1] run data merge block -1540 51 -545 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/jungle_c/second_go/0"}}'}
execute if entity @s[tag=1] run scoreboard players set @s Battle 0
execute if entity @s[tag=1] run tag @s remove 1