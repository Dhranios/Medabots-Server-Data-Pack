...
teleport @s[scores={StageIndex=-1}] 33 38 33 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 28 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/jungle_c/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
