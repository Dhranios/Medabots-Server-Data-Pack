...
execute if entity @s[scores={StageIndex=0..}] as @a[scores={Stage=26,Gamemode=0}] if score @s StageIndex > #temp StageIndex run scoreboard players remove @s StageIndex 1
