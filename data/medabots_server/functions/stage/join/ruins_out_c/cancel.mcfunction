execute unless entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1634 51 -703 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
...
execute unless entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1636 51 -701 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ruins_out_c/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block -1634 51 -703 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1634 52 -705 minecraft:red_wool
teleport @s[scores={StageIndex=-1}] -1630 29 -671 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block -1636 51 -701 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_out_c/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1636 52 -703 minecraft:red_wool
