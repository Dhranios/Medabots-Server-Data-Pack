execute unless entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] run data merge block 31 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] run setblock 31 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] run data merge block 29 60 3 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ruins_out_c/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 31 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 31 61 -1 minecraft:air
teleport @s[scores={StageIndex=-1}] 35 38 33 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 29 60 3 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_out_c/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 29 61 1 minecraft:air
