...
execute unless entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] run setblock -1634 52 -705 minecraft:red_wool
...
execute if entity @a[scores={Stage=27,Gamemode=0,StageIndex=-1},limit=1] if entity @s[gamemode=adventure,tag=valid_tinpet,scores={Dialog=0}] run function medabots_server:stage/join/ruins_out_c/join
