execute unless entity @a[scores={Stage=28,Gamemode=0,StageIndex=-1},limit=1] run data merge block 11 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=28,Gamemode=0,StageIndex=-1},limit=1] run setblock 11 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=28,Gamemode=0,StageIndex=-1},limit=1] run data merge block 9 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/laboratory_c/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 11 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 11 61 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 17 38 25 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 9 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/laboratory_c/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 9 61 -1 minecraft:air
