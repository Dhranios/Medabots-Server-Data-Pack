...
teleport @s[scores={StageIndex=-1}] 31 34 32 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 29 61 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/lagdou_ruins_3/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
