...
execute if score #temp NeededPlayers matches 0 run data merge block -1761 51 -763 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if score #temp NeededPlayers matches 0 run setblock -1759 52 -763 minecraft:red_wool
execute if score #temp NeededPlayers matches 0 run data merge block -1764 51 -763 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_in_d/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if score #temp NeededPlayers matches 0 run setblock -1766 52 -763 minecraft:red_wool
