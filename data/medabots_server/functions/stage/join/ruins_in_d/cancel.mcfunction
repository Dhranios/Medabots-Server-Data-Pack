execute unless entity @a[scores={Stage=34,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1761 51 -763 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=34,Gamemode=0,StageIndex=-1},limit=1] run setblock -1759 52 -763 minecraft:red_wool
...
execute unless entity @a[scores={Stage=34,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1764 51 -763 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ruins_in_d/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block -1761 51 -763 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1759 52 -763 minecraft:red_wool
teleport @s[scores={StageIndex=-1}] -1760 29 -764 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block -1764 51 -763 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_in_d/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1766 52 -763 minecraft:red_wool
