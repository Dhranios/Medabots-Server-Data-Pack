...
execute if score #temp NeededPlayers matches 0 run data merge block 28 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/seashore_c/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
