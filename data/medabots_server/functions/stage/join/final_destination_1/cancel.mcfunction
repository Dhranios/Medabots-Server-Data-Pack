...
execute if entity @s[scores={StageIndex=-1}] run data merge block -2016 44 -195 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -2014 45 -195 minecraft:red_wool
teleport @s[scores={StageIndex=-1}] -2041 12 -249 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block -2016 44 -197 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/final_destination_1/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -2014 45 -197 minecraft:red_wool
