execute unless entity @a[scores={Stage=19,Gamemode=0,StageIndex=-1},limit=1] run data merge block 46 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=19,Gamemode=0,StageIndex=-1},limit=1] run setblock 46 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=19,Gamemode=0,StageIndex=-1},limit=1] run data merge block 44 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/park_a/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 46 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 46 61 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 52 45 46 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 44 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/park_a/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 44 61 -2 minecraft:air
