...
execute if entity @a[scores={Stage=44,Gamemode=0,StageIndex=-1},limit=1] if entity @s[gamemode=adventure,tag=valid_tinpet,scores={Dialog=0,Level=45..},advancements={medabots_server:stages/wave_1/lagdou_ruins_8_second_go=true}] run function medabots_server:stage/join/lagdou_ruins_9/join
...
execute unless entity @s[scores={Level=45..}] run tellraw @s[gamemode=adventure] {"translate":"medabots_server:message.stage.requires.not_matching","with":[{"translate":"medabots_server:message.stage.requirements.lagdou_ruins_9.0"}]}
execute unless entity @s[advancements={medabots_server:stages/wave_1/lagdou_ruins_8_second_go=true}] run tellraw @s[gamemode=adventure] {"translate":"medabots_server:message.stage.requires.not_matching","with":[{"translate":"medabots_server:message.stage.requirements.lagdou_ruins_9.1"}]}
