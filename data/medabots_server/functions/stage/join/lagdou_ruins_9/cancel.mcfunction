...
execute if entity @s[scores={StageIndex=-1}] run data merge block -1287 52 -279 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1287 53 -281 minecraft:red_wool
teleport @s[scores={StageIndex=-1}] -1280 25 -247 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block -1289 52 -279 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/lagdou_ruins_9/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
