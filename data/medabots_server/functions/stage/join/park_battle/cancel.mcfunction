execute unless entity @a[scores={Stage=50,Gamemode=0,StageIndex=-1},limit=1] run data merge block 25 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=50,Gamemode=0,StageIndex=-1},limit=1] run setblock 25 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=50,Gamemode=0,StageIndex=-1},limit=1] run data merge block 23 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/park_battle/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 25 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 25 61 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 29 45 24 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 23 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/park_battle/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 23 61 -2 minecraft:air
