execute unless entity @a[scores={Stage=54,Gamemode=0,StageIndex=-1},limit=1] run data merge block 46 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=54,Gamemode=0,StageIndex=-1},limit=1] run setblock 46 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=54,Gamemode=0,StageIndex=-1},limit=1] run data merge block 48 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/jungle_e/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
teleport @s[scores={StageIndex=-1}] 46 45 47 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 48 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/jungle_e/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
