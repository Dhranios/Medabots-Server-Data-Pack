...
execute if score #temp NeededPlayers matches 0 run data merge block 29 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/snowfield_d/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
