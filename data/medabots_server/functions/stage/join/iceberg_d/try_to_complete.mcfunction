...
execute if score #temp NeededPlayers matches 0 run setblock -1699 52 -795 minecraft:air
...
execute if score #temp NeededPlayers matches 0 run setblock -1701 52 -795 minecraft:air

execute if score #temp NeededPlayers matches 0 unless entity @s[scores={StageVersion=0..}] run function medabots_server:stage/create/iceberg_d/custom
