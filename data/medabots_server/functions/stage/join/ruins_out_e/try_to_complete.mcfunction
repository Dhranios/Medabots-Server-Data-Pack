...
execute if score #temp NeededPlayers matches 0 run data merge block -1891 52 -534 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if score #temp NeededPlayers matches 0 run setblock -1891 53 -536 minecraft:red_wool
