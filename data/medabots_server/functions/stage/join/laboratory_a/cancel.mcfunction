...
execute unless entity @a[scores={Stage=9,Gamemode=0,StageIndex=-1},limit=1] run setblock -1771 52 -323 minecraft:red_wool
...
execute unless entity @a[scores={Stage=9,Gamemode=0,StageIndex=-1},limit=1] run data merge block -1773 51 -321 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/laboratory_a/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block -1773 51 -321 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/laboratory_a/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock -1773 52 -323 minecraft:red_wool
