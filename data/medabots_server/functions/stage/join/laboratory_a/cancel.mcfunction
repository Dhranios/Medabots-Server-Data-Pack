execute unless entity @a[scores={Stage=9,Gamemode=0,StageIndex=-1},limit=1] run data merge block 40 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=9,Gamemode=0,StageIndex=-1},limit=1] run setblock 40 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=9,Gamemode=0,StageIndex=-1},limit=1] run data merge block 38 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/laboratory_a/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 40 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 40 61 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 47 38 31 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 38 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/laboratory_a/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
