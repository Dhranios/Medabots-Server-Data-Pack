execute unless entity @a[scores={Stage=49,Gamemode=0,StageIndex=-1},limit=1] run data merge block 21 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=49,Gamemode=0,StageIndex=-1},limit=1] run setblock 21 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=49,Gamemode=0,StageIndex=-1},limit=1] run data merge block 19 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/ruins_battle/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
execute if entity @s[scores={StageIndex=-1}] run data merge block 21 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 21 61 -2 minecraft:air
teleport @s[scores={StageIndex=-1}] 22 45 24 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 19 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_battle/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 19 61 -2 minecraft:air
