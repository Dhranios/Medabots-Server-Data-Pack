...
execute if entity @s[scores={StageIndex=-1}] run data merge block 32 59 42 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 32 60 40 minecraft:air
teleport @s[scores={StageIndex=-1}] 28 32 35 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 30 59 42 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/lagdou_ruins_7/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[scores={StageIndex=-1}] run setblock 30 60 40 minecraft:air
