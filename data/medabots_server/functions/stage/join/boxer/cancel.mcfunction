execute unless entity @a[scores={Stage=29,Gamemode=0,StageIndex=-1},limit=1] run data merge block 32 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute unless entity @a[scores={Stage=29,Gamemode=0,StageIndex=-1},limit=1] run setblock 32 61 -2 minecraft:air
...
execute unless entity @a[scores={Stage=29,Gamemode=0,StageIndex=-1},limit=1] run data merge block 30 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/boxer/play"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
...
teleport @s[scores={StageIndex=-1}] 41 38 24 90 0
execute if entity @s[scores={StageIndex=-1}] run data merge block 30 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/boxer/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
