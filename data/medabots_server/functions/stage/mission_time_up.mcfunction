...
execute if entity @s[scores={Dialog=82..},tag=!run_until_the_time_is_up] as @e[tag=this_mission] run scoreboard players set @s State 2
execute if entity @s[scores={Dialog=162},tag=!run_until_the_time_is_up] as @a[tag=this_mission] run function medabots_server:stage/exit/enforced
...
execute if entity @s[scores={Dialog=82},tag=run_until_the_time_is_up] as @a[tag=enemy_medabot,tag=this_mission] run function medabots_server:stage/exit/enforced
