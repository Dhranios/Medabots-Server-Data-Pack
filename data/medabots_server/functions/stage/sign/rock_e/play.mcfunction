...
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1861 52 -345 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/rock_e/enter"}}'}
