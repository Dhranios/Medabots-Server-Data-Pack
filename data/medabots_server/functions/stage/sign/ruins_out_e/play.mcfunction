...
teleport @s[scores={Dialog=0},gamemode=adventure] 26 45 42 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 29 60 2 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_out_e/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 29 61 0 minecraft:air
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 58
