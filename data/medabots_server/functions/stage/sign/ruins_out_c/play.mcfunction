...
teleport @s[scores={Dialog=0},gamemode=adventure] 35 38 33 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 29 60 3 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_out_c/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 29 61 1 minecraft:air
