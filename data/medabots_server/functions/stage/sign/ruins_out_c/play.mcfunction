...
teleport @s[scores={Dialog=0},gamemode=adventure] -1630 29 -671 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1636 51 -701 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_out_c/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock -1636 52 -703 minecraft:red_wool
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 27
