...
teleport @s[scores={Dialog=0},gamemode=adventure] 31 45 36 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 31 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/rock_b/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 31 61 -2 minecraft:air
