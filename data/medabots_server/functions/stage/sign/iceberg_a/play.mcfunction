...
teleport @s[scores={Dialog=0},gamemode=adventure] 41 38 25 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 57 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/iceberg_a/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 57 61 -1 minecraft:air
