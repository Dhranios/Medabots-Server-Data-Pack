...
teleport @s[scores={Dialog=0},gamemode=adventure] -1721 29 -220 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1705 51 -244 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/iceberg_a/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock -1705 52 -246 minecraft:red_wool
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 6
