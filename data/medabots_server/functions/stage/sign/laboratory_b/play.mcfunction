...
teleport @s[scores={Dialog=0},gamemode=adventure] 50 38 55 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 32 60 29 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/laboratory_b/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 32 61 27 minecraft:air
