...
teleport @s[scores={Dialog=0},gamemode=adventure] -1826 29 -769 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1828 51 -806 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_in_d/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock -1828 52 -808 minecraft:red_wool
