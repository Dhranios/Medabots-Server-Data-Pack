...
teleport @s[scores={Dialog=0},gamemode=adventure] 50 45 58 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 44 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_out_b/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 44 61 -1 minecraft:air
