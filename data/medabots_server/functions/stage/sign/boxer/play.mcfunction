...
teleport @s[scores={Dialog=0},gamemode=adventure] 41 38 24 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 30 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/boxer/enter"}}'}
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 29
