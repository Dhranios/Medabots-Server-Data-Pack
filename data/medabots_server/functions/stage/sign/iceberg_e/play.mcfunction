...
teleport @s[scores={Dialog=0},gamemode=adventure] 42 38 39 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 40 60 17 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/iceberg_e/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 40 61 15 minecraft:air
