...
teleport @s[scores={Dialog=0},gamemode=adventure] -1716 37 -475 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1716 52 -538 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/seashore_b/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock -1716 53 -540 minecraft:red_wool
