...
teleport @s[scores={Dialog=0},gamemode=adventure] 33 45 28 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 29 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/grassland_b/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 29 61 -2 minecraft:air
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 30
