...
teleport @s[scores={Dialog=0},gamemode=adventure] -1709 37 -693 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1715 52 -730 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/paradise_a/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock -1715 53 -732 minecraft:red_wool
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 21
