...
execute if entity @s[scores={KillStreak=1..3}] run function medabots_server:stage/try/ruins_battle/story_battle

execute unless entity @s[scores={Gamemode=0,State=1..3}] run function medabots_server:stage/sign/ruins_battle/random
