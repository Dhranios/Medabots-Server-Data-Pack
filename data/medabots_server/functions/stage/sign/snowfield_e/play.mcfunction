...
teleport @s[scores={Dialog=0},gamemode=adventure] 39 45 33 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 38 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/snowfield_e/enter"}}'}
