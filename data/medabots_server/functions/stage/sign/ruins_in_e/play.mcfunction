...
teleport @s[scores={Dialog=0},gamemode=adventure] 42 38 38 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 33 60 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_in_e/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 33 61 -1 minecraft:air
