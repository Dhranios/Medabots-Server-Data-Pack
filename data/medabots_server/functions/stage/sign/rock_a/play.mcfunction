...
teleport @s[scores={Dialog=0},gamemode=adventure] 52 45 37 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 31 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/rock_a/enter"}}'}
