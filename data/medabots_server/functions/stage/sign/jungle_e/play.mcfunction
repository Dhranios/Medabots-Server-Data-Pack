...
teleport @s[scores={Dialog=0},gamemode=adventure] 46 45 47 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 46 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/jungle_e/enter"}}'}
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 54
