...
teleport @s[scores={Dialog=0},gamemode=adventure] -1614 29 -516 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block -1621 51 -572 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_in_b/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock -1621 52 -574 minecraft:red_wool
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 17
