...
teleport @s[scores={Dialog=0},gamemode=adventure] 52 38 56 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 45 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/ruins_in_b/enter"}}'}
