...
teleport @s[scores={Dialog=0},gamemode=adventure] 52 45 46 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 44 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/park_a/enter"}}'}
execute if entity @s[scores={Dialog=0},gamemode=adventure] run setblock 44 61 -2 minecraft:air
