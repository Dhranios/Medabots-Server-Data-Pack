...
teleport @s[scores={Dialog=0},gamemode=adventure] 34 45 35 90 0
execute if entity @s[scores={Dialog=0},gamemode=adventure] run data merge block 29 60 0 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/jungle_d/enter"}}'}
...
scoreboard players set @s[scores={Dialog=0},gamemode=adventure] Stage 31
