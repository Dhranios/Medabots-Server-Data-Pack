...
execute if entity @s[tag=!missing_medabot,tag=!no_saving] run setblock -286 0 -52 minecraft:oak_sign{Text1:'{"italic":false,"color":"white","translate":"medabots_server:item.custom_stage.owner","with":[{"nbt":"Item.tag.medabots_server.owner","entity":"@e[tag=build_stage,limit=1]"}]}'}
execute if entity @s[tag=!missing_medabot,tag=!no_saving] run data modify entity @e[tag=build_stage,limit=1] Item.tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=!missing_medabot,tag=!no_saving] run setblock -286 0 -52 minecraft:bedrock
...
execute if entity @s[tag=!missing_medabot,tag=!no_saving,scores={NeededPlayers=1..}] run setblock -286 0 -52 minecraft:oak_sign{Text1:'{"italic":false,"color":"white","translate":"medabots_server:item.custom_stage.vs","with":[{"score":{"objective":"NeededPlayers","name":"@a[scores={StageBuild=-2},limit=1]"}}]}'}
execute if entity @s[tag=!missing_medabot,tag=!no_saving,scores={NeededPlayers=1..}] run data modify entity @e[tag=build_stage,limit=1] Item.tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=!missing_medabot,tag=!no_saving,scores={NeededPlayers=1..}] run setblock -286 0 -52 minecraft:bedrock
