...
execute if entity @s[tag=!missing_medabot,tag=!no_saving] run data modify entity @e[tag=build_stage,limit=1] Item.tag.display.Lore[1] set from block -286 0 -52 Text1
