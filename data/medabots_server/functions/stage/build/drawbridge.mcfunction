...
execute if entity @s[scores={StageBuild=13},y_rotation=45..135] unless block ~1 ~1 ~ minecraft:air run tag @s remove allowed
execute if entity @s[scores={StageBuild=13},y_rotation=-45..45] unless block ~ ~1 ~-1 minecraft:air run tag @s remove allowed
execute if entity @s[scores={StageBuild=13},y_rotation=135..-135] unless block ~ ~1 ~1 minecraft:air run tag @s remove allowed
execute if entity @s[scores={StageBuild=13},y_rotation=-135..-45] unless block ~-1 ~1 ~ minecraft:air run tag @s remove allowed
