...
scoreboard players set @s[nbt={Inventory:[{Slot:0b,tag:{medabots_server:{move:"float",activated:1b}}}]}] FlyHackTime 0
scoreboard players set @s[scores={Gamemode=1}] FlyHackTime 0
