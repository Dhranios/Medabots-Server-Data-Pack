...
scoreboard players operation @e[distance=..0.7,tag=cannon] CannonNr > @e[tag=cannon] CannonNr
scoreboard players add @e[distance=..0.7,tag=cannon] CannonNr 1
scoreboard players set @e[distance=..0.7,tag=cannon] CannonFire 0
scoreboard players set @e[distance=..0.7,tag=cannon] DelayTime 0
scoreboard players set @e[distance=..0.7,tag=cannon] Time 20
...
execute as @e[tag=cannon_model,distance=..0.1] unless entity @s[scores={CannonNr=1..}] run scoreboard players operation @s CannonNr = @e[distance=..0.1,limit=1,tag=cannon] CannonNr