...
playsound medabots_server:music.credits_intro music @s[scores={Jukebox=7},advancements={medabots_server:special_items/jukebox/credits=true}] ~ ~ ~ 1000
scoreboard players set @s[scores={Jukebox=7},advancements={medabots_server:special_items/jukebox/credits=true}] Music 454
