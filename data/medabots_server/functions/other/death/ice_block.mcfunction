...
tag @s add me
execute if entity @s[tag=medabot] run tellraw @a[tag=this_robattle] {"translate":"medabots_server:death.ice_block","with":[{"selector":"@s"},{"translate":"medabots_server:entity.ice_block"}]}
tag @s add had_death
