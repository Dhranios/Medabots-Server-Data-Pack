...
tag @s add me
execute if entity @s[tag=medabot] run tellraw @a[tag=this_robattle] {"translate":"medabots_server:death.round_stone","with":[{"selector":"@s"},{"translate":"medabots_server:entity.round_stone"}]}
tag @s add had_death
