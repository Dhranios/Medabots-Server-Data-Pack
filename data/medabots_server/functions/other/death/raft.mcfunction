...
tag @s add me
execute if entity @s[tag=medabot] run tellraw @a[tag=this_robattle] {"translate":"medabots_server:death.raft","with":[{"selector":"@s"},{"translate":"medabots_server:entity.raft"}]}
tag @s add had_death
