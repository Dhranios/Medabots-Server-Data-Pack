...
tag @s add me
execute if entity @s[tag=medabot] run tellraw @a[tag=this_robattle] {"translate":"medabots_server:death.balloon_bomb","with":[{"selector":"@s"},{"translate":"medabots_server:entity.balloon_bomb"}]}
tag @s add had_death
