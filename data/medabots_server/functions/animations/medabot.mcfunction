...
execute as @e[type=minecraft:armor_stand,tag=medabot_model,tag=!found_owner,tag=chest] if score @s MedabotNr = #temp MedabotNr run function medabots_server:animations/medabot/main
execute as @e[type=minecraft:armor_stand,tag=medabot_model,tag=!found_owner,tag=!chest] if score @s MedabotNr = #temp MedabotNr run function medabots_server:animations/medabot/main
