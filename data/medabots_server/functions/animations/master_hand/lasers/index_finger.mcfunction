...
execute if entity @s[scores={AnimationProg=31..70}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 1
execute if entity @s[scores={AnimationProg=71..110}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 1
