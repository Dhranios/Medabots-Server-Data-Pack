...
execute if entity @s[scores={AnimationProg=71..110}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 1
execute if entity @s[scores={AnimationProg=111..150}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 1
...
execute if entity @s[scores={AnimationProg=3..197}] at @e[type=minecraft:ghast,tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^ ^0.6 ^0.3
