...
execute if entity @s[scores={AnimationProg=11..56}] rotated ~ 0 run teleport @s ^1.3 ^-0.3 ^
execute if entity @s[scores={AnimationProg=1..10}] rotated ~ 0 run teleport @s ^1.3 ^0.3 ^
