...
execute if entity @s[scores={AnimationProg=1}] run data modify entity @s Pose.Head[1] set value -20f
execute if entity @s[scores={AnimationProg=1}] run data modify entity @s Pose.Head[0] set value -20f
execute if entity @s[scores={AnimationProg=1..}] at @e[type=minecraft:ghast,tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^1.3 ^-0.3 ^
