...
execute if entity @s[tag=!was_appearing,tag=!fast_idle,tag=!grab,tag=!grab_success,tag=!ram,tag=!punch,tag=!drill,tag=!walk_start,tag=!walk,tag=!walk_stop,tag=!walk_kick,tag=!slap,tag=!crush,tag=!poke] run function medabots_server:animations/master_hand/idle/middle_finger
...
execute if entity @s[tag=walk_start] run function medabots_server:animations/master_hand/walk_start/middle_finger
...
execute if entity @s[tag=walk] run function medabots_server:animations/master_hand/walk/middle_finger
