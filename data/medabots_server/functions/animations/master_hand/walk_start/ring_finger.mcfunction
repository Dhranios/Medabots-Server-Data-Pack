...
execute if entity @s[scores={AnimationProg=10..19}] rotated ~ 0 run teleport @s ^ ^-0.1 ^0.1
execute if entity @s[scores={AnimationProg=20}] rotated ~ 0 run teleport @s ^ ^-0.5 ^0.6