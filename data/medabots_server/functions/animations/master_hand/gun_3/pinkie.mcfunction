...
execute if entity @s[scores={AnimationProg=1..3}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 45
execute if entity @s[scores={AnimationProg=107..109}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 45
...
execute if entity @s[scores={AnimationProg=3..106}] at @e[type=minecraft:ghast,tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^-0.5 ^0.3 ^0.5
