...
execute if entity @s[scores={AnimationProg=87..89}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 45
...
execute if entity @s[scores={AnimationProg=3..86}] at @e[type=minecraft:ghast,tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^-0.5 ^0.3 ^0.5
