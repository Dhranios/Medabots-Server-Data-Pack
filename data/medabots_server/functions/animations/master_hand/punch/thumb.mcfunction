...
execute if entity @s[scores={AnimationProg=1}] run data modify entity @s Pose.Head[0] set value -156f
execute if entity @s[scores={AnimationProg=1}] run data modify entity @s Pose.Head[1] set value -70f
