...
execute if entity @s[scores={AnimationProg=2}] run data modify entity @s Pose.Head[1] set value -70f
...
execute if entity @s[scores={AnimationProg=..81}] at @e[type=minecraft:ghast,tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^1.3 ^-0.3 ^
