...
execute if entity @s[scores={AnimationProg=1..8}] rotated ~ 0 run teleport @s ^ ^-0.3 ^0.4
execute if entity @s[scores={AnimationProg=1}] run data modify entity @s Pose.Head[0] set value 90f
execute store result score #temp Time run data get entity @s Pose.Head[0]
execute if entity @s[scores={AnimationProg=9..12}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 18
