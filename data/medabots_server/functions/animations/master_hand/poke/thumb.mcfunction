...
execute if entity @s[scores={AnimationProg=3..98}] at @e[type=minecraft:ghast,tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^1.1 ^-0.3 ^
...
execute if entity @s[scores={AnimationProg=5}] run data modify entity @s Pose.Head[2] set value 70f
