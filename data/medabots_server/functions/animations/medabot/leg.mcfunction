...
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] if entity @s[nbt=!{ArmorItems:[{tag:{medabots_server:{move:"multi_legged"}}}]},nbt=!{ArmorItems:[{tag:{medabots_server:{model_data:{height:0,leg_offset:[]}}}}]},tag=!dancing,tag=!carried] run function medabots_server:animations/medabot/walking/two_legged_legs
...
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] if entity @s[nbt={ArmorItems:[{tag:{medabots_server:{model_data:{height:0,leg_offset:[]}}}}]},tag=!dancing,tag=!carried] run function medabots_server:animations/medabot/walking/legs
