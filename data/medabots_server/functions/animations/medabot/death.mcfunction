...
execute if entity @s[scores={DeathTime=1}] as @e[tag=this_medabot] run function medabots_server:animations/medabot/main
...
execute if entity @s[scores={DeathTime=1..99}] positioned as @e[tag=this_medabot,tag=chest,limit=1] rotated as @s rotated ~ 0 run teleport @s ^0.105 ^2 ^-1.5 facing entity @e[tag=this_medabot,limit=1]
...
execute if entity @s[scores={DeathTime=100}] at @e[tag=this_medabot,tag=chest] positioned ~ ~0.7 ~ run particle minecraft:cloud ~ ~ ~ 1 1 1 0 30
