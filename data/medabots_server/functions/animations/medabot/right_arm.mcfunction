...
data modify entity @s[tag=guarding] Pose.Head[0] set value -50.0f
data modify entity @s[tag=guarding] Pose.Head[1] set value -38.0f
...
# Equipped arms
tag @s[tag=right_arm_selected] add selected
...
execute unless entity @s[tag=swimming,tag=!dancing] run function medabots_server:animations/medabot/idle/right_arm
...
execute if entity @s[tag=sneaking,tag=!selected,tag=!guarding,tag=!edge_grabbing,tag=!dancing,tag=!carried] run function medabots_server:animations/medabot/sneaking/right_arm
execute if entity @s[tag=walking,tag=!selected,tag=!guarding,tag=!edge_grabbing,tag=!dancing,tag=!carried] run function medabots_server:animations/medabot/walking/right_arm
execute if entity @s[tag=running,tag=!selected,tag=!guarding,tag=!edge_grabbing,tag=!dancing,tag=!carried] run function medabots_server:animations/medabot/running/right_arm
execute if entity @s[tag=swimming,tag=!selected,tag=!guarding,tag=!dancing] run function medabots_server:animations/medabot/swimming/right_arm