...
summon minecraft:armor_stand ~ ~ ~ {NoGravity:1b,Invisible:1b,Marker:1b,Tags:["hips","medabot_model","model_piece","new"],CustomName:'{"translate":"medabots_server:entity.model_piece"}'}
