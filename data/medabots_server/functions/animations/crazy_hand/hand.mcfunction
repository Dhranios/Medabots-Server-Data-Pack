...
execute if entity @s[tag=grab,tag=!grab_success] run function medabots_server:animations/crazy_hand/grab/hand
...
execute if entity @s[tag=ram] run function medabots_server:animations/crazy_hand/ram/hand
