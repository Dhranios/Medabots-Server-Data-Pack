...
execute if entity @s[scores={AnimationProg=73..76}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
execute if entity @s[scores={AnimationProg=77..83}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={AnimationProg=84..85}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
