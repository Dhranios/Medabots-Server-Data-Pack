...
execute if entity @s[scores={AnimationProg=73..78}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 6
execute if entity @s[scores={AnimationProg=79..85}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 6
