...
execute if entity @s[scores={AnimationProg=73..77}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 6
execute if entity @s[scores={AnimationProg=78..84}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 6
execute if entity @s[scores={AnimationProg=85}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 6
