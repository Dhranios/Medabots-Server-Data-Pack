...
execute if entity @s[tag=!was_appearing,tag=!grab,tag=!grab_success,tag=!ram,tag=!punch,tag=!drill,tag=!slap,tag=!crush,tag=!poke] run function medabots_server:animations/crazy_hand/idle/pinkie
