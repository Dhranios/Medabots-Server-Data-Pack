...
execute if entity @s[scores={AnimationProg=11..56}] at @e[type=minecraft:ghast,tag=this_crazy_hand,limit=1] rotated ~ 0 run teleport @s ^-1.3 ^-0.3 ^
execute if entity @s[scores={AnimationProg=1..10}] at @e[type=minecraft:ghast,tag=this_crazy_hand,limit=1] rotated ~ 0 run teleport @s ^-1.3 ^0.3 ^
