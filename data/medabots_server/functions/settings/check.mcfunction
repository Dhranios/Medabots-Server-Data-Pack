...
# Toggle random arena version
tellraw @s[scores={SettingsCheck=14,PlayerInteract=1..}] {"translate":"medabots_server:settings.player_interacted","color":"blue"}
tellraw @s[scores={SettingsCheck=14,PlayerInteract=0},tag=!player_interactions] {"translate":"medabots_server:settings.modified.player_interactions","color":"blue","clickEvent":{"action":"run_command","value":"/trigger SettingsCheck set 14"},"hoverEvent":{"action":"show_text","value":{"translate":"medabots_server:settings.click.modify"}},"with":[{"translate":"medabots_server:settings.on"}]}
tellraw @s[scores={SettingsCheck=14,PlayerInteract=0},tag=player_interactions] {"translate":"medabots_server:settings.modified.player_interactions","color":"blue","clickEvent":{"action":"run_command","value":"/trigger SettingsCheck set 14"},"hoverEvent":{"action":"show_text","value":{"translate":"medabots_server:settings.click.modify"}},"with":[{"translate":"medabots_server:settings.off"}]}
tag @s[scores={SettingsCheck=14,PlayerInteract=0},tag=!player_interactions] add toggle_player_interactions
tag @s[scores={PlayerInteract=0},tag=toggle_player_interactions] add player_interactions
