...
# Equip message
tellraw @s[tag=valid,scores={EditingTinpet=0},nbt=!{Inventory:[{Slot:0b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=1},nbt=!{Inventory:[{Slot:1b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=2},nbt=!{Inventory:[{Slot:2b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=3},nbt=!{Inventory:[{Slot:3b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=4},nbt=!{Inventory:[{Slot:4b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=5},nbt=!{Inventory:[{Slot:5b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=6},nbt=!{Inventory:[{Slot:6b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=7},nbt=!{Inventory:[{Slot:7b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=8},nbt=!{Inventory:[{Slot:8b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=0},nbt={Inventory:[{Slot:0b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:0b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=1},nbt={Inventory:[{Slot:1b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:1b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=2},nbt={Inventory:[{Slot:2b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:2b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=3},nbt={Inventory:[{Slot:3b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:3b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=4},nbt={Inventory:[{Slot:4b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:4b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=5},nbt={Inventory:[{Slot:5b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:5b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=6},nbt={Inventory:[{Slot:6b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:6b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
tellraw @s[tag=valid,scores={EditingTinpet=7},nbt={Inventory:[{Slot:7b,tag:{medabots_server:{items:{head:{Count:1b}}}}}]}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:item.tinpet","color":"green"},{"translate":"medabots_server:message.tinpet.equipped.switched","with":[{"nbt":"SelectedItem.tag.display.Lore[5]","interpret":true,"entity":"@s","extra":[{"text":" "},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"}]},{"nbt":"Inventory[{Slot:7b}].tag.display.Lore[1]","interpret":true,"entity":"@s"}]}]}
...
execute if entity @s[tag=valid,scores={EditingTinpet=0}] run data modify block -286 0 -52 Items[{Slot:0b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=1}] run data modify block -286 0 -52 Items[{Slot:1b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=2}] run data modify block -286 0 -52 Items[{Slot:2b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=3}] run data modify block -286 0 -52 Items[{Slot:3b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=4}] run data modify block -286 0 -52 Items[{Slot:4b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=5}] run data modify block -286 0 -52 Items[{Slot:5b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=6}] run data modify block -286 0 -52 Items[{Slot:6b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=7}] run data modify block -286 0 -52 Items[{Slot:7b}].tag.medabots_server.items.head set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=8}] run data modify block -286 0 -52 Items[{Slot:8b}].tag.medabots_server.items.head set from entity @s SelectedItem
...
# Show equipped head name in Lore
...
execute if entity @s[tag=valid,scores={EditingTinpet=0}] run data modify block -286 1 -52 Items[{Slot:0b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=1}] run data modify block -286 1 -52 Items[{Slot:1b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=2}] run data modify block -286 1 -52 Items[{Slot:2b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=3}] run data modify block -286 1 -52 Items[{Slot:3b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=4}] run data modify block -286 1 -52 Items[{Slot:4b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=5}] run data modify block -286 1 -52 Items[{Slot:5b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=6}] run data modify block -286 1 -52 Items[{Slot:6b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=7}] run data modify block -286 1 -52 Items[{Slot:7b}].tag.display.Lore[1] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=8}] run data modify block -286 1 -52 Items[{Slot:8b}].tag.display.Lore[1] set from block -286 0 -52 Text1
