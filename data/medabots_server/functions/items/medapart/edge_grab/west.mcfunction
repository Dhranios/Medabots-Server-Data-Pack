...
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~ ~ #minecraft:trapdoors[open=true,facing=north] run scoreboard players set @s EdgeGrabAble 0
...
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~1 ~ #minecraft:stairs[facing=south,shape=straight] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~1 ~ #minecraft:stairs[facing=south,shape=inner_left] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~1 ~ #minecraft:stairs[facing=south,shape=inner_right] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~1 ~ #minecraft:stairs[facing=east,shape=inner_right] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~1 ~ #minecraft:stairs[facing=west,shape=inner_left] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~-1 ~1 ~ minecraft:piston_head[facing=west] run scoreboard players set @s EdgeGrabAble 0
