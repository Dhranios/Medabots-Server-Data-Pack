...
execute at @s positioned ~ ~1.7 ~ if block ~ ~ ~ minecraft:black_stained_glass positioned ~ ~-1 ~ if entity @e[type=minecraft:area_effect_cloud,distance=..0.7,tag=ice_block] run tag @s add continue
execute at @s positioned ~ ~1.7 ~ if block ~ ~ ~ minecraft:black_stained_glass if block ~ ~-1 ~ minecraft:black_stained_glass positioned ~ ~-1 ~ if entity @e[type=minecraft:armor_stand,distance=..0.7,tag=mirror] run tag @s add mirror
execute at @s positioned ~ ~1.7 ~ if block ~ ~ ~ minecraft:black_stained_glass if block ~ ~-1 ~ minecraft:black_stained_glass positioned ~ ~-1 ~ if entity @e[type=minecraft:armor_stand,distance=..0.8,tag=mirror] run tag @s[tag=!mirror] add continue
...
execute at @s[tag=mirror] run function medabots_server:items/medapart/laser/move/try_mirror
