...
execute if entity @s[tag=!swim,tag=!had_death] anchored eyes if block ^ ^ ^ minecraft:water run function medabots_server:other/death/deep_water
execute if entity @s[tag=!swim,tag=!had_death,nbt={OnGround:0b}] if block ~ ~ ~ minecraft:water if block ~0.3 ~-1 ~ minecraft:water if block ~-0.3 ~-1 ~ minecraft:water if block ~ ~-1 ~0.3 minecraft:water if block ~ ~-1 ~-0.3 minecraft:water run function medabots_server:other/death/deep_water
