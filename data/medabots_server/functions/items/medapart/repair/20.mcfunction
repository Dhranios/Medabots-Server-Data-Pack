# Show particles
particle minecraft:portal ~ ~1 ~ 1 0 1 1 10
...
# Affect teammates
execute if entity @s[tag=ally_medabot] unless entity @s[scores={ScoutTime=1..}] run scoreboard players set @a[scores={LegsArmor=..10},distance=..16,tag=ally_medabot] LegsArmor 10
execute if entity @s[tag=ally_medabot] unless entity @s[scores={ScoutTime=1..}] run scoreboard players set @a[scores={LeftArmArmor=..10},distance=..16,tag=ally_medabot] LeftArmArmor 10
execute if entity @s[tag=ally_medabot] unless entity @s[scores={ScoutTime=1..}] run scoreboard players set @a[scores={RightArmArmor=..10},distance=..16,tag=ally_medabot] RightArmArmor 10
execute if entity @s[tag=ally_medabot] unless entity @s[scores={ScoutTime=1..}] as @a[scores={MaxLegsArmor=..10},distance=..16,tag=ally_medabot] run scoreboard players operation @s LegsArmor = @s MaxLegsArmor
execute if entity @s[tag=ally_medabot] unless entity @s[scores={ScoutTime=1..}] as @a[scores={MaxLeftArmArmor=..10},distance=..16,tag=ally_medabot] run scoreboard players operation @s LeftArmArmor = @s MaxLeftArmArmor
execute if entity @s[tag=ally_medabot] unless entity @s[scores={ScoutTime=1..}] as @a[scores={MaxRightArmArmor=..10},distance=..16,tag=ally_medabot] run scoreboard players operation @s RightArmArmor = @s MaxRightArmArmor
...
execute if entity @s[tag=enemy_medabot] unless entity @s[scores={ScoutTime=1..}] run scoreboard players set @e[scores={LegsArmor=..10},distance=..16,tag=enemy_medabot] LegsArmor 10
execute if entity @s[tag=enemy_medabot] unless entity @s[scores={ScoutTime=1..}] run scoreboard players set @e[scores={LeftArmArmor=..10},distance=..16,tag=enemy_medabot] LeftArmArmor 10
execute if entity @s[tag=enemy_medabot] unless entity @s[scores={ScoutTime=1..}] run scoreboard players set @e[scores={RightArmArmor=..10},distance=..16,tag=enemy_medabot] RightArmArmor 10
execute if entity @s[tag=enemy_medabot] unless entity @s[scores={ScoutTime=1..}] as @e[scores={MaxLegsArmor=..10},distance=..16,tag=enemy_medabot] run scoreboard players operation @s LegsArmor = @s MaxLegsArmor
execute if entity @s[tag=enemy_medabot] unless entity @s[scores={ScoutTime=1..}] as @e[scores={MaxLeftArmArmor=..10},distance=..16,tag=enemy_medabot] run scoreboard players operation @s LeftArmArmor = @s MaxLeftArmArmor
execute if entity @s[tag=enemy_medabot] unless entity @s[scores={ScoutTime=1..}] as @e[scores={MaxRightArmArmor=..10},distance=..16,tag=enemy_medabot] run scoreboard players operation @s RightArmArmor = @s MaxRightArmArmor
