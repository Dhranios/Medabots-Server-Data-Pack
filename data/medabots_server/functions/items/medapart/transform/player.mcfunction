...
scoreboard players set @s[tag=left_arm_selected,nbt={Inventory:[{tag:{medabots_server:{part:"left_arm",activated:1b,id:"medabots_server:flame_tisala_sala_arm"}}}]}] TransformLID 1
scoreboard players set @s[tag=right_arm_selected,nbt={Inventory:[{tag:{medabots_server:{part:"right_arm",activated:1b,id:"medabots_server:flame_tisala_sala_hand"}}}]}] TransformRID 1
scoreboard players set @s[tag=head_selected,nbt={Inventory:[{tag:{medabots_server:{part:"head",activated:1b,id:"medabots_server:flame_tisala_sala_head"}}}]}] TransformHID 1
scoreboard players set @s[tag=head_selected,nbt={Inventory:[{tag:{medabots_server:{part:"head",activated:1b,id:"medabots_server:potato_insect_changedress"}}}]}] TransformHID 2
...
# Transform
loot replace entity @s[tag=left_arm_selected,tag=male_tinpet] hotbar.1 loot medabots_server:gameplay/transform/left_arm/male_tinpet
loot replace entity @s[tag=right_arm_selected,tag=male_tinpet] hotbar.2 loot medabots_server:gameplay/transform/right_arm/male_tinpet
loot replace entity @s[tag=head_selected,tag=male_tinpet] hotbar.3 loot medabots_server:gameplay/transform/head/male_tinpet
loot replace entity @s[tag=left_arm_selected,tag=female_tinpet] hotbar.1 loot medabots_server:gameplay/transform/left_arm/female_tinpet
loot replace entity @s[tag=right_arm_selected,tag=female_tinpet] hotbar.2 loot medabots_server:gameplay/transform/right_arm/female_tinpet
loot replace entity @s[tag=head_selected,tag=female_tinpet] hotbar.3 loot medabots_server:gameplay/transform/head/female_tinpet
loot replace entity @s[tag=left_arm_selected,tag=neutral_tinpet] hotbar.1 loot medabots_server:gameplay/transform/left_arm/neutral_tinpet
loot replace entity @s[tag=right_arm_selected,tag=neutral_tinpet] hotbar.2 loot medabots_server:gameplay/transform/right_arm/neutral_tinpet
loot replace entity @s[tag=head_selected,tag=neutral_tinpet] hotbar.3 loot medabots_server:gameplay/transform/head/neutral_tinpet
...
execute if entity @s[tag=left_arm_selected] as @e[tag=left_arm,tag=new] run data modify entity @s ArmorItems[3] merge from entity @a[distance=..0.1,limit=1] Inventory[1]
execute if entity @s[tag=right_arm_selected] as @e[tag=right_arm,tag=new] run data modify entity @s ArmorItems[3] merge from entity @a[distance=..0.1,limit=1] Inventory[2]
execute if entity @s[tag=head_selected] as @e[tag=head,tag=new] run data modify entity @s ArmorItems[3] merge from entity @a[distance=..0.1,limit=1] Inventory[3]
