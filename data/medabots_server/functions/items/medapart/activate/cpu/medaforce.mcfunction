...
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=kuwagata_medal] Medaforce -2
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=kabuto_medal] Medaforce -3
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=mermaid_medal] Medaforce -4
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=ghost_medal] Medaforce -5
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=monkey_medal] Medaforce -6
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=spidar_medal] Medaforce -7
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=question_medal] Medaforce -8
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=chameleon_medal] Medaforce -9
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=knight_medal] Medaforce -10
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=unicorn_medal] Medaforce -11
scoreboard players set @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=devil_medal] Medaforce -12
tag @s[scores={Medaforce=2},tag=!medaforce_blocked,tag=alien_medal,tag=!random_change] add random_change
