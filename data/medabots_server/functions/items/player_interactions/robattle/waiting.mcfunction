...
execute unless entity @a[distance=..10,tag=challenged_to_robattle] run scoreboard players set @s[tag=awaiting_robattle_response] PlayerInteract -1
execute unless entity @a[distance=..10,tag=awaiting_robattle_response] run scoreboard players set @s[tag=challenged_to_robattle] PlayerInteract -1