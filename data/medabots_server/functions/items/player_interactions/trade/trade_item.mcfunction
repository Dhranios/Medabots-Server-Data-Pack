...
execute as @a[distance=..10,tag=awaiting_trade_response,tag=accepted] run data modify entity @e[type=minecraft:item,limit=1,tag=traded_item] Owner.M set from entity @s UUIDMost
execute as @a[distance=..10,tag=awaiting_trade_response,tag=accepted] run data modify entity @e[type=minecraft:item,limit=1,tag=traded_item] Owner.L set from entity @s UUIDLeast
...
execute as @a[distance=..10,tag=asked_to_trade,tag=accepted] run data modify entity @e[type=minecraft:item,limit=1,tag=traded_item] Owner.M set from entity @s UUIDMost
execute as @a[distance=..10,tag=asked_to_trade,tag=accepted] run data modify entity @e[type=minecraft:item,limit=1,tag=traded_item] Owner.L set from entity @s UUIDLeast
execute as @e[type=minecraft:item,tag=traded_item,limit=1] if data entity @s Item.tag.medabots_server.part run data merge entity @s {Age:-32768s,Item:{tag:{medabots_server:{stage_item:0b}}}}
tag @e[type=minecraft:item,tag=traded_item,limit=1] remove traded_item
