...
execute if entity @s[tag=available] if block -286 0 -52 minecraft:shulker_box{Items:[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}]} run data remove block -286 0 -52 Items[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}].tag.medabots_server.items[0]
execute if entity @s[tag=available] if block -286 1 -52 minecraft:shulker_box{Items:[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}]} run data remove block -286 1 -52 Items[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}].tag.medabots_server.items[0]
execute if entity @s[tag=available] if block -287 0 -52 minecraft:shulker_box{Items:[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}]} run data remove block -287 0 -52 Items[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}].tag.medabots_server.items[0]
...
execute if entity @s[tag=available] if block -286 0 -52 minecraft:shulker_box{Items:[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}]} run data modify block -286 0 -52 Items[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}].tag.display.Lore[1] set from block -286 3 -52 Text1
execute if entity @s[tag=available] if block -286 1 -52 minecraft:shulker_box{Items:[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}]} run data modify block -286 1 -52 Items[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}].tag.display.Lore[1] set from block -286 3 -52 Text1
execute if entity @s[tag=available] if block -287 0 -52 minecraft:shulker_box{Items:[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}]} run data modify block -287 0 -52 Items[{tag:{medabots_server:{id:"medabots_server:loot_container"}}}].tag.display.Lore[1] set from block -286 3 -52 Text1
