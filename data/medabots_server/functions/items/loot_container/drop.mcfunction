...
execute if entity @s[tag=available] run data modify entity @e[type=minecraft:item,limit=1,tag=replacing_item] Owner set from entity @s UUID
...
execute if score #temp Money matches 1 run data modify entity @e[type=minecraft:item,limit=1,tag=replacing_item] Owner set from entity @s UUID
