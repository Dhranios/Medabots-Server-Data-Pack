...
execute if entity @s[scores={Dialog=1}] positioned 20 59 18 run function medabots_server:spawn_entities/cutscene/spyke
...
execute if entity @s[scores={Dialog=152}] as @e[tag=spyke,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 19 59 0
