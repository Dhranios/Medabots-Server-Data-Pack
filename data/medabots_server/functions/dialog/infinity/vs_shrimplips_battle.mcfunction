...
execute if entity @s[scores={Dialog=1}] positioned 22 59 25 run function medabots_server:spawn_entities/cutscene/metabee
execute if entity @s[scores={Dialog=1}] positioned 23 59 28 run function medabots_server:spawn_entities/cutscene/shrimplips
...
execute if entity @s[scores={Dialog=200}] as @e[tag=shrimplips,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 24 59 49
