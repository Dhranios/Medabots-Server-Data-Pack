...
execute if entity @s[scores={Dialog=1}] positioned 49 59 30 run function medabots_server:spawn_entities/cutscene/metabee
...
execute if entity @s[scores={Dialog=536}] as @e[tag=rubberobo,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 47 59 0
