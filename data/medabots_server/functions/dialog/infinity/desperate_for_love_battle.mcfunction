...
execute if entity @s[scores={Dialog=1}] positioned 21 59 27 run function medabots_server:spawn_entities/cutscene/peppercat
...
execute if entity @s[scores={Dialog=188}] as @e[tag=peppercat,tag=!medabot_model,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 47
...
execute if entity @s[scores={Dialog=244}] as @e[tag=samantha,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 47
