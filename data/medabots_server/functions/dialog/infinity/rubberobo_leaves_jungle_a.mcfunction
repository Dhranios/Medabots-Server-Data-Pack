...
execute if entity @s[scores={Dialog=1}] positioned 32 59 35 run function medabots_server:spawn_entities/cutscene/rubberobo
...
execute if entity @s[scores={Dialog=200}] as @e[tag=rubberobo,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 32 59 63
