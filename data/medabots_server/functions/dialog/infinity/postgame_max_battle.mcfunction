...
execute if entity @s[scores={Dialog=1}] positioned 24 59 28 run function medabots_server:spawn_entities/cutscene/max
...
execute if entity @s[scores={Dialog=120}] as @e[tag=max,tag=!medabot_model,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 24 59 49
