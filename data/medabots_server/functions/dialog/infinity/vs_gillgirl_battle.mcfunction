...
execute if entity @s[scores={Dialog=1}] positioned 17 59 18 run function medabots_server:spawn_entities/cutscene/rubberobo
...
execute if entity @s[scores={Dialog=682..782}] if entity @e[x=24.5,y=59,z=31.5,type=minecraft:item,distance=..0.7,limit=1] unless entity @e[x=22.5,y=59,z=34.5,type=minecraft:item,distance=..0.7,limit=1] run scoreboard players set @s Dialog 782
execute if entity @s[scores={Dialog=682..782}] unless entity @e[x=24.5,y=59,z=31.5,type=minecraft:item,distance=..0.7,limit=1] if entity @e[x=22.5,y=59,z=34.5,type=minecraft:item,distance=..0.7,limit=1] run scoreboard players set @s Dialog 782
execute if entity @s[scores={Dialog=782}] if entity @e[x=24.5,y=59,z=31.5,type=minecraft:item,distance=..0.7,limit=1] run tag @e[tag=rubberobo,tag=this_dialog,limit=1] add ghost
execute if entity @s[scores={Dialog=782}] if entity @e[x=22.5,y=59,z=34.5,type=minecraft:item,distance=..0.7,limit=1] run tag @e[tag=rubberobo,tag=this_dialog,limit=1] add unicorn
execute if entity @s[scores={Dialog=782}] run data merge entity @e[x=24.5,y=59,z=31.5,type=minecraft:item,distance=..0.7,limit=1] {PickupDelay:1000s}
execute if entity @s[scores={Dialog=782}] run data merge entity @e[x=22.5,y=59,z=34.5,type=minecraft:item,distance=..0.7,limit=1] {PickupDelay:1000s}
execute if entity @s[scores={Dialog=782}] if entity @e[x=24.5,y=59,z=31.5,type=minecraft:item,distance=..0.7,limit=1] if entity @e[x=22.5,y=59,z=34.5,type=minecraft:item,distance=..0.7,limit=1] run scoreboard players set @s Dialog 903
...
execute if entity @s[scores={Dialog=903}] as @e[tag=rubberobo,tag=this_dialog,limit=1,tag=ghost] at @s run teleport @s ~ ~ ~ facing 24 59 31
...
execute if entity @s[scores={Dialog=939}] if entity @e[tag=rubberobo,tag=this_dialog,limit=1,tag=ghost] run kill @e[x=24.5,y=59,z=31.5,type=minecraft:item,distance=..0.7,limit=1]
execute if entity @s[scores={Dialog=920}] as @e[tag=rubberobo,tag=this_dialog,limit=1,tag=!ghost,tag=unicorn] at @s run teleport @s ~ ~ ~ facing -2000 59 34
...
execute if entity @s[scores={Dialog=940}] as @e[tag=rubberobo,tag=this_dialog,limit=1,tag=ghost,tag=unicorn] at @s run teleport @s ~ ~ ~ facing -2000 59 34
...
execute if entity @s[scores={Dialog=957}] if entity @e[tag=rubberobo,tag=this_dialog,limit=1,tag=unicorn] run kill @e[x=22.5,y=59,z=34.5,type=minecraft:item,distance=..0.7,limit=1]
execute if entity @s[scores={Dialog=958}] as @e[tag=rubberobo,tag=this_dialog,limit=1,tag=unicorn] at @s run teleport @s ~ ~ ~ facing 23 59 47
...
execute if entity @s[scores={Dialog=1061}] as @e[tag=gillgirl,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 47
