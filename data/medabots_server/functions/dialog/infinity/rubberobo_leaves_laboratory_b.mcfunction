...
execute if entity @s[scores={Dialog=1}] positioned 34 59 59 run function medabots_server:spawn_entities/cutscene/metabee
execute if entity @s[scores={Dialog=1}] positioned 33 59 62 run function medabots_server:spawn_entities/cutscene/rubberobo
...
execute if entity @s[scores={Dialog=112}] as @e[tag=rubberobo,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 33 59 91
