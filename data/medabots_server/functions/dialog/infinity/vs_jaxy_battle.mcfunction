...
execute if entity @s[scores={Dialog=1}] positioned 19 59 22 run function medabots_server:spawn_entities/cutscene/metabee
execute if entity @s[scores={Dialog=1}] positioned 20 59 25 run function medabots_server:spawn_entities/cutscene/jaxy
...
execute if entity @s[scores={Dialog=192}] as @e[tag=jaxy,tag=!medabot_model,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 20 59 41
