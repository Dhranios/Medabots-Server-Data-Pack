...
execute if entity @s[scores={Dialog=1}] positioned 23 59 21 run function medabots_server:spawn_entities/cutscene/karin
...
execute if entity @s[scores={Dialog=136}] as @e[tag=karin,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 22 59 0
