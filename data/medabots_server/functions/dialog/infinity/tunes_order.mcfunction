...
execute if entity @s[scores={Dialog=1}] positioned 66 59 32 run function medabots_server:spawn_entities/cutscene/metabee
execute if entity @s[scores={Dialog=1}] positioned 65 59 60 run function medabots_server:spawn_entities/cutscene/jaxy
execute if entity @s[scores={Dialog=1}] positioned 65 59 62 run function medabots_server:spawn_entities/cutscene/karin
execute if entity @s[scores={Dialog=1}] positioned 68 59 61 run function medabots_server:spawn_entities/cutscene/director_tune
teleport @s[scores={Dialog=1}] 64 59 31 0 0
...
execute if entity @s[scores={Dialog=552}] as @e[tag=director_tune,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 64 59 63
...
execute if entity @s[scores={Dialog=646}] as @e[tag=karin,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 64 59 63
...
execute if entity @s[scores={Dialog=646}] as @e[tag=jaxy,tag=!medabot_model,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 64 59 63
