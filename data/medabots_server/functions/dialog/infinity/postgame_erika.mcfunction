...
execute if entity @s[scores={Dialog=1}] positioned 24 59 22 run function medabots_server:spawn_entities/cutscene/erika
...
execute if entity @s[scores={Dialog=128}] as @e[tag=erika,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 0
