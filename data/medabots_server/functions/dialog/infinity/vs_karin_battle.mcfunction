...
execute if entity @s[scores={Dialog=1}] positioned 15 59 12 run function medabots_server:spawn_entities/cutscene/koji
execute if entity @s[scores={Dialog=1}] positioned 15 59 20 run function medabots_server:spawn_entities/cutscene/rubberobo
...
execute if entity @s[scores={Dialog=1}] as @e[tag=rubberobo,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 47
...
execute if entity @s[scores={Dialog=1}] as @e[tag=koji,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 47
...
execute if entity @s[scores={Dialog=516}] as @e[tag=karin,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 23 59 47
