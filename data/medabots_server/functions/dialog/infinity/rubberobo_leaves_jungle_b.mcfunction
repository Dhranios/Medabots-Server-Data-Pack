...
teleport @s[scores={Dialog=1}] 46 59 46 20 0
...
execute if entity @s[scores={Dialog=296}] as @e[tag=kid,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 46 59 91
