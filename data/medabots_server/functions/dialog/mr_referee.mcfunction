...
execute if entity @s[scores={Dialog=2..},tag=!done] as @e[tag=medabot] if score @s Stage = #temp Stage run tag @s add waiting_for_referee
...
execute if entity @s[scores={Dialog=3},tag=!done,tag=!no_overwrite] run scoreboard players operation @a[tag=waiting_for_referee] MusicType = @s MusicType
execute if entity @s[scores={Dialog=3},tag=!done,tag=!no_overwrite] as @a[tag=waiting_for_referee] unless entity @s[scores={Jukebox=1..}] run scoreboard players set @s Music 0
...
execute if entity @s[tag=done,tag=!no_overwrite,tag=!finished] as @a[tag=waiting_for_referee] unless entity @s[scores={Jukebox=1..}] run scoreboard players set @s Music 0
...
execute if entity @s[tag=done,tag=!finished] as @e[tag=!medabot] if score @s Stage = #temp Stage run tag @s remove disabled
