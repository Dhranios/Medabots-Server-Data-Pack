...
tellraw @s[scores={Dialog=1}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.1"}]}
tellraw @s[scores={Dialog=80}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.2"}]}
tellraw @s[scores={Dialog=160}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.3"}]}
...
tellraw @s[scores={Dialog=360}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.5"}]}
...
tellraw @s[scores={Dialog=936}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.9"}]}
...
tellraw @s[scores={Dialog=1168}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.12"}]}
...
tellraw @s[scores={Dialog=1704}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.18"}]}
tellraw @s[scores={Dialog=1776}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.19"}]}
...
tellraw @s[scores={Dialog=2100}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.22"}]}
tellraw @s[scores={Dialog=2100}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.rock_e_ultimategold_cleared.22"}]}
