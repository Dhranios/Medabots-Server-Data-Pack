...
execute if entity @s[scores={Dialog=286}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.1"}]}
...
execute if entity @s[scores={Dialog=393}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.2"}]}
...
execute if entity @s[scores={Dialog=561}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.3"}]}
execute if entity @s[scores={Dialog=690}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.4"}]}
...
execute if entity @s[scores={Dialog=955}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.5"}]}
execute if entity @s[scores={Dialog=1053}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.6"}]}
execute if entity @s[scores={Dialog=1091}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.7"}]}
execute if entity @s[scores={Dialog=1091}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~-0.5 ~ ~-10
execute if entity @s[scores={Dialog=1154}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.8"}]}
execute if entity @s[scores={Dialog=1154}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ ~-10 ~-10
execute if entity @s[scores={Dialog=1275}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.9"}]}
execute if entity @s[scores={Dialog=1275}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~0.5 ~10 ~10
execute if entity @s[scores={Dialog=1345}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.10"}]}
execute if entity @s[scores={Dialog=1345}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~1 ~10 ~20
execute if entity @s[scores={Dialog=1420}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.11"}]}
execute if entity @s[scores={Dialog=1420}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~-0.5 ~-10 ~-10
execute if entity @s[scores={Dialog=1479}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.12"}]}
execute if entity @s[scores={Dialog=1479}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~-0.5 ~ ~-5
execute if entity @s[scores={Dialog=1579}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.13"}]}
execute if entity @s[scores={Dialog=1579}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ ~ ~-10
execute if entity @s[scores={Dialog=1683}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.14"}]}
...
execute if entity @s[scores={Dialog=1767}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.15"}]}
execute if entity @s[scores={Dialog=1820}] as @e[tag=magolor,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~-1
execute if entity @s[scores={Dialog=1820}] run tellraw @s {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.magolor","color":"green"},{"translate":"medabots_server:dialog.magolor.16"}]}
