...
execute if entity @s[scores={Dialog=1}] positioned -1894 51 -487 run function medabots_server:spawn_entities/cutscene/metabee
execute if entity @s[scores={Dialog=1}] positioned -1890 51 -485 run function medabots_server:spawn_entities/cutscene/max
execute if entity @s[scores={Dialog=1}] positioned -1893 51 -483 run function medabots_server:spawn_entities/cutscene/gillgirl
execute if entity @s[scores={Dialog=1}] positioned -1890 51 -482 run function medabots_server:spawn_entities/cutscene/seaslug
execute if entity @s[scores={Dialog=1}] positioned -1892 51 -471 run function medabots_server:spawn_entities/cutscene/shrimplips
...
execute if entity @s[scores={Dialog=1}] as @e[tag=shrimplips,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing -1892 51 -443
...
teleport @s[scores={Dialog=1}] -1892 51 -489 0 0
...
execute if entity @s[scores={Dialog=48}] as @e[tag=gillgirl,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing -1892 51 -443
...
execute if entity @s[scores={Dialog=296}] as @e[tag=seaslug,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing -1892 51 -443
...
execute if entity @s[scores={Dialog=336}] as @e[tag=max,tag=!medabot_model,tag=this_dialog,limit=1] at @s run teleport @s ~ ~ ~ facing -1892 51 -443
