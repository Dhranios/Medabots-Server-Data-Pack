...
tellraw @s[scores={Dialog=1}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.1"}]}
tellraw @s[scores={Dialog=8}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.2"}]}
tellraw @s[scores={Dialog=48}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.3"}]}
tellraw @s[scores={Dialog=104}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.4"}]}
tellraw @s[scores={Dialog=128}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.5"}]}
tellraw @s[scores={Dialog=200}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.6"}]}
...
execute if entity @s[scores={Dialog=440..467}] as @e[tag=rubberobo_2,tag=this_dialog,limit=1] at @s facing entity @e[tag=select_corps_1,tag=this_dialog,limit=1] feet run teleport @s ~ ~ ~ ~ ~
tellraw @s[scores={Dialog=264}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.7"}]}
...
tellraw @s[scores={Dialog=312}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.select_corps"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.8"}]}
tellraw @s[scores={Dialog=352}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.select_corps"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.9"}]}
tellraw @s[scores={Dialog=400}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.10"}]}
tellraw @s[scores={Dialog=408}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.11"}]}
tellraw @s[scores={Dialog=440}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.12"}]}
tellraw @s[scores={Dialog=472}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.13"}]}
tellraw @s[scores={Dialog=512}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.14"}]}
...
tellraw @s[scores={Dialog=560}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.select_corps"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.15"}]}
tellraw @s[scores={Dialog=584}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.select_corps"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.16"}]}
...
tellraw @s[scores={Dialog=698}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.18"}]}
...
tellraw @s[scores={Dialog=722}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.20"}]}
tellraw @s[scores={Dialog=738}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.rubberobo"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.21"}]}
...
tellraw @s[scores={Dialog=1006}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.24"}]}
...
tellraw @s[scores={Dialog=1278}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.28"}]}
tellraw @s[scores={Dialog=1334}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.29"}]}
...
tellraw @s[scores={Dialog=1526}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.32"}]}
tellraw @s[scores={Dialog=1550}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.33"}]}
...
tellraw @s[scores={Dialog=1952}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.37"}]}
tellraw @s[scores={Dialog=1976}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.38"}]}
tellraw @s[scores={Dialog=2048}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.39"}]}
tellraw @s[scores={Dialog=2064}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.40"}]}
...
tellraw @s[scores={Dialog=2104}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.41"}]}
tellraw @s[scores={Dialog=2112}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.42"}]}
tellraw @s[scores={Dialog=2176}] {"translate":"chat.type.text","with":[{"selector":"@s"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.43"}]}
tellraw @s[scores={Dialog=2184}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.metabee"},{"translate":"medabots_server:dialog.other.ruins_in_b_fvbico_cleared.44"}]}
