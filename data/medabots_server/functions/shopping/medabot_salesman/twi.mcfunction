...
execute unless entity @s[advancements={medabots_server:get_all_medabots/wave_1/zant={legs=false,left_arm=false,right_arm=false,head=false}}] run tellraw @s {"clickEvent":{"action":"run_command","value":"/trigger ShopIndex4 set 12"},"translate":"medabots_server:advancements.get_all_medabots.zant"}}
execute unless entity @s[advancements={medabots_server:get_all_medabots/wave_1/darknut={legs=false,left_arm=false,right_arm=false,head=false}}] run tellraw @s {"clickEvent":{"action":"run_command","value":"/trigger ShopIndex4 set 11"},"translate":"medabots_server:advancements.get_all_medabots.darknut"}}
