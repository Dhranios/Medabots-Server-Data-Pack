execute if entity @s[tag=pot_model,nbt={ArmorItems:[{tag:{medabots_server:{contents:{tag:{}}}}}]}] run summon minecraft:item ~ ~0.375 ~ {Item:{id:"minecraft:stone",Count:1b},Tags:["pot_item","do_not_teleport"],PickupDelay:0s,Invulnerable:1b}
