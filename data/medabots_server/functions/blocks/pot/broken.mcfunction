execute if block ~ ~ ~ minecraft:chest{Items:[{Slot:0b}]} run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:["pot_item","do_not_teleport"],PickupDelay:0s,Invulnerable:1b}
