...
execute if entity @s[scores={Range=11..,Time=100}] if block ~10 ~ ~ minecraft:air positioned ~10 ~ ~ run function medabots_server:blocks/press_wall/extend/x
...
execute if entity @s[scores={Range=12..,Time=110}] if block ~11 ~ ~ minecraft:air positioned ~11 ~ ~ run function medabots_server:blocks/press_wall/extend/x
...
execute if entity @s[scores={Range=13..,Time=120}] if block ~12 ~ ~ minecraft:air positioned ~12 ~ ~ run function medabots_server:blocks/press_wall/extend/x
...
execute if entity @s[scores={Range=14..,Time=130}] if block ~13 ~ ~ minecraft:air positioned ~13 ~ ~ run function medabots_server:blocks/press_wall/extend/x
...
execute if entity @s[scores={Range=15..,Time=140}] if block ~14 ~ ~ minecraft:air positioned ~14 ~ ~ run function medabots_server:blocks/press_wall/extend/x