...
execute if entity @s[tag=cannon,tag=!detect,tag=rotating,tag=east] run function medabots_server:set_blocks/action_floor/cannon/swiffle/east/delay_4/power_1
execute if entity @s[tag=cannon,tag=!detect,tag=rotating,tag=north] run function medabots_server:set_blocks/action_floor/cannon/swiffle/north/delay_4/power_1
execute if entity @s[tag=cannon,tag=!detect,tag=rotating,tag=south] run function medabots_server:set_blocks/action_floor/cannon/swiffle/south/delay_4/power_1
execute if entity @s[tag=cannon,tag=!detect,tag=rotating,tag=west] run function medabots_server:set_blocks/action_floor/cannon/swiffle/west/delay_4/power_1
