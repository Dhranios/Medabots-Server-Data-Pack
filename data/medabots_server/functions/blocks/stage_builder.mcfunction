...
tag @s add me
execute if entity @e[distance=..0.7,tag=!me,tag=!dead,tag=!model_piece,type=!minecraft:player,type=!minecraft:item,tag=!medabot_walk_detection,tag=!guard_walk_detection] run tag @s add cancel
