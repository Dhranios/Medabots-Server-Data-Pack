...
execute if entity @s[tag=custom_stage,scores={Time=1..}] unless entity @s[scores={HomeX=0,HomeY=0,HomeZ=0}] run function medabots_server:blocks/floor_switch/custom_stage
