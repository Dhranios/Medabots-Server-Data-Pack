execute if block ~ ~2 ~ minecraft:wall_torch[facing=east] run tag @s add east_wall_torch_2
execute if block ~ ~2 ~ minecraft:wall_torch[facing=north] run tag @s add north_wall_torch_2
