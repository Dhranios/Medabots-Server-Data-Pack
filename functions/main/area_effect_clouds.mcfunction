...
execute if entity @s[tag=balloon_bomb,tag=!action_floor,tag=!pot] positioned ~ ~0.375 ~ run function medabots_server:entities/balloon_bomb
execute if entity @s[tag=bomb,tag=!action_floor,tag=!pot] positioned ~ ~0.375 ~ run function medabots_server:entities/bomb
