...
execute if entity @s[scores={Transform=1..}] run function medabots_server:medaparts/transform
...
execute if entity @s[tag=!no_transform] run function medabots_server:medaparts/transform_timer
