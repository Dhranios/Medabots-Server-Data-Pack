...
execute if entity @s[tag=right_arm_selected,scores={Time=1,Dialog=60}] run function medabots_server:medaparts/cpu_right_arm
execute if entity @s[tag=head_selected,scores={Time=1,Dialog=60}] run function medabots_server:medaparts/cpu_head
execute if entity @s[tag=left_arm_selected,scores={Time=1,Dialog=60}] run function medabots_server:medaparts/cpu_left_arm
