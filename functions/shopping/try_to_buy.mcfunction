...
# Alien Medal
tellraw @s[scores={Shopping=6,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/alien_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=6,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/alien_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.alien_medal"}]}]}
...
# Chameleon Medal
tellraw @s[scores={Shopping=7,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/chameleon_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=7,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/chameleon_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.chameleon_medal"}]}]}
...
# Devil Medal
tellraw @s[scores={Shopping=8,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/devil_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=8,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/devil_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.devil_medal"}]}]}
...
# Ghost Medal
tellraw @s[scores={Shopping=9,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/ghost_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=9,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/ghost_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.ghost_medal"}]}]}
...
# Kabuto Medal
tellraw @s[scores={Shopping=10,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/kabuto_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=10,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/kabuto_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.kabuto_medal"}]}]}
...
# Knight Medal
tellraw @s[scores={Shopping=11,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/knight_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=11,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/knight_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.knight_medal"}]}]}
...
# Kuwagata Medal
tellraw @s[scores={Shopping=12,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/kuwagata_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=12,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/kuwagata_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.kuwagata_medal"}]}]}
...
# Mermaid Medal
tellraw @s[scores={Shopping=13,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/mermaid_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=13,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/mermaid_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.mermaid_medal"}]}]}
...
# Monkey Medal
tellraw @s[scores={Shopping=14,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/monkey_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=14,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/monkey_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.monkey_medal"}]}]}
...
# Question Medal
tellraw @s[scores={Shopping=15,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/question_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=15,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/question_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.question_medal"}]}]}
...
# Spider Medal
tellraw @s[scores={Shopping=16,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/spider_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=16,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/spider_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.spider_medal"}]}]}
...
# Unicorn Medal
tellraw @s[scores={Shopping=17,Money=..499},advancements={medabots_server:get_all_medabots/wave_1/unicorn_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=17,Money=500..},advancements={medabots_server:get_all_medabots/wave_1/unicorn_medal=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.unicorn_medal"}]}]}
...
# Male Tinpet
tellraw @s[scores={Shopping=18,Money=..2999},advancements={medabots_server:get_all_medabots/male_tinpet=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.tinpet_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=18,Money=3000..},advancements={medabots_server:get_all_medabots/male_tinpet=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.tinpet_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.male_tinpet"}]}]}
...
# Female Tinpet
tellraw @s[scores={Shopping=19,Money=..2999},advancements={medabots_server:get_all_medabots/female_tinpet=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.tinpet_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=19,Money=3000..},advancements={medabots_server:get_all_medabots/female_tinpet=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.tinpet_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.female_tinpet"}]}]}
...
# Neutral Tinpet
tellraw @s[scores={Shopping=20,Money=..13999},advancements={medabots_server:get_all_medabots/neutral_tinpet=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.tinpet_salesman"},{"translate":"medabots_server:message.shop.too_expensive"}]}
tellraw @s[scores={Shopping=20,Money=12000..},advancements={medabots_server:get_all_medabots/neutral_tinpet=true}] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.tinpet_salesman"},{"translate":"medabots_server:message.shop.thank_you","with":[{"translate":"medabots_server:item.neutral_tinpet"}]}]}
