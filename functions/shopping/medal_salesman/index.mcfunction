...
execute if entity @s[scores={ShopIndex1=17}] run function medabots_server:shopping/medal_salesman/q
...
tellraw @s[tag=!success] {"translate":"chat.type.text","with":[{"translate":"medabots_server:entity.medal_salesman"},{"translate":"medabots_server:message.shop.no_medal"}]}
