...
execute if entity @s[tag=medal_salesman] as @a[tag=trading_with_medal_salesman,distance=..4,scores={Dialog=0,ShopIndex1=1..,ShopIndex0=2}] run function medabots_server:shopping/medal_salesman/sell_item
execute if entity @s[tag=medal_salesman] as @a[tag=trading_with_medal_salesman,distance=..4,scores={Dialog=0,ShopIndex1=1..,ShopIndex0=1}] run function medabots_server:shopping/medal_salesman/index
