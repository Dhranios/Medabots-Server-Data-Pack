...
execute if entity @s[scores={Dialog=187}] run summon minecraft:armor_stand -441 55 -10 {Invulnerable:1b,NoGravity:1b,ShowArms:1b,NoBasePlate:1b,DisabledSlots:2039583,Tags:["kid","cutscene"],Rotation:[-120.0f,0.0f],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:3225135}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:8023136}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:4551997}}},{id:"minecraft:player_head",Count:1b,tag:{}}]}
