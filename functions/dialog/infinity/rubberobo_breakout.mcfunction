...
advancement grant @s[scores={Dialog=1}] only medabots_server:wave_1/story_progression rubberobo_breakout
...
playsound medabots_server:music.entity.rubberobo_intro music @s[scores={Dialog=104}] ~ ~ ~ 100
...
playsound medabots_server:music.entity.koji_intro music @s[scores={Dialog=271}] ~ ~ ~ 100
...
playsound medabots_server:music.entity.koji music @s[scores={Music=0,MusicType=-1,Dialog=..103}] ~ ~ ~ 100
scoreboard players set @s[scores={Music=0,MusicType=-1,Dialog=..103}] Music 274
playsound medabots_server:music.entity.rubberobo music @s[scores={Music=0,MusicType=-1,Dialog=104..270}] ~ ~ ~ 100
scoreboard players set @s[scores={Music=0,MusicType=-1,Dialog=104..270}] Music 744
playsound medabots_server:music.entity.koji music @s[scores={Music=0,MusicType=-1,Dialog=271..}] ~ ~ ~ 100
