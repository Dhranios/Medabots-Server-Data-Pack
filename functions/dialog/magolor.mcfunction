...
execute if entity @s[scores={Dialog=286..307}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~-0.1667 ~ ~ ~3.75
execute if entity @s[scores={Dialog=308..328}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~ ~-3.75
execute if entity @s[scores={Dialog=329..349}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~ ~3.75
execute if entity @s[scores={Dialog=350..370}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~ ~-3.75
execute if entity @s[scores={Dialog=391..394}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~ ~1.875
...
execute if entity @s[scores={Dialog=477..496}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~0.5 ~
execute if entity @s[scores={Dialog=496}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr run data merge entity @s {HandItems:[{id:"minecraft:golden_helmet",Count:1b},{}]}
execute if entity @s[scores={Dialog=497..516}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~-0.5 ~
...
execute if entity @s[scores={Dialog=1091}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~-0.5 ~ ~-10
...
execute if entity @s[scores={Dialog=1154}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~-10 ~-10
...
execute if entity @s[scores={Dialog=1275}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~0.5 ~10 ~10
...
execute if entity @s[scores={Dialog=1345}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~1 ~10 ~20
...
execute if entity @s[scores={Dialog=1420}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~-0.5 ~-10 ~-10
...
execute if entity @s[scores={Dialog=1479}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~-0.5 ~ ~-5
...
execute if entity @s[scores={Dialog=1579}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~ ~-10
...
execute if entity @s[scores={Dialog=1683}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~ ~ ~ ~10
execute if entity @s[scores={Dialog=1720}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run particle minecraft:explosion ~-1 ~-1 ~-1 2 2 2 0 60
execute if entity @s[scores={Dialog=1720}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run clone -298 39 195 -292 45 195 ~-3 ~-1 ~-2
execute if entity @s[scores={Dialog=1750..1767}] as @e[tag=magolor] if score @s DialogNr = @a[distance=..0.1,limit=1,sort=nearest] DialogNr at @s run teleport @s ~ ~0.118 ~-0.0588 ~ ~1.176
