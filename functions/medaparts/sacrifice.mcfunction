...
scoreboard players set @s[scores={Time=3,Sacrifice=1}] Time 19
scoreboard players set @s[scores={Time=3,Sacrifice=3}] Time 27
...
replaceitem entity @s[scores={Sacrifice=1,Time=32..34,Drop=0}] hotbar.1 minecraft:bow{Unbreakable:1b,display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:move.sacrifice"}',Lore:['{"translate":"medabots_server:medabots_server:move.sacrifice"}','{"italic":false,"color":"white","translate":"medabots_server:item.generic.shoot"}']},Enchantments:[{id:"minecraft:power",lvl:3s}],medabots_server:{id:"medabots_server:sacrifice"}}
replaceitem entity @s[scores={Sacrifice=3,Time=32..34,Drop=0}] hotbar.2 minecraft:bow{Unbreakable:1b,display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:move.sacrifice"}',Lore:['{"translate":"medabots_server:medabots_server:move.sacrifice"}','{"italic":false,"color":"white","translate":"medabots_server:item.generic.shoot"}']},Enchantments:[{id:"minecraft:power",lvl:3s}],medabots_server:{id:"medabots_server:sacrifice"}}
replaceitem entity @s[scores={Sacrifice=1..,Time=32..34},type=!minecraft:player] weapon.mainhand minecraft:bow{Unbreakable:1b,display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:move.sacrifice"}',Lore:['{"translate":"medabots_server:medabots_server:move.sacrifice"}','{"italic":false,"color":"white","translate":"medabots_server:item.generic.shoot"}']},Enchantments:[{id:"minecraft:power",lvl:3s}],medabots_server:{id:"medabots_server:sacrifice"}}

# destroy the arm used
scoreboard players set @s[scores={Sacrifice=1,Time=82}] LeftArmArmor 0
scoreboard players set @s[scores={Sacrifice=3,Time=82}] RightArmArmor 0

# Remove the weapon
clear @s[scores={Time=82}] minecraft:tipped_arrow{medabots_server:{id:"medabots_server:bullet"}}
clear @s[scores={Time=82}] minecraft:bow{medabots_server:{id:"medabots_server:sacrifice"}}
