...
# Give the effect
execute if entity @s[scores={Time=32}] positioned ^ ^ ^2 as @e[distance=..2] unless entity @s[scores={Time=32,Confuse=1..3}] run scoreboard players set @s ConfuseTime 600
