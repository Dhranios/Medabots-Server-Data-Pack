...
# Heal user
scoreboard players add @s[scores={Time=20}] HeadArmor 5
execute if score @s[scores={Time=20}] HeadArmor > @s MaxHeadArmor run scoreboard players operation @s HeadArmor = @s MaxHeadArmor

# Affect teammates
execute if entity @s[scores={Time=20},tag=ally_medabot] run scoreboard players add @a[distance=..16,tag=ally_medabot] HeadArmor 5
...
execute if entity @s[scores={Time=20},tag=enemy_medabot] run scoreboard players add @e[distance=..16,tag=enemy_medabot] HeadArmor 5
