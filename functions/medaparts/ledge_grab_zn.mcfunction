...
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~ ~-1 #medabots_server:ledge_grab/trapdoors[open=true,facing=east] run scoreboard players set @s LedgeGrabAble 0
...
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~1 ~-1 #medabots_server:ledge_grab/stairs[facing=south,shape=straight] run scoreboard players set @s LedgeGrabAble 0
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~1 ~-1 #medabots_server:ledge_grab/stairs[facing=south,shape=inner_left] run scoreboard players set @s LedgeGrabAble 0
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~1 ~-1 #medabots_server:ledge_grab/stairs[facing=south,shape=inner_right] run scoreboard players set @s LedgeGrabAble 0
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~1 ~-1 #medabots_server:ledge_grab/stairs[facing=east,shape=inner_right] run scoreboard players set @s LedgeGrabAble 0
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~1 ~-1 #medabots_server:ledge_grab/stairs[facing=west,shape=inner_left] run scoreboard players set @s LedgeGrabAble 0
execute if entity @s[scores={LedgeGrabAble=1}] if block ~ ~1 ~-1 minecraft:piston_head[facing=south] run scoreboard players set @s LedgeGrabAble 0
