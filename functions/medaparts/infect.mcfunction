...
scoreboard players set @s[scores={Time=2,Infect=1}] Time 10
scoreboard players set @s[scores={Time=2,Infect=3}] Time 20

# Show particles
execute if entity @s[scores={Time=20}] run particle minecraft:underwater ~ ~1 ~ 1 0 1 1 10

# Give the effect
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=22,Infect=1..3}] run scoreboard players set @s InfectTime 100
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=22,Infect=1..3}] run scoreboard players set @s InfectTime 100
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=22,Infect=1..3}] run scoreboard players set @s InfectTime 100
