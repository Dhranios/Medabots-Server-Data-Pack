...
replaceitem entity @s[scores={MedapartType=1,Time=84..,Drop=0}] hotbar.2 minecraft:fishing_rod{Damage:11,Unbreakable:1b,HideFlags:4,display:{Name:"{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:item.sphere_doomers_electric_doomer\"}",Lore:["{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:move.anti_fly\"}","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:move.anti_fly.description\"}","","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:item.part.armor\",\"with\":[{\"text\":\"40\"}]}","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:item.part.neutral\"}","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:entity.sphere_doomers\"}","","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:item.sphere_doomers_electric_doomer.quote\"}","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:item.part.wave\",\"with\":[{\"text\":\"1\"}]}","{\"italic\":false,\"color\":\"white\",\"translate\":\"medabots_server:item.sphere_doomers_electric_doomer.model\"}"]},medabots_server:{id:"medabots_server:sphere_doomers_electric_doomer",gender:2b,move:"anti_fly",part:"right_arm",armor:40,power:24,activated:1b,version:1}}

# Finish move
scoreboard players reset @s[scores={AntiFly=1,Time=84..},nbt={Inventory:[{Slot:1b,id:"minecraft:fishing_rod",tag:{Damage:2,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=2,Time=84..},nbt={Inventory:[{Slot:3b,id:"minecraft:fishing_rod",tag:{Damage:3,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=3,Time=84..},nbt={Inventory:[{Slot:2b,id:"minecraft:fishing_rod",tag:{Damage:4,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=1,Time=84..},nbt={Inventory:[{Slot:1b,id:"minecraft:fishing_rod",tag:{Damage:6,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=2,Time=84..},nbt={Inventory:[{Slot:3b,id:"minecraft:fishing_rod",tag:{Damage:7,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=3,Time=84..},nbt={Inventory:[{Slot:2b,id:"minecraft:fishing_rod",tag:{Damage:8,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=1,Time=84..},nbt={Inventory:[{Slot:1b,id:"minecraft:fishing_rod",tag:{Damage:10,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=2,Time=84..},nbt={Inventory:[{Slot:3b,id:"minecraft:fishing_rod",tag:{Damage:11,Unbreakable:1b}}]}] AntiFly
scoreboard players reset @s[scores={AntiFly=3,Time=84..},nbt={Inventory:[{Slot:2b,id:"minecraft:fishing_rod",tag:{Damage:12,Unbreakable:1b}}]}] AntiFly
