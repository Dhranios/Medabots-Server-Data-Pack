...
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[type=!#medabots_server:undead] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[type=#medabots_server:undead] minecraft:instant_health 1 0 true
...
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!ally_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[type=!#medabots_server:undead] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!ally_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[type=#medabots_server:undead] minecraft:instant_health 1 0 true
...
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!enemy_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[type=!#medabots_server:undead] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!enemy_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[type=#medabots_server:undead] minecraft:instant_health 1 0 true
