...
scoreboard players set @s[scores={Time=2,Bug=1}] Time 10
scoreboard players set @s[scores={Time=2,Bug=3}] Time 20

# Show particles
execute if entity @s[scores={Time=20}] run particle minecraft:enchant ~ ~1 ~ 1 0 1 1 30

# Give the effects
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2] unless entity @s[scores={Time=20,Bug=1..3}] run scoreboard players set @s BugTime 600
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 true
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!ally_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run scoreboard players set @s BugTime 600
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!ally_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!ally_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 true
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!enemy_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run scoreboard players set @s BugTime 600
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!enemy_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 true
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=!enemy_medabot] unless entity @s[scores={Time=20,Bug=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 true
