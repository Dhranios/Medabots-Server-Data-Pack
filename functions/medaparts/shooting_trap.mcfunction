...
# Set the trap
execute if entity @s[scores={Time=32}] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:"{\"translate\":\"medabots_server:medabots_server:move.shooting_trap\"}",Tags:["shooting_trap","trap"],Duration:1200}
