...
# give the effect
execute if entity @s[scores={Time=32},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=32,Hold=1..3}] run scoreboard players set @s HoldTime 100
execute if entity @s[scores={Time=32},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=32,Hold=1..3}] run scoreboard players set @s HoldTime 100
execute if entity @s[scores={Time=32},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=32,Hold=1..3}] run scoreboard players set @s HoldTime 100
