...
# Give the effect
execute if entity @s[scores={Time=36},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=36,Freeze=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=36},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=36,Freeze=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 false
execute if entity @s[scores={Time=36},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=36,Freeze=1..3}] run scoreboard players set @s FreezeTime 60
execute if entity @s[scores={Time=36},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=36,Freeze=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=36},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=36,Freeze=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 false
execute if entity @s[scores={Time=36},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=36,Freeze=1..3}] run scoreboard players set @s FreezeTime 60
execute if entity @s[scores={Time=36},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=36,Freeze=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=36},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=36,Freeze=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 false
execute if entity @s[scores={Time=36},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=36,Freeze=1..3}] run scoreboard players set @s FreezeTime 60
