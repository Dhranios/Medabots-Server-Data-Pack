...
scoreboard players set @s[scores={Time=2,Freeze=1}] Time 10
scoreboard players set @s[scores={Time=2,Freeze=3}] Time 20
...
# Give the effect
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 false
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=20,Freeze=1..3}] run scoreboard players set @s FreezeTime 60
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 false
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run scoreboard players set @s FreezeTime 60
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[tag=!undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[tag=undead] minecraft:instant_health 1 0 false
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run scoreboard players set @s FreezeTime 60

# Create thin ice
execute if entity @s[scores={Time=20}] rotated 0 ~ positioned ^ ^ ^2 if block ~ ~-1 ~ minecraft:water[level=0] unless block ~ ~ ~ minecraft:water run summon minecraft:area_effect_cloud ~ ~-1 ~ {CustomName:'{"translate":"medabots_server:block.thin_ice"}',Duration:2147483647,Tags:["thin_ice"]}
execute if entity @s[scores={Time=20}] rotated 0 ~ positioned ^ ^ ^2 if block ~-1 ~-1 ~ minecraft:water[level=0] unless block ~-1 ~ ~ minecraft:water run summon minecraft:area_effect_cloud ~-1 ~-1 ~ {CustomName:'{"translate":"medabots_server:block.thin_ice"}',Duration:2147483647,Tags:["thin_ice"]}
execute if entity @s[scores={Time=20}] rotated 0 ~ positioned ^ ^ ^2 if block ~1 ~-1 ~ minecraft:water[level=0] unless block ~1 ~ ~ minecraft:water run summon minecraft:area_effect_cloud ~1 ~-1 ~ {CustomName:'{"translate":"medabots_server:block.thin_ice"}',Duration:2147483647,Tags:["thin_ice"]}
execute if entity @s[scores={Time=20}] rotated 0 ~ positioned ^ ^ ^2 if block ~ ~-1 ~-1 minecraft:water[level=0] unless block ~ ~ ~-1 minecraft:water run summon minecraft:area_effect_cloud ~ ~-1 ~-1 {CustomName:'{"translate":"medabots_server:block.thin_ice"}',Duration:2147483647,Tags:["thin_ice"]}
execute if entity @s[scores={Time=20}] rotated 0 ~ positioned ^ ^ ^2 if block ~ ~-1 ~1 minecraft:water[level=0] unless block ~ ~ ~1 minecraft:water run summon minecraft:area_effect_cloud ~ ~-1 ~1 {CustomName:'{"translate":"medabots_server:block.thin_ice"}',Duration:2147483647,Tags:["thin_ice"]}
