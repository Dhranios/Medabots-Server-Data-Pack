...
# Give the effect
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[type=!#medabots_server:undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=20},tag=!ally_medabot,tag=!enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[type=#medabots_server:undead] minecraft:instant_health 1 0 false
...
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[type=!#medabots_server:undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=20},tag=ally_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!ally_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[type=#medabots_server:undead] minecraft:instant_health 1 0 false
...
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[type=!#medabots_server:undead] minecraft:instant_damage 1 0 false
execute if entity @s[scores={Time=20},tag=enemy_medabot] positioned ^ ^ ^2 as @e[distance=..2,tag=hostile,tag=!enemy_medabot] unless entity @s[scores={Time=20,Freeze=1..3}] run effect give @s[type=#medabots_server:undead] minecraft:instant_health 1 0 false
