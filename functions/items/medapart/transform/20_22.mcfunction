# Transform
loot replace entity @s[scores={Transform=1,Drop=0},tag=male_tinpet] hotbar.1 loot medabots_server:gameplay/transform/left_arm/male_tinpet
loot replace entity @s[scores={Transform=3,Drop=0},tag=male_tinpet] hotbar.2 loot medabots_server:gameplay/transform/right_arm/male_tinpet
loot replace entity @s[scores={Transform=2,Drop=0},tag=male_tinpet] hotbar.3 loot medabots_server:gameplay/transform/head/male_tinpet
loot replace entity @s[scores={Transform=1,Drop=0},tag=female_tinpet] hotbar.1 loot medabots_server:gameplay/transform/left_arm/female_tinpet
loot replace entity @s[scores={Transform=3,Drop=0},tag=female_tinpet] hotbar.2 loot medabots_server:gameplay/transform/right_arm/female_tinpet
loot replace entity @s[scores={Transform=2,Drop=0},tag=female_tinpet] hotbar.3 loot medabots_server:gameplay/transform/head/female_tinpet
loot replace entity @s[scores={Transform=1,Drop=0},tag=neutral_tinpet] hotbar.1 loot medabots_server:gameplay/transform/left_arm/neutral_tinpet
loot replace entity @s[scores={Transform=3,Drop=0},tag=neutral_tinpet] hotbar.2 loot medabots_server:gameplay/transform/right_arm/neutral_tinpet
loot replace entity @s[scores={Transform=2,Drop=0},tag=neutral_tinpet] hotbar.3 loot medabots_server:gameplay/transform/head/neutral_tinpet
