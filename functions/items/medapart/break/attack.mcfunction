...
data merge entity @s[tag=!broken] {CustomName:'{"translate":"medabots_server:move.break"}',Tags:["hostile","do_not_teleport","break","broken"],NoGravity:1b,PickupDelay:32767s,Age:3600s}
