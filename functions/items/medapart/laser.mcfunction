...
execute if entity @s[scores={Time=40..42}] run function medabots_server:items/medapart/laser/40..42
execute if entity @s[scores={Time=80..}] run function medabots_server:items/medapart/laser/80..

# Increase time by 1
scoreboard players add @s[scores={Laser=1..}] Time 1
