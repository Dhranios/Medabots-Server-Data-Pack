...
execute if entity @e[distance=0.1..4,tag=hostile,tag=enemy_medabot] run advancement grant @s only medabots_server:wave_1/kamikaze_bomber
execute if entity @a[distance=0.1..4,tag=hostile] run advancement grant @s only medabots_server:wave_1/kamikaze_bomber
