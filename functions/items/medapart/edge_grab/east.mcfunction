...
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~ ~ #medabots_server:edge_grab/trapdoors[open=true,facing=south] run scoreboard players set @s EdgeGrabAble 0
...
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~1 ~ #medabots_server:edge_grab/stairs[facing=north,shape=straight] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~1 ~ #medabots_server:edge_grab/stairs[facing=north,shape=inner_left] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~1 ~ #medabots_server:edge_grab/stairs[facing=north,shape=inner_right] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~1 ~ #medabots_server:edge_grab/stairs[facing=west,shape=inner_right] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~1 ~ #medabots_server:edge_grab/stairs[facing=east,shape=inner_left] run scoreboard players set @s EdgeGrabAble 0
execute if entity @s[scores={EdgeGrabAble=1}] if block ~1 ~1 ~ minecraft:piston_head[facing=east] run scoreboard players set @s EdgeGrabAble 0
