...
execute if entity @s[scores={Time=20..22}] run function medabots_server:items/medapart/napalm/20..22
execute if entity @s[scores={Time=60..}] run function medabots_server:items/medapart/napalm/60..
