...
# Equip selected right arm
execute if entity @s[tag=valid,scores={EditingTinpet=0}] run data modify entity @s Inventory[{Slot:0b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=1}] run data modify entity @s Inventory[{Slot:1b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=2}] run data modify entity @s Inventory[{Slot:2b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=3}] run data modify entity @s Inventory[{Slot:3b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=4}] run data modify entity @s Inventory[{Slot:4b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=5}] run data modify entity @s Inventory[{Slot:5b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=6}] run data modify entity @s Inventory[{Slot:6b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=7}] run data modify entity @s Inventory[{Slot:7b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem
execute if entity @s[tag=valid,scores={EditingTinpet=8}] run data modify entity @s Inventory[{Slot:8b}].tag.medabots_server.items.right_arm set from entity @s SelectedItem

# Show equipped right arm name in Lore
...
execute if entity @s[tag=valid,scores={EditingTinpet=0}] run data modify entity @s Inventory[{Slot:0b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=1}] run data modify entity @s Inventory[{Slot:1b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=2}] run data modify entity @s Inventory[{Slot:2b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=3}] run data modify entity @s Inventory[{Slot:3b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=4}] run data modify entity @s Inventory[{Slot:4b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=5}] run data modify entity @s Inventory[{Slot:5b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=6}] run data modify entity @s Inventory[{Slot:6b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=7}] run data modify entity @s Inventory[{Slot:7b}].tag.display.Lore[2] set from block -286 0 -52 Text1
execute if entity @s[tag=valid,scores={EditingTinpet=8}] run data modify entity @s Inventory[{Slot:8b}].tag.display.Lore[2] set from block -286 0 -52 Text1
