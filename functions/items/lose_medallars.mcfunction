summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:diamond",Count:15b,tag:{CustomModelData:1,medabots_server:{stage_item:1b,id:"medabots_server:medallar"},display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:item.medallar"}'}}},Tags:["medallar_drop"],PickupDelay:1s}
