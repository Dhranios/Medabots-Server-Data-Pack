...
# Equipped arms
execute if entity @e[tag=right_arm_selected,tag=this_medabot,limit=1] run tag @s add selected
execute if entity @s[tag=selected] unless entity @e[tag=right_arm_selected,tag=this_medabot,limit=1] run tag @s remove selected
