...
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] if entity @s[tag=!selected,tag=!guarding,tag=two_legged] run function medabots_server:animations/medabot/walking/two_legged/right_arm
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] if entity @s[tag=!selected,tag=!guarding,tag=!two_legged] run function medabots_server:animations/medabot/walking/other/right_arm
