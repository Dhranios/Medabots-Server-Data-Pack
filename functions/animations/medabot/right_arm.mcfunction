...
execute at @e[tag=this_medabot,tag=chest,limit=1] rotated ~ 0 run teleport @s[tag=!guarding] ^-.25 ^.03 ^-.25
execute at @e[tag=this_medabot,tag=chest,limit=1] rotated ~ 0 run teleport @s[tag=guarding] ^-.2 ^.03 ^-.25
...
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] if entity @s[tag=!selected,tag=!guarding,tag=has_legs,tag=!edge_grabbing] run function medabots_server:animations/medabot/walking/right_arm_with_legs
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] if entity @s[tag=!selected,tag=!guarding,tag=!has_legs,tag=!edge_grabbing] run function medabots_server:animations/medabot/walking/right_arm
