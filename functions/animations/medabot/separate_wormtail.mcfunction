summon minecraft:armor_stand ~ ~ ~ {NoGravity:1b,Invisible:1b,Marker:1b,Tags:["wormtail","medabot_model","new"],CustomName:'{"translate":"medabots_server:entity.medabot_model"}'}
