execute if entity @s[tag=walking] store result score #temp Time run data get entity @s Pose.Head[1] 10
...
execute if entity @s[tag=running] store result score #temp Time run data get entity @s Pose.Head[1] 10
...
execute if entity @s[tag=sneaking] store result score #temp Time run data get entity @s Pose.Head[1] 10
