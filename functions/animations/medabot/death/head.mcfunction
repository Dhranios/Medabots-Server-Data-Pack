...
execute at @s[scores={DeathTime=1},tag=!drowned,tag=!crushed,tag=chest] run playsound medabots_server:entity.medabot.death player @a ~ ~ ~ 0.7
execute at @s[scores={DeathTime=1},tag=crushed,tag=chest] run playsound medabots_server:entity.medabot.death.crushed player @a ~ ~ ~ 0.7
execute at @s[scores={DeathTime=1},tag=drowned,tag=chest] run playsound medabots_server:entity.medabot.death.drowned player @a ~ ~ ~ 0.7