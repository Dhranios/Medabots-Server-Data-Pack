...
gamemode adventure @s[scores={DeathTime=100}]
tag @s[scores={DeathTime=100}] remove drowned
tag @s[scores={DeathTime=100}] remove crushed
tag @s[scores={DeathTime=100}] remove dying
tag @s[scores={DeathTime=100}] remove had_death
tag @s[scores={DeathTime=100}] remove retry
tag @s[scores={DeathTime=100}] remove enemy
tag @s[scores={DeathTime=100}] remove story_battle
tellraw @s[scores={DeathTime=100}] {"translate":"medabots_server:message.defeat.1","color":"gold","extra":[{"text":"\n"},{"translate":"medabots_server:message.defeat.2"}]}
