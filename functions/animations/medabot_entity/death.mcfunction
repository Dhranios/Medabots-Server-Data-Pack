...
execute if entity @s[scores={DeathTime=2},type=minecraft:player,tag=!practice_battle] if entity @a[scores={Killer=1..},tag=!practice_battle] run function medabots_server:items/drop_medapart
execute if entity @s[scores={DeathTime=2},type=minecraft:player,tag=!practice_battle] if entity @e[tag=enemy_medabot,nbt=!{DeathLootTable:"medabots_server:entities/battle_enemies/practice_round"}] run function medabots_server:items/drop_medapart
execute if entity @s[y=-80,dy=79,scores={DeathTime=2},type=minecraft:player] positioned ~ 3 ~ run function medabots_server:items/lose_medallars
execute if entity @s[y=-80,dy=79,scores={DeathTime=2},type=!minecraft:player] run loot spawn ~ 3 ~ kill @s
execute if entity @s[y=-80,dy=79,scores={DeathTime=2}] positioned ~ 3 ~ run tag @e[distance=..1,type=minecraft:item] add medabot_loot
execute if entity @s[y=-80,dy=79,scores={DeathTime=2},tag=enemy_medabot] positioned ~ 3 ~ run tag @e[distance=..1,type=minecraft:item] add enemy_loot
execute if entity @s[y=-80,dy=79,scores={DeathTime=2},tag=ally_medabot] positioned ~ 3 ~ run tag @e[distance=..1,type=minecraft:item] add ally_loot
execute if entity @s[y=0,dy=255,scores={DeathTime=2},type=minecraft:player] run function medabots_server:items/lose_medallars
execute if entity @s[y=0,dy=255,scores={DeathTime=2},type=!minecraft:player] run loot spawn ~ ~ ~ kill @s
execute if entity @s[y=0,dy=255,scores={DeathTime=2}] run tag @e[distance=..1,type=minecraft:item] add medabot_loot
execute if entity @s[y=0,dy=255,scores={DeathTime=2},tag=enemy_medabot] positioned ~ 3 ~ run tag @e[distance=..1,type=minecraft:item] add enemy_loot
execute if entity @s[y=0,dy=255,scores={DeathTime=2},tag=ally_medabot] positioned ~ 3 ~ run tag @e[distance=..1,type=minecraft:item] add ally_loot
