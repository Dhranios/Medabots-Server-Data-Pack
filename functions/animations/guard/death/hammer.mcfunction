...
execute if entity @s[scores={AnimationProg=1}] store result entity @s Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 180
execute if entity @s[scores={AnimationProg=2}] store result entity @s Pose.Head[0] float 0.1 run scoreboard players add #temp Time 180
