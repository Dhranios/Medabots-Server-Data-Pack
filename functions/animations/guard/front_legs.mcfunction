# Move with
execute at @e[tag=this_guard,limit=1] rotated ~ 0 run teleport @s ^ ^-1.2 ^0.25
...
execute if entity @e[tag=this_guard,tag=walking,limit=1] run function medabots_server:animations/guard/walking/front_legs
