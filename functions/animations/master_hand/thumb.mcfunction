# Move with
execute at @e[tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^1.3 ^ ^
...
execute if entity @s[tag=idle] run function medabots_server:animations/master_hand/idle/thumb
