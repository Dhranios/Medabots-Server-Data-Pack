# Move with
execute at @e[tag=this_master_hand,limit=1] rotated ~ 0 run teleport @s ^ ^0.4 ^0.5
...
execute if entity @e[tag=this_master_hand,tag=!appeared,limit=1] run tag @s add appearing
...
execute if entity @e[tag=this_master_hand,tag=idle,limit=1] run tag @s add idle
execute if entity @s[tag=idle] run function medabots_server:animations/master_hand/idle/middle_finger
...
execute if entity @e[tag=this_master_hand,tag=fast_idle,limit=1] run tag @s add fast_idle
...
execute if entity @e[tag=this_master_hand,tag=ram,limit=1] run tag @s add ram
