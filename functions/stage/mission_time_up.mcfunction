...
execute if entity @s[scores={Dialog=162},tag=!run_until_the_time_is_up] as @a[tag=this_mission] run scoreboard players set @s Battle 3
execute if entity @s[scores={Dialog=162},tag=!run_until_the_time_is_up] as @a[tag=this_mission] run scoreboard players set @s LeaveStage 1
...
execute if entity @s[scores={Dialog=82},tag=run_until_the_time_is_up] as @a[tag=enemy_medabot,tag=this_mission] run scoreboard players set @s Battle 3
execute if entity @s[scores={Dialog=82},tag=run_until_the_time_is_up] as @a[tag=enemy_medabot,tag=this_mission] run scoreboard players set @s LeaveStage 1
