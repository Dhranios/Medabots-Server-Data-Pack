...
execute if entity @s[scores={Dialog=82},tag=run_until_the_time_is_up] as @e[type=!minecraft:player,tag=!mission,tag=run_until_time_is_up] if score @s Stage = @e[distance=..0.1,tag=mission,limit=1] Stage run tag @s remove run_until_time_is_up
