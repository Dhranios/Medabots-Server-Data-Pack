...
execute unless entity @a[x=-1665,y=50,z=-704,dx=62,dy=4,dz=63,tag=0] positioned -1617 44 -688 run function medabots_server:spawn_entities/enemy_medabot/kanehachi_mk2/seven_colors/hellphoenix/kanehachi_mk2/kuwagata
