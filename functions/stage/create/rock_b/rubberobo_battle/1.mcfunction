...
execute positioned -1607 45 -355 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1606 45 -356 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1605 45 -353 run function medabots_server:spawn_entities/mission/guard/normal
