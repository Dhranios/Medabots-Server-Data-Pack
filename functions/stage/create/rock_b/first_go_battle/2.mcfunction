...
execute unless entity @a[x=-1636,y=51,z=-382,dx=63,dy=4,dz=63,tag=0] positioned -1604 45 -374 run function medabots_server:spawn_entities/character_enemy_medabot/spyke
