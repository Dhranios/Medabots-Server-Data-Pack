...
execute unless entity @a[x=-1636,y=51,z=-382,dx=63,dy=4,dz=63,tag=0] positioned -1586 45 -344 run function medabots_server:spawn_entities/enemy_medabot/seven_colors/poison_scorpi/poison_scorpi/seven_colors/chameleon
