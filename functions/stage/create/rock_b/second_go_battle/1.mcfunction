...
execute positioned -1607 45 -356 run function medabots_server:spawn_entities/guard/slow/mission
execute positioned -1607 45 -352 run function medabots_server:spawn_entities/guard/slow/mission
