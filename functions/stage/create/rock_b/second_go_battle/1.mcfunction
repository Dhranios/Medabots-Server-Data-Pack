...
execute positioned -1607 45 -356 run function medabots_server:spawn_entities/guard/slow
execute positioned -1607 45 -352 run function medabots_server:spawn_entities/guard/slow
execute positioned -1604 45 -352 run function medabots_server:spawn_entities/guard/slow
execute positioned -1604 45 -356 run function medabots_server:spawn_entities/guard/slow
execute positioned -1634 42 -381 run function medabots_server:set_blocks/whrilpool
