...
execute unless entity @a[x=-1705,y=51,z=-179,dx=63,dy=4,dz=63,tag=1] positioned -1697 45 -167 run function medabots_server:spawn_entities/medabot/nin_ninja/basstroyer/poison_scorpi/nin_ninja/knight
...
execute unless entity @a[x=-1705,y=51,z=-179,dx=63,dy=4,dz=63,tag=1] positioned -1697 45 -167 run tag @e[distance=..1] add enemy_medabot
...
scoreboard players set @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,scores={PowerNeeded=0}] PowerNeeded 1
