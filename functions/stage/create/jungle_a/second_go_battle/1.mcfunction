...
tag @a[x=-1697,y=45,z=-167,distance=10..,tag=enemy_medabot,scores={Stage=9}] remove enemy_medabot
scoreboard players set @a[x=-1697,y=45,z=-167,distance=10..,tag=enemy_medabot,scores={Stage=9}] Music 0
scoreboard players set @a[x=-1697,y=45,z=-167,distance=10..,tag=enemy_medabot,scores={Stage=9}] MusicType 1
scoreboard players set @a[x=-1697,y=45,z=-167,distance=10..,tag=enemy_medabot,scores={Stage=9}] Battle 0
teleport @a[x=-1697,y=45,z=-167,distance=10..,tag=enemy_medabot,scores={Stage=9}] -1673 51 -148 -180 0
tag @e[x=-1697,y=45,z=-167,distance=10..,tag=enemy_medabot,scores={Stage=9},type=!minecraft:player] add dead
