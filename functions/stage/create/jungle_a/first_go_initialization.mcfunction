execute if entity @s[tag=vs_cpus] run function medabots_server:stage/create/jungle_a/first_go_cpus
...
execute if entity @s[tag=!vs_cpus] run data merge block -1674 52 -179 {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function medabots_server:stage/join/jungle_a/first_go/cancle\"}}",Text3:"{\"translate\":\"medabots_server:sign.stage.cancle\"}"}
