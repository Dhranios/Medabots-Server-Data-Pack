...
teleport @a[x=-1376,y=50,z=-205,dx=62,dy=4,dz=86,tag=-1] -1321 45 -123
teleport @a[x=-1376,y=50,z=-205,dx=62,dy=4,dz=86,tag=0] -1369 45 -186
teleport @s[tag=-1] -1321 45 -123
