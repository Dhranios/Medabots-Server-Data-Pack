...
execute unless entity @a[x=-1570,y=50,z=-545,dx=62,dy=4,dz=62,tag=1] positioned -1549 44 -511 run function medabots_server:spawn_entities/enemy_medabot/knight_armor/hellphoenix/maxsnake/knight_armor/chameleon
...
execute positioned -1550 44 -513 run function medabots_server:spawn_entities/mission/guard/slow
execute positioned -1550 44 -509 run function medabots_server:spawn_entities/mission/guard/slow
...
summon minecraft:area_effect_cloud -1546 44 -512 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","defeat_all_guards"],Duration:2147483647}
