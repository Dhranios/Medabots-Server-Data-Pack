...
setblock -1955 45 -604 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1956 45 -610 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1961 45 -623 minecraft:structure_block[mode=load]{name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1955 45 -624 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1942 45 -629 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1932 45 -602 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1938 45 -599 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1963 45 -600 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1966 45 -606 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1965 45 -631 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1959 45 -634 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1934 45 -633 minecraft:structure_block[mode=load]{name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1931 45 -627 minecraft:structure_block[mode=load]{name:"medabots_server:stage/laser_trap",mode:"LOAD"}
setblock -1941 46 -623 minecraft:redstone_block
setblock -1936 46 -610 minecraft:redstone_block
setblock -1942 46 -609 minecraft:redstone_block
setblock -1955 46 -604 minecraft:redstone_block
setblock -1956 46 -610 minecraft:redstone_block
setblock -1961 46 -623 minecraft:redstone_block
setblock -1955 46 -624 minecraft:redstone_block
setblock -1942 46 -629 minecraft:redstone_block
setblock -1932 46 -602 minecraft:redstone_block
setblock -1938 46 -599 minecraft:redstone_block
setblock -1963 46 -600 minecraft:redstone_block
setblock -1966 46 -606 minecraft:redstone_block
setblock -1965 46 -631 minecraft:redstone_block
