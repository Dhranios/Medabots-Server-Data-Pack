execute positioned -1941 45 -623 run function medabots_server:set_blocks/laser_trap/enabled/south/delay_8
execute positioned -1936 45 -610 run function medabots_server:set_blocks/laser_trap/enabled/north/delay_8
execute positioned -1942 45 -609 run function medabots_server:set_blocks/laser_trap/enabled/west/delay_8
execute positioned -1955 45 -604 run function medabots_server:set_blocks/laser_trap/enabled/east/delay_8
execute positioned -1956 45 -610 run function medabots_server:set_blocks/laser_trap/enabled/north/delay_12
execute positioned -1961 45 -623 run function medabots_server:set_blocks/laser_trap/enabled/south/delay_12
execute positioned -1955 45 -624 run function medabots_server:set_blocks/laser_trap/enabled/east/delay_12
execute positioned -1942 45 -629 run function medabots_server:set_blocks/laser_trap/enabled/west/delay_12
