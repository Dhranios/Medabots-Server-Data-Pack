...
execute unless entity @a[x=-1668,y=51,z=-247,dx=105,dy=4,dz=63,tag=1] positioned -1660 45 -233 run function medabots_server:spawn_entities/medabot/hellphoenix/kanehachi_mk2/fly_falcon/hellphoenix/kuwagata
...
execute unless entity @a[x=-1668,y=51,z=-247,dx=105,dy=4,dz=63,tag=1] positioned -1660 45 -233 run tag @e[distance=..1] add enemy_medabot
...
scoreboard players set @e[x=-1651.5,y=45,z=-228.5,distance=..0.7,tag=door,scores={PowerNeeded=0}] PowerNeeded 1
