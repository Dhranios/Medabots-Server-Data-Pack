...
execute unless entity @a[x=-1764,y=50,z=-247,dx=88,dy=4,dz=63,tag=0] run function medabots_server:stage/create/iceberg_a/second_go_battle/0_cpu
...
setblock -1734 44 -230 minecraft:chest[facing=south,type=single]
setblock -1735 44 -229 minecraft:chest[facing=south,type=single]
setblock -1732 44 -229 minecraft:chest[facing=south,type=single]{Items:[{Slot:0b,id:"minecraft:lapis_lazuli",Count:6b,tag:{medabots_server:{stage_item:1b,id:"medabots_server:medallar_cent"},display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:item.medallar_cent"}'}}}]}
...
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=1,tag=selected] run summon minecraft:armor_stand -1705 44 -209 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[0.0f,0.0f]}
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=2,tag=selected] run summon minecraft:armor_stand -1704 44 -206 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[-180.0f,0.0f]}
kill @e[type=minecraft:area_effect_cloud,tag=referee_marker]
bossbar set medabots_server:iceberg_a/robattle value 3600
bossbar set medabots_server:iceberg_a/robattle players @a[scores={Stage=18}]