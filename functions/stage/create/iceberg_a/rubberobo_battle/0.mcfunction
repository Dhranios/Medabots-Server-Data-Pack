...
execute positioned -1686 44 -205 run function medabots_server:spawn_entities/guard/medium
execute positioned -1682 44 -205 run function medabots_server:spawn_entities/guard/medium
execute positioned -1704 44 -213 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1703 44 -213 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1689 44 -216 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1684 44 -218 run function medabots_server:spawn_entities/cannon/search/south/delay_4/2_medallar_cents
execute positioned -1684 44 -219 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1683 44 -219 run function medabots_server:spawn_entities/cannon/search/south/delay_4
...
summon minecraft:area_effect_cloud -1705 44 -209 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","hide_normal_time","defeat_the_enemy"],Duration:2147483647}
