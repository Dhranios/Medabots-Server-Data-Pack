execute unless entity @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] run tellraw @s[tag=!vs_cpus] {"translate":"medabots_server:message.stage.player.left","color":"green"}
execute unless entity @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] positioned -1585 44 -612 run function medabots_server:spawn_entities/enemy_medabot/blackbeetle/blackbeetle/fancyroll/blackbeetle/monkey
execute unless entity @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] positioned -1585 44 -612 run scoreboard players set @e[distance=..1] Stage 28
execute positioned -1578 44 -607 run function medabots_server:spawn_entities/guard/slow
execute positioned -1584 44 -605 run function medabots_server:spawn_entities/cannon/detect/rotating/north/delay_4
...
effect give @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] minecraft:night_vision 2 0 true
effect give @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] minecraft:blindness 2 0 true
scoreboard players set @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] Battle 2
teleport @a[x=-1596,y=50,z=-620,dx=22,dy=4,dz=44,tag=1] -1585 44 -612
