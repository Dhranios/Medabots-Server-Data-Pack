...
execute positioned -1578 44 -591 run function medabots_server:spawn_entities/cannon/no_detect/rotating/west/delay_4/10_medallar_cents
...
execute positioned -1595 44 -589 run function medabots_server:set_blocks/pot/cannon/no_detect/rotating/east/delay_1
# Medapart pot
...
execute positioned -1586 44 -598 run function medabots_server:set_blocks/door/open/south
