...
execute unless entity @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=1] positioned -1807 45 -580 run function medabots_server:spawn_entities/medabot/shoot_spider/maxsnake/basstroyer/shoot_spider/chameleon
execute unless entity @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=1] positioned -1807 45 -580 run scoreboard players set @e[distance=..1] Stage 19
execute unless entity @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=1] positioned -1807 45 -580 run tag @e[distance=..1] add enemy_medabot
...
teleport @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=1] -1807 45 -580
