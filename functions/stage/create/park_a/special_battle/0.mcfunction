...
execute unless entity @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=0] positioned -1800 45 -616 run function medabots_server:spawn_entities/medabot/kasou_touchu/basstroyer/kasou_touchu/kasou_touchu/alien
execute unless entity @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=0] positioned -1800 45 -616 run scoreboard players set @e[distance=..1] Stage 19
execute unless entity @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=0] positioned -1800 45 -616 run tag @e[distance=..1] add enemy_medabot
...
teleport @a[x=-1854,y=51,z=-633,dx=91,dy=4,dz=94,tag=0] -1800 45 -616
