...
execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=0] positioned -1521 45 -401 run function medabots_server:spawn_entities/medabot/pinguen/pure_mermaid/frappe/pinguen/mermaid
...
execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=0] positioned -1521 45 -401 run tag @e[distance=..1] add enemy_medabot
execute positioned -1534 45 -404 run function medabots_server:spawn_entities/cannon/search/east/delay_4
execute positioned -1532 45 -397 run function medabots_server:spawn_entities/cannon/search/east/delay_4
execute positioned -1525 45 -393 run function medabots_server:spawn_entities/cannon/search/north/delay_4
execute positioned -1520 45 -393 run function medabots_server:spawn_entities/cannon/search/north/delay_4
execute positioned -1514 45 -399 run function medabots_server:spawn_entities/cannon/search/west/delay_4
execute positioned -1515 45 -405 run function medabots_server:spawn_entities/cannon/search/west/delay_4
execute positioned -1522 45 -410 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1528 45 -410 run function medabots_server:spawn_entities/cannon/search/south/delay_4
