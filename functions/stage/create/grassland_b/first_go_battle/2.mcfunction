...
execute positioned -1552 45 -395 run function medabots_server:set_blocks/action_floor/enabled/balloon_bomb
execute positioned -1555 45 -397 run function medabots_server:set_blocks/action_floor/enabled/balloon_bomb
execute positioned -1559 45 -400 run function medabots_server:set_blocks/action_floor/enabled/balloon_bomb
...
execute positioned -1563 45 -403 run function medabots_server:set_blocks/action_floor/enabled/balloon_bomb
...
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=1,tag=selected] run summon minecraft:armor_stand -1557 45 -395 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[90.0f,0.0f]}
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=2,tag=selected] run summon minecraft:armor_stand -1560 45 -395 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[-90.0f,0.0f]}
