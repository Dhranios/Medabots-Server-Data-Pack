...
execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=0] positioned -1521 45 -328 run function medabots_server:spawn_entities/enemy_medabot/fly_falcon/basstroyer/nin_ninja/fly_falcon/kabuto
...
tag @e[x=-1521.5,y=45,z=-339.5,distance=..0.7,tag=door,tag=open] remove open
