execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] run tellraw @s[tag=!vs_cpus] {"translate":"medabots_server:message.stage.player.left","color":"green"}
execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] positioned -1529 45 -400 run function medabots_server:spawn_entities/medabot/pinguen/pure_mermaid/frappe/pinguen/mermaid
execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] positioned -1529 45 -400 run scoreboard players set @e[distance=..1] Stage 10
execute unless entity @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] positioned -1529 45 -400 run tag @e[distance=..1] add enemy_medabot
...
effect give @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] minecraft:night_vision 2 0 true
effect give @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] minecraft:blindness 2 0 true
scoreboard players set @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] Battle 2
teleport @a[x=-1570,y=51,z=-414,dx=62,dy=4,dz=95,tag=1] -1529 45 -400
