...
execute unless entity @a[x=-1634,y=51,z=-315,dx=127,dy=4,dz=64,tag=0] positioned -1611 45 -297 run function medabots_server:spawn_entities/medabot/grade_kabuki/kanehachi_mk2/dondoguu/grade_kabuki/alien
