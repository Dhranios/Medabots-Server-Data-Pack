execute if entity @s[tag=vs_cpus] run function medabots_server:stage/create/ruins_out_a/first_go_cpus
...
execute if entity @s[tag=!vs_cpus] run data merge block -1571 52 -315 {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function medabots_server:stage/join/ruins_out_a/first_go/cancle\"}}",Text3:"{\"translate\":\"medabots_server:sign.stage.cancle\"}"}
