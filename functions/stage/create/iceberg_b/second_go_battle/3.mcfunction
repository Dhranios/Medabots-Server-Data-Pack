...
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=3] positioned -1778 44 -429 run function medabots_server:spawn_entities/medabot/peppercat/uglyduck/peppercat/peppercat/kuwagata
...
execute positioned -1776 44 -419 run function medabots_server:spawn_entities/cannon/search/north/delay_4
execute positioned -1781 44 -421 run function medabots_server:spawn_entities/cannon/search/north/delay_4
execute positioned -1771 44 -421 run function medabots_server:spawn_entities/cannon/search/north/delay_4
execute positioned -1784 44 -425 run function medabots_server:spawn_entities/cannon/search/east/delay_4
execute positioned -1774 44 -427 run function medabots_server:spawn_entities/cannon/search/west/delay_4
execute positioned -1775 44 -432 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1780 44 -432 run function medabots_server:spawn_entities/cannon/search/south/delay_4
