...
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=3] positioned -1778 44 -429 run function medabots_server:spawn_entities/enemy_medabot/peppercat/uglyduck/peppercat/peppercat/kuwagata
