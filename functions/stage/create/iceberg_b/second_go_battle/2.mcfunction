...
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] positioned -1767 44 -403 run function medabots_server:spawn_entities/enemy_medabot/pinguen/frappe/pure_mermaid/pinguen/mermaid
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] positioned -1767 44 -403 run scoreboard players set @e[distance=..1] Stage 15
...
teleport @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] -1767 44 -403
summon minecraft:area_effect_cloud -1765 44 -400 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","defeat_all_guards"],Duration:2147483647}
