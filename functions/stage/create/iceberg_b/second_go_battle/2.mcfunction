...
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] positioned -1767 44 -402 run function medabots_server:spawn_entities/medabot/pinguen/frappe/pure_mermaid/pinguen/mermaid
...
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] positioned -1767 44 -402 run tag @e[distance=..1] add enemy_medabot
execute positioned -1771 44 -391 run function medabots_server:spawn_entities/guard/slow/mission
execute positioned -1769 44 -393 run function medabots_server:spawn_entities/guard/slow/mission
