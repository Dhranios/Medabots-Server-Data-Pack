...
execute unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=0] positioned -1774 44 -379 run function medabots_server:spawn_entities/enemy_medabot/dragonbeetle/nin_ninja/attack_tyrano/dragonbeetle/kabuto
...
execute positioned -1778 44 -379 run function medabots_server:spawn_entities/mission/cannon/no_detect/rotating/south/delay_4
execute positioned -1776 44 -379 run function medabots_server:spawn_entities/mission/cannon/no_detect/rotating/south/delay_4
execute positioned -1773 44 -381 run function medabots_server:spawn_entities/mission/cannon/no_detect/rotating/south/delay_4
execute positioned -1771 44 -380 run function medabots_server:spawn_entities/mission/cannon/no_detect/rotating/south/delay_4
