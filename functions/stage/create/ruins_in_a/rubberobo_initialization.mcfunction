execute if entity @s[tag=vs_cpus] run function medabots_server:stage/create/ruins_in_a/rubberobo_cpus
...
execute if entity @s[tag=!vs_cpus] run data merge block -1683 51 -277 {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function medabots_server:stage/join/ruins_in_a/rubberobo/cancle\"}}",Text3:"{\"translate\":\"medabots_server:sign.stage.cancle\"}"}
