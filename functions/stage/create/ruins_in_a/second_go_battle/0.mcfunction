...
execute positioned -1639 44 -343 run function medabots_server:spawn_entities/cannon/no_detect/looking/west/delay_4
execute positioned -1661 44 -327 run function medabots_server:spawn_entities/cannon/no_detect/looking/east/delay_4
execute positioned -1661 44 -331 run function medabots_server:spawn_entities/cannon/no_detect/looking/east/delay_4
