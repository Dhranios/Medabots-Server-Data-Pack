...
execute unless entity @a[x=-1665,y=51,z=-638,dx=64,dy=4,dz=63,tag=4] positioned -1659 45 -618 run function medabots_server:spawn_entities/character_medabot/koji
