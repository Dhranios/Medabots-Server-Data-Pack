...
execute positioned -1617 45 -593 run function medabots_server:set_blocks/accelerator/south
...
scoreboard players set @e[x=-1617.5,y=45,z=-588.5,distance=..0.7,tag=door,scores={PowerNeeded=0}] PowerNeeded 1
