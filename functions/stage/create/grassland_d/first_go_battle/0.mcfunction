...
execute unless entity @a[x=-1600,y=50,z=-750,dx=62,dy=4,dz=62,tag=0] positioned -1589 45 -742 run function medabots_server:spawn_entities/enemy_medabot/bluesdog/bluesdog/shoot_spider/bluesdog/kabuto
...
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=1,tag=selected] run summon minecraft:armor_stand -1587 45 -738 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[90.0f,0.0f]}
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=2,tag=selected] run summon minecraft:armor_stand -1590 45 -739 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[-90.0f,0.0f]}
