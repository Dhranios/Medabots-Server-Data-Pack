...
execute unless entity @a[x=-1570,y=50,z=-480,dx=65,dy=4,dz=63,tag=1] positioned -1537 44 -470 run function medabots_server:spawn_entities/enemy_medabot/bluesdog/bluesdog/fly_falcon/bluesdog/kabuto
...
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=1,tag=selected] run summon minecraft:armor_stand -1534 44 -468 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[90.0f,0.0f]}
execute if entity @e[type=minecraft:area_effect_cloud,tag=referee_marker,tag=2,tag=selected] run summon minecraft:armor_stand -1539 44 -468 {CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Invisible:1b,Rotation:[-90.0f,0.0f]}
