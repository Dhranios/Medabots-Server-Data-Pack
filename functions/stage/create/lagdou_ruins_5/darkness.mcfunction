...
teleport @a[x=-1376,y=50,z=-276,dx=58,dy=4,dz=68,tag=-1] -1372 44 -266
teleport @a[x=-1376,y=50,z=-276,dx=58,dy=4,dz=68,tag=0] -1345 44 -215
teleport @s[tag=-1] -1372 44 -266
...
scoreboard players set @a[x=-1376,y=39,z=-276,dx=58,dy=10,dz=68] Music 0
