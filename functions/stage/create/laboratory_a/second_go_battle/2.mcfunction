...
execute unless entity @a[x=-1812,y=50,z=-322,dx=80,dy=4,dz=72,tag=2] positioned -1773 44 -298 run function medabots_server:spawn_entities/medabot/shoot_spider/kanehachi_mk2/grade_kabuki/shoot_spider/chameleon
