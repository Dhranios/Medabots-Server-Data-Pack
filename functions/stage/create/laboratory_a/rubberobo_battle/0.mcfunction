...
execute unless entity @a[x=-1812,y=50,z=-322,dx=80,dy=4,dz=72,tag=0] positioned -1752 44 -271 run function medabots_server:spawn_entities/medabot/dragonbeetle/dondoguu/nin_ninja/dragonbeetle/kabuto
...
execute unless entity @a[x=-1812,y=50,z=-322,dx=80,dy=4,dz=72,tag=0] positioned -1752 44 -271 run tag @e[distance=..1] add enemy_medabot
execute positioned -1759 44 -264 run function medabots_server:set_blocks/action_floor/enabled/bomb/delay_5
execute positioned -1759 44 -272 run function medabots_server:set_blocks/action_floor/enabled/bomb/delay_5
execute positioned -1748 44 -267 run function medabots_server:set_blocks/action_floor/enabled/bomb/delay_5
execute positioned -1748 44 -275 run function medabots_server:set_blocks/action_floor/enabled/bomb/delay_5
...
tag @e[x=-1760,y=44,z=-270.5,distance=..0.7,tag=door,tag=open] remove open
...
summon minecraft:area_effect_cloud -1753 44 -270 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","hide_normal_time","defeat_the_enemy"],Duration:2147483647}
