execute if entity @s[tag=vs_cpus] run function medabots_server:stage/create/laboratory_a/first_go_cpus
...
execute if entity @s[tag=!vs_cpus] run data merge block -1773 51 -321 {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function medabots_server:stage/join/laboratory_a/first_go/cancle\"}}",Text3:"{\"translate\":\"medabots_server:sign.stage.cancle\"}"}
