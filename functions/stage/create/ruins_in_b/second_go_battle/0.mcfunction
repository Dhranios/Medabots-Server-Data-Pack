...
execute unless entity @a[x=-1666,y=50,z=-572,dx=92,dy=4,dz=92,tag=0] positioned -1621 44 -564 run function medabots_server:spawn_entities/medabot/saintnurse/frappe/saintnurse/saintnurse/mermaid
