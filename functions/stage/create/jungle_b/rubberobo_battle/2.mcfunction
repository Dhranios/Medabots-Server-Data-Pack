...
execute unless entity @a[x=-1666,y=51,z=-477,dx=94,dy=4,dz=92,tag=2] positioned -1650 45 -466 run function medabots_server:spawn_entities/enemy_medabot/fly_falcon/grade_kabuki/maxsnake/fly_falcon/kabuto
