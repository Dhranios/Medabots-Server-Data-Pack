...
execute positioned -1593 45 -408 run function medabots_server:spawn_entities/cannon/swiffle/east/delay_4/mission
execute positioned -1593 45 -406 run function medabots_server:spawn_entities/cannon/swiffle/east/delay_4/mission
execute positioned -1586 45 -402 run function medabots_server:spawn_entities/cannon/swiffle/north/delay_4/mission
execute positioned -1586 45 -413 run function medabots_server:spawn_entities/cannon/swiffle/south/delay_4/mission
execute positioned -1583 45 -414 run function medabots_server:spawn_entities/cannon/swiffle/south/delay_4/mission
execute positioned -1577 45 -412 run function medabots_server:spawn_entities/cannon/swiffle/west/delay_4/mission
execute positioned -1576 45 -404 run function medabots_server:spawn_entities/cannon/swiffle/west/delay_4/mission
