...
execute positioned -1543 45 -175 run function medabots_server:spawn_entities/guard/normal/20_medallar_cents
execute positioned -1543 45 -169 run function medabots_server:spawn_entities/guard/normal/20_medallar_cents
execute positioned -1551 45 -172 run function medabots_server:spawn_entities/guard/normal
execute positioned -1557 45 -174 run function medabots_server:spawn_entities/guard/normal
execute positioned -1565 45 -174 run function medabots_server:spawn_entities/guard/normal
execute positioned -1544 45 -170 run function medabots_server:spawn_entities/cannon/detect/rotating/west/delay_4
execute positioned -1544 45 -174 run function medabots_server:spawn_entities/cannon/detect/rotating/west/delay_4
...
tag @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,tag=open] remove open
