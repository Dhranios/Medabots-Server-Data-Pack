...
execute unless entity @a[x=-1762,y=51,z=-538,dx=94,dy=4,dz=93,tag=2] positioned -1675 45 -486 run function medabots_server:spawn_entities/medabot/doctor_study/kasou_touchu/basstroyer/doctor_study/chameleon
execute unless entity @a[x=-1762,y=51,z=-538,dx=94,dy=4,dz=93,tag=2] positioned -1675 45 -486 run scoreboard players set @e[distance=..1] Stage 14
execute unless entity @a[x=-1762,y=51,z=-538,dx=94,dy=4,dz=93,tag=2] positioned -1675 45 -486 run tag @e[distance=..1] add enemy_medabot
...
summon minecraft:area_effect_cloud -1676 45 -485 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","hide_normal_time","open_the_exit_door"],Duration:2147483647}
