...
execute unless entity @a[x=-1762,y=51,z=-538,dx=94,dy=4,dz=93,tag=4] positioned -1751 45 -528 run function medabots_server:spawn_entities/medabot/uglyduck/uglyduck/uglyduck/uglyduck/monkey
