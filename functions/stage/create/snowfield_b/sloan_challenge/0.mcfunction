...
execute positioned -1738 45 -468 run function medabots_server:spawn_entities/guard/medium
...
execute positioned -1745 45 -457 run function medabots_server:set_blocks/gas_floor/confuse/power_0
execute positioned -1740 45 -462 run function medabots_server:set_blocks/gas_floor/confuse/power_0
