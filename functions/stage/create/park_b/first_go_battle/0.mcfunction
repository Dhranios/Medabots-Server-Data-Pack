...
execute unless entity @a[x=-1857,y=51,z=-730,dx=94,dy=4,dz=94,tag=0] positioned -1810 45 -653 run function medabots_server:spawn_entities/character_medabot/erika
...
scoreboard players set @e[x=-1809.5,y=45,z=-667.5,distance=..0.7,tag=door,scores={PowerNeeded=0}] PowerNeeded 1
