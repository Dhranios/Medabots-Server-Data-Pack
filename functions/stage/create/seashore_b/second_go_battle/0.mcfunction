...
execute unless entity @a[x=-1762,y=51,z=-442,dx=94,dy=4,dz=94,tag=0] positioned -1756 44 -360 run function medabots_server:spawn_entities/medabot/basstroyer/hellphoenix/shoot_spider/basstroyer/kuwagata
execute unless entity @a[x=-1762,y=51,z=-442,dx=94,dy=4,dz=94,tag=0] positioned -1756 44 -360 run scoreboard players set @e[distance=..1] Stage 13
execute unless entity @a[x=-1762,y=51,z=-442,dx=94,dy=4,dz=94,tag=0] positioned -1756 44 -360 run tag @e[distance=..1] add enemy_medabot
