...
execute unless entity @a[x=-1762,y=51,z=-442,dx=94,dy=4,dz=94,tag=1] positioned -1747 45 -430 run function medabots_server:spawn_entities/medabot/hippopojamas/basstroyer/hellphoenix/hippopojamas/knight
