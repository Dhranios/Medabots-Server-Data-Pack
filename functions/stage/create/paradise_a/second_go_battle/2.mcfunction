...
execute unless entity @a[x=-1761,y=51,z=-730,dx=94,dy=4,dz=94,tag=2] positioned -1720 45 -718 run function medabots_server:spawn_entities/enemy_medabot/basstroyer/kasou_touchu/poison_scorpi/basstroyer/kuwagata
...
execute positioned -1722 45 -718 run function medabots_server:set_blocks/floor_switch/green
execute positioned -1716 45 -718 run function medabots_server:set_blocks/floor_switch/green
execute positioned -1711 45 -719 run function medabots_server:set_blocks/floor_switch/green
...
summon minecraft:area_effect_cloud -1718 45 -719 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","open_the_exit_door"],Duration:2147483647}
