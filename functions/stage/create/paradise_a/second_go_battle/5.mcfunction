...
execute unless entity @a[x=-1761,y=51,z=-730,dx=94,dy=4,dz=94,tag=5] positioned -1743 45 -669 run function medabots_server:spawn_entities/enemy_medabot/fly_falcon/shoot_spider/basstroyer/fly_falcon/kabuto
...
execute positioned -1738 45 -666 run function medabots_server:spawn_entities/guard/slow
execute positioned -1734 45 -675 run function medabots_server:spawn_entities/guard/slow
execute positioned -1739 45 -679 run function medabots_server:spawn_entities/guard/slow
execute positioned -1748 45 -678 run function medabots_server:spawn_entities/guard/slow
execute positioned -1753 45 -672 run function medabots_server:spawn_entities/guard/slow
execute positioned -1754 45 -666 run function medabots_server:spawn_entities/guard/slow
...
summon minecraft:area_effect_cloud -1746 45 -670 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","destroy_all_cannons"],Duration:2147483647}
