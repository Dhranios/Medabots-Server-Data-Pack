...
execute positioned -1690 45 -684 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1681 45 -675 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1677 45 -668 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1684 45 -663 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1684 45 -653 run function medabots_server:spawn_entities/mission/guard/normal
