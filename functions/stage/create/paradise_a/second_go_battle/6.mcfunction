...
execute positioned -1749 45 -646 run function medabots_server:spawn_entities/guard/medium/mission
execute positioned -1739 45 -650 run function medabots_server:spawn_entities/guard/medium/mission
execute positioned -1738 45 -642 run function medabots_server:spawn_entities/guard/medium/mission
