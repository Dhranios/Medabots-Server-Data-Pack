...
execute positioned -1744 45 -718 run function medabots_server:spawn_entities/mission/cannon/search/east/delay_4
execute positioned -1746 45 -723 run function medabots_server:spawn_entities/mission/cannon/search/north/delay_4
execute positioned -1749 45 -716 run function medabots_server:spawn_entities/mission/cannon/search/south/delay_4
execute positioned -1751 45 -721 run function medabots_server:spawn_entities/mission/cannon/search/west/delay_4
execute positioned -1749 45 -724 run function medabots_server:set_blocks/bridge
scoreboard players set @e[x=-1739.5,y=45,z=-707.5,distance=..0.7,tag=door,scores={NeededPower=0}] NeededPower 1
