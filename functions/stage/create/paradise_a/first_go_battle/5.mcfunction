...
execute positioned -1732 45 -679 run function medabots_server:spawn_entities/mission/cannon/detect/rotating/west/delay_4
execute positioned -1744 45 -680 run function medabots_server:spawn_entities/mission/cannon/detect/rotating/south/delay_4
execute positioned -1754 45 -677 run function medabots_server:spawn_entities/mission/cannon/detect/rotating/east/delay_4
