...
execute positioned -1738 45 -650 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1750 45 -645 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1728 45 -649 run function medabots_server:spawn_entities/mission/guard/normal
execute positioned -1737 45 -642 run function medabots_server:spawn_entities/mission/guard/normal
...
summon minecraft:area_effect_cloud -1745 45 -653 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","hide_normal_time","defeat_all_guards"],Duration:2147483647}
