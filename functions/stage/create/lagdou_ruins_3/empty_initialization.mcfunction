...
execute if entity @s[tag=!vs_cpus] run data merge block -1226 52 -58 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/lagdou_ruins_3/empty/0"}}'}
