...
teleport @a[x=-1267,y=50,z=-139,dx=60,dy=4,dz=77,tag=-1] -1221 43 -63 0 0
teleport @a[x=-1267,y=50,z=-139,dx=60,dy=4,dz=77,tag=0] -1236 45 -135 -180 0
teleport @s[tag=-1] -1221 43 -63 0 0
