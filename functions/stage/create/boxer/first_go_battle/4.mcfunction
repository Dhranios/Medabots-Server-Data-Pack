...
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=4] positioned -1908 44 -588 run function medabots_server:spawn_entities/medabot/sailor_multi/sailor_multi/sailor_multi/sailor_multi/kabuto
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=4] positioned -1908 44 -588 run scoreboard players set @e[distance=..1] Stage 29
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=4] positioned -1908 44 -588 run tag @e[distance=..1] add enemy_medabot
