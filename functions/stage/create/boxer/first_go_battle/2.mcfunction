...
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=2] positioned -1873 43 -590 run function medabots_server:spawn_entities/enemy_medabot/peppercat/peppercat/peppercat/peppercat/kuwagata
