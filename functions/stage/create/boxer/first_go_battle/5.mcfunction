...
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=5] positioned -1917 44 -572 run function medabots_server:spawn_entities/enemy_medabot/dorcus/dorcus/dorcus/dorcus/kuwagata
