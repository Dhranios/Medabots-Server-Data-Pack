...
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=5] positioned -1917 44 -572 run function medabots_server:spawn_entities/medabot/dorcus/dorcus/dorcus/dorcus/kuwagata
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=5] positioned -1917 44 -572 run scoreboard players set @e[distance=..1] Stage 29
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=5] positioned -1917 44 -572 run tag @e[distance=..1] add enemy_medabot
...
summon minecraft:area_effect_cloud -1916 44 -571 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","hide_normal_time","defeat_the_enemy"],Duration:2147483647}
