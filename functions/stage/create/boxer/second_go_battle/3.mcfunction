...
execute unless entity @a[x=-1921,y=50,z=-603,dx=64,dy=4,dz=64,tag=3] positioned -1890 44 -594 run function medabots_server:spawn_entities/enemy_medabot/aimflash/aimflash/aimflash/aimflash/monkey
...
execute positioned -1890 44 -598 run function medabots_server:spawn_entities/guard/slow
execute positioned -1889 44 -598 run function medabots_server:spawn_entities/guard/slow
