...
execute positioned -1715 44 -569 run function medabots_server:spawn_entities/cannon/search/south/delay_8/mission
execute positioned -1719 44 -550 run function medabots_server:spawn_entities/cannon/search/north/delay_8/mission
execute positioned -1708 44 -550 run function medabots_server:spawn_entities/cannon/search/north/delay_8/mission
...
scoreboard players set @e[x=-1724.5,y=44,z=-558.5,distance=..0.7,tag=door,scores={PowerNeeded=0}] PowerNeeded 1
