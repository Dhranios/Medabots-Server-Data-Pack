...
execute positioned -1691 44 -569 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_8
execute positioned -1689 44 -551 run function medabots_server:spawn_entities/cannon/detect/rotating/north/delay_8
execute positioned -1680 44 -571 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_8
...
execute positioned -1678 44 -568 run function medabots_server:spawn_entities/balloon_bomb
...
tag @e[x=-1696.5,y=44,z=-599.5,distance=..0.7,tag=door,tag=open] remove open
