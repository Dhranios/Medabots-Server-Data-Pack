...
execute positioned -1691 44 -569 run function medabots_server:spawn_entities/cannon/search/south/delay_8
execute positioned -1689 44 -551 run function medabots_server:spawn_entities/cannon/search/north/delay_8
execute positioned -1680 44 -571 run function medabots_server:spawn_entities/cannon/search/south/delay_8
...
scoreboard players set @e[x=-1696.5,y=44,z=-558.5,distance=..0.7,tag=door,scores={PowerNeeded=0}] PowerNeeded 1
