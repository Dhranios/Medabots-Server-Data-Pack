...
execute positioned -1750 44 -613 run function medabots_server:spawn_entities/cannon/search/east/delay_8/mission
execute positioned -1735 44 -606 run function medabots_server:spawn_entities/cannon/tripwire/north/delay_8/mission
execute positioned -1756 44 -623 run function medabots_server:spawn_entities/cannon/tripwire/east/delay_8/mission
execute positioned -1736 44 -624 run function medabots_server:spawn_entities/cannon/search/south/delay_8/mission
