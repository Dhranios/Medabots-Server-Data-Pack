...
execute positioned -1753 44 -586 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_8
execute positioned -1733 44 -583 run function medabots_server:spawn_entities/cannon/detect/rotating/west/delay_8
execute positioned -1754 44 -593 run function medabots_server:spawn_entities/cannon/detect/rotating/east/delay_8
execute positioned -1739 44 -597 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_8
