...
execute positioned -1753 44 -586 run function medabots_server:spawn_entities/cannon/search/south/delay_8
execute positioned -1733 44 -583 run function medabots_server:spawn_entities/cannon/search/west/delay_8
execute positioned -1754 44 -593 run function medabots_server:spawn_entities/cannon/search/east/delay_8
execute positioned -1739 44 -597 run function medabots_server:spawn_entities/cannon/search/south/delay_8
