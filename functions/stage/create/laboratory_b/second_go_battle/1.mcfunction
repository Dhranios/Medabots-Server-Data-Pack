...
execute unless entity @a[x=-1760,y=51,z=-633,dx=92,dy=4,dz=92,tag=1] positioned -1683 44 -559 run function medabots_server:spawn_entities/enemy_medabot/pastel_fairy/pure_mermaid/frappe/pastel_fairy/chameleon
...
execute positioned -1690 44 -571 run function medabots_server:spawn_entities/mission/guard/slow
execute positioned -1693 44 -551 run function medabots_server:spawn_entities/mission/guard/slow
execute positioned -1679 44 -567 run function medabots_server:spawn_entities/mission/guard/slow
execute positioned -1679 44 -551 run function medabots_server:spawn_entities/mission/guard/slow
execute positioned -1691 44 -569 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_4
execute positioned -1689 44 -551 run function medabots_server:spawn_entities/cannon/detect/rotating/north/delay_4
execute positioned -1680 44 -571 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_4
...
summon minecraft:area_effect_cloud -1685 44 -560 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","defeat_all_guards"],Duration:2147483647}
