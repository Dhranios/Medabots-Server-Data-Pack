...
execute positioned -1754 44 -586 run function medabots_server:spawn_entities/cannon/search/south/delay_4
execute positioned -1732 44 -583 run function medabots_server:spawn_entities/cannon/search/west/delay_4
execute positioned -1755 44 -593 run function medabots_server:spawn_entities/cannon/search/east/delay_4
execute positioned -1739 44 -598 run function medabots_server:spawn_entities/cannon/search/south/delay_4
