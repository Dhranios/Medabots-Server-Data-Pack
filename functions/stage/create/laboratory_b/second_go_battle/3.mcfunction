...
execute positioned -1735 44 -606 run function medabots_server:spawn_entities/cannon/tripwire/north/delay_4/mission
execute positioned -1756 44 -623 run function medabots_server:spawn_entities/cannon/tripwire/east/delay_4/mission
