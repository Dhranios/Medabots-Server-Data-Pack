...
execute unless entity @a[x=-1760,y=51,z=-633,dx=92,dy=4,dz=92,tag=3] positioned -1743 44 -619 run function medabots_server:spawn_entities/poison_scorpi/knight_armor/kanehachi_mk2/poison_scorpi/kuwagata
...
execute positioned -1732 45 -612 run function medabots_server:spawn_entities/guard/slow
...
execute positioned -1751 44 -613 run function medabots_server:spawn_entities/balloon_bomb
execute positioned -1749 44 -613 run function medabots_server:spawn_entities/balloon_bomb
...
summon minecraft:area_effect_cloud -1744 44 -617 {CustomName:'{"translate":"medabots_server:message.stage.mission"}',Tags:["mission","destroy_all_cannons"],Duration:2147483647}
