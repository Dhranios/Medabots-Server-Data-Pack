...
execute positioned -1755 44 -586 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_4
execute positioned -1731 44 -583 run function medabots_server:spawn_entities/cannon/detect/rotating/west/delay_4
execute positioned -1756 44 -593 run function medabots_server:spawn_entities/cannon/detect/rotating/east/delay_4
execute positioned -1739 44 -599 run function medabots_server:spawn_entities/cannon/detect/rotating/south/delay_4
