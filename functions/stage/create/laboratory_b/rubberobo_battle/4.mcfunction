...
execute unless entity @a[x=-1760,y=51,z=-633,dx=92,dy=4,dz=92,tag=4] positioned -1678 44 -626 run function medabots_server:spawn_entities/medabot/fly_falcon/shoot_spider/basstroyer/fly_falcon/kabuto
