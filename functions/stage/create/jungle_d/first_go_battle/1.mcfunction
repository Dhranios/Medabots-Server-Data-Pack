...
execute unless entity @a[x=-1665,y=51,z=-768,dx=61,dy=4,dz=61,tag=1] positioned -1656 45 -736 run function medabots_server:spawn_entities/enemy_medabot/keithturtle/dondoguu/keithturtle/keithturtle/kabuto
