execute store result score @s BattlingMedabots if entity @e[scores={Stage=92,Medabot=0..,Battle=1..}]
...
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/lagdou_ruins_6_first_go=true}] only medabots_server:stages/lagdou_ruins_6_second_go
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/lagdou_ruins_6_first_go=false}] only medabots_server:stages/lagdou_ruins_6_first_go
...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[scores={Stage=92},type=!minecraft:player] add dead
...
execute as @e[x=-1267,y=40,z=-139,dx=60,dy=9,dz=77,type=!minecraft:player] unless entity @s[scores={Stage=92}] run scoreboard players set @s Stage 92