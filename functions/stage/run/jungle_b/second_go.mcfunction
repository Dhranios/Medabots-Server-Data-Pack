execute unless entity @e[x=-1666,y=0,z=-477,dx=94,dy=50,dz=92,scores={Medabot=0..,Battle=1..2,Stage=12},tag=enemy_medabot] run bossbar set medabots_server:jungle_b/time players @s[scores={Battle=1..}]
...
execute if block -1601 45 -468 minecraft:iron_door[open=true] if block -1606 45 -457 minecraft:iron_door[open=false] if entity @s[x=-1604,y=45,z=-470,dx=3,dy=3,dz=3] run function medabots_server:stage/create/jungle_b/second_go_battle/1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1605.5,y=45,z=-456.5,distance=..0.7,tag=door,tag=!open] add open
...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1620 51 -431 1000
...
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1620 51 -431 -180 0
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run bossbar set medabots_server:jungle_b/robattle players
