...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1583.5,y=45,z=-408.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission,type=minecraft:area_effect_cloud_entity,scores={Stage=12}] run tag @s remove run_until_the_time_is_up
