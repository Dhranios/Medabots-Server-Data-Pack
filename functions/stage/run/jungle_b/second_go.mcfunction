...
execute if block -1645 44 -408 minecraft:blue_wool if block -1629 44 -420 minecraft:blue_wool if block -1629 44 -421 minecraft:yellow_wool run tag @e[x=-1627.5,y=45,z=-419.5,distance=..0.7,tag=alarm,tag=!enabled] add enabled
execute if block -1645 44 -408 minecraft:light_blue_wool run tag @e[x=-1627.5,y=45,z=-419.5,distance=..0.7,tag=alarm,tag=enabled] remove enabled
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1600.5,y=45,z=-467.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1605.5,y=45,z=-455.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1615.5,y=45,z=-463.5,distance=..0.7,tag=door,tag=!open] add open
