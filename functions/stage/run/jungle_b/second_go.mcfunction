...
execute if entity @s[scores={BattlingMedabots=1}] as @e[x=-1583.5,y=45,z=-408.5,distance=..0.7,tag=mission,scores={Dialog=81}] unless entity @e[x=-1666,y=0,z=-477,dx=94,dy=50,dz=92,tag=mission_entity,scores={Stage=12}] run tag @s remove run_until_the_time_is_up
