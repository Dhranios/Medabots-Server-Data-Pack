...
execute if block -1645 44 -408 minecraft:blue_wool if block -1629 44 -420 minecraft:blue_wool if block -1629 44 -421 minecraft:yellow_wool run tag @e[x=-1627.5,y=45,z=-420.5,distance=..0.7,tag=alarm,tag=!enabled] add enabled
execute if block -1645 44 -408 minecraft:light_blue_wool run tag @e[x=-1627.5,y=45,z=-420.5,distance=..0.7,tag=alarm,tag=enabled] remove enabled
execute if block -1629 44 -420 minecraft:light_blue_wool run tag @e[x=-1627.5,y=45,z=-420.5,distance=..0.7,tag=alarm,tag=enabled] remove enabled
execute if block -1629 44 -421 minecraft:orange_wool run tag @e[x=-1627.5,y=45,z=-420.5,distance=..0.7,tag=alarm,tag=enabled] remove enabled
