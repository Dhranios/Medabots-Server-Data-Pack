...
execute if block -1703 43 -599 minecraft:blue_wool run tag @e[x=-1678.5,y=44,z=-612.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1703 43 -599 minecraft:light_blue_wool run tag @e[x=-1678.5,y=44,z=-612.5,distance=..0.7,tag=door,tag=open] remove open
execute if block -1751 43 -543 minecraft:blue_wool run tag @e[x=-1750.5,y=44,z=-543.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1751 43 -543 minecraft:light_blue_wool run tag @e[x=-1750.5,y=44,z=-543.5,distance=..0.7,tag=action_floor,tag=enabled] remove enabled
execute if block -1751 43 -543 minecraft:blue_wool run tag @e[x=-1726.5,y=44,z=-542.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1751 43 -543 minecraft:light_blue_wool run tag @e[x=-1726.5,y=44,z=-542.5,distance=..0.7,tag=action_floor,tag=enabled] remove enabled
execute if block -1751 43 -543 minecraft:blue_wool run tag @e[x=-1698.5,y=44,z=-542.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1751 43 -543 minecraft:light_blue_wool run tag @e[x=-1698.5,y=44,z=-542.5,distance=..0.7,tag=action_floor,tag=enabled] remove enabled
execute if block -1751 43 -543 minecraft:blue_wool run tag @e[x=-1670.5,y=44,z=-542.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1751 43 -543 minecraft:light_blue_wool run tag @e[x=-1670.5,y=44,z=-542.5,distance=..0.7,tag=action_floor,tag=enabled] remove enabled
execute if block -1759 43 -551 minecraft:blue_wool run tag @e[x=-1757.5,y=44,z=-550.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1759 43 -551 minecraft:light_blue_wool run tag @e[x=-1757.5,y=44,z=-550.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1759 43 -551 minecraft:blue_wool run tag @e[x=-1758.5,y=44,z=-574.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1759 43 -551 minecraft:light_blue_wool run tag @e[x=-1758.5,y=44,z=-574.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1759 43 -551 minecraft:blue_wool run tag @e[x=-1758.5,y=44,z=-602.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1759 43 -551 minecraft:light_blue_wool run tag @e[x=-1758.5,y=44,z=-602.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1759 43 -551 minecraft:blue_wool run tag @e[x=-1758.5,y=44,z=-630.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1759 43 -551 minecraft:light_blue_wool run tag @e[x=-1758.5,y=44,z=-630.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
...
execute if entity @s[tag=mission_success] run tag @e[x=-1672.5,y=44,z=-557.5,distance=..0.7,tag=door,tag=!open] add open
