...
execute if entity @e[scores={Stage=56},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1905,y=42,z=-438,dx=79,dy=7,dz=78,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
