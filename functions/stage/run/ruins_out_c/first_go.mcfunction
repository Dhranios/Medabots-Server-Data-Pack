...
execute if block -1644 43 -676 minecraft:yellow_wool run scoreboard players set @e[x=-1635.5,y=44,z=-680.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1634 43 -681 minecraft:orange_wool if block -1644 43 -676 minecraft:orange_wool run scoreboard players set @e[x=-1635.5,y=44,z=-680.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
execute if block -1609 43 -694 minecraft:lime_wool run scoreboard players set @e[x=-1628.5,y=44,z=-662.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1652 43 -647 minecraft:lime_wool if block -1657 43 -652 minecraft:lime_wool if block -1654 43 -658 minecraft:lime_wool if block -1655 43 -653 minecraft:lime_wool run scoreboard players set @e[x=-1630.5,y=44,z=-657.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1609 43 -694 minecraft:lime_wool run scoreboard players set @e[x=-1630.5,y=44,z=-698.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=0}] PowerAmount 1
execute if block -1609 43 -694 minecraft:lime_wool run scoreboard players set @e[x=-1630.5,y=44,z=-699.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=0}] PowerAmount 1
execute if block -1609 43 -694 minecraft:lime_wool run scoreboard players set @e[x=-1617.5,y=44,z=-698.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=0}] PowerAmount 1
execute if block -1609 43 -694 minecraft:lime_wool run scoreboard players set @e[x=-1617.5,y=44,z=-699.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=0}] PowerAmount 1
execute if block -1650 43 -653 minecraft:light_blue_wool run scoreboard players set @e[x=-1650.5,y=44,z=-652.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=0}] PowerAmount 1
execute if block -1650 43 -653 minecraft:blue_wool run scoreboard players set @e[x=-1650.5,y=44,z=-652.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=1}] PowerAmount 0
