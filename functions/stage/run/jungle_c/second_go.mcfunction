execute unless entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] run bossbar set medabots_server:jungle_c/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] store result score #temp Time run bossbar get medabots_server:jungle_c/time value
execute unless entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] store result bossbar medabots_server:jungle_c/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] store result score #temp Time run bossbar get medabots_server:jungle_c/robattle value
execute if entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] store result bossbar medabots_server:jungle_c/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] if score #temp Time matches 0 as @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,scores={Medabot=0..,Battle=1..2,Stage=24},tag=enemy_medabot] if score #temp Time matches 0 as @e[x=-1570,y=42,z=-545,dx=62,dy=7,dz=62,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1541 50 -515 14
