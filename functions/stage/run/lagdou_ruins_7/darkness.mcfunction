...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1280 51 -171 1000
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1280 51 -171 -180 0
