execute if entity @e[x=-1256,y=0,z=-58,dx=59,dy=50,dz=83,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=38,Medabot=0..,Battle=1..}]
