...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1224 51 -19 1000
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1224 51 -19 -180 0
