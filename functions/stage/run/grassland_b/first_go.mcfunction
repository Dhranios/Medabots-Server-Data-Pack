...
execute if entity @e[x=-1520.5,y=45,z=-328.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=10,Medabot=0..,Battle=1..2}]
title @s[scores={BattlingMedabots=1,Battle=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1521.5,y=45,z=-339.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run kill @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mission,type=minecraft:area_effect_cloud]
...
execute if entity @e[x=-1523.5,y=45,z=-398.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=10,Medabot=0..,Battle=1..2}]
...
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run tag @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,scores={Stage=10,Medabot=0..,Battle=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] as @a[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,scores={Stage=10,Medabot=0..,Battle=1..},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
...
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run scoreboard players set @e[x=-1537.5,y=45,z=-402.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run scoreboard players set @e[x=-1519.5,y=45,z=-388.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run bossbar set medabots_server:grassland_b/robattle players
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run kill @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,type=minecraft:area_effect_cloud,tag=mission,type=minecraft:area_effect_cloud]
...
execute if entity @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=10,Medabot=0..,Battle=1..2}]
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run bossbar set medabots_server:grassland_b/robattle players
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:story_progression/infinity={vs_koji_battle=true,vs_sloan_begin=false}}] add dialog_infinity_vs_sloan_begin
