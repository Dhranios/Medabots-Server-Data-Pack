...
execute if entity @e[x=-1520.5,y=45,z=-328.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,scores={Stage=30,Medabot=0..,Battle=1..}]
execute if entity @e[x=-1520.5,y=45,z=-328.5,distance=..0.7,tag=mission,scores={Time=81}] run title @s[scores={BattlingMedabots=1}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @e[x=-1520.5,y=45,z=-328.5,distance=..0.7,tag=mission,scores={Time=81}] if block -1521 46 -340 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1521 45 -340 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if entity @s[scores={BattlingMedabots=1}] run kill @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mission]
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:grassland_b/time players
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] store result score #temp Time run bossbar get medabots_server:grassland_b/time value
...
execute if score #temp Time matches 0 as @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mission] at @s run function medabots_server:stage/mission_time_up
...
execute if entity @e[x=-1523.5,y=45,z=-398.5,distance=..0.7,tag=mission,scores={Time=81}] if block -1531 44 -404 minecraft:yellow_wool if block -1530 44 -399 minecraft:yellow_wool if block -1526 44 -395 minecraft:yellow_wool if block -1519 44 -395 minecraft:yellow_wool if block -1516 44 -398 minecraft:yellow_wool if block -1517 44 -403 minecraft:yellow_wool if block -1521 44 -408 minecraft:yellow_wool if block -1527 44 -407 minecraft:yellow_wool run bossbar set medabots_server:grassland_b/time players
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] store result score #temp Time run bossbar get medabots_server:grassland_b/time value
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] store result bossbar medabots_server:grassland_b/time value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if score #temp Time matches 0 as @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] run scoreboard players reset #temp Time
...
execute if entity @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mr_referee] store result score @s BattlingMedabots if entity @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,scores={Stage=30,Medabot=0..,Battle=1..}]
execute as @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,type=!minecraft:player] unless entity @s[scores={Stage=30}] run scoreboard players set @s Stage 30
execute if entity @s[scores={BattlingMedabots=1}] run function medabots_server:stage/clean_up/grassland_b/second_go
stopsound @s[scores={BattlingMedabots=1}] music
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1}] -1540 51 -367 14
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:stages/wave_1/grassland_b_second_go
teleport @s[scores={BattlingMedabots=1}] -1540 51 -367 -180 0
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:grassland_b/time players
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] store result score #temp Time run bossbar get medabots_server:grassland_b/time value
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] store result bossbar medabots_server:grassland_b/time value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if score #temp Time matches 0 as @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
execute if entity @s[scores={BattlingMedabots=2..,Battle=1}] run scoreboard players reset #temp Time
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
