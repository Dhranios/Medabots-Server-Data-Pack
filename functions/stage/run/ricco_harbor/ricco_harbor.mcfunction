...
execute if entity @s[scores={BattlingMedabots=2..}] unless entity @e[x=-1504,y=8,z=-210,dx=275,dy=41,dz=93,tag=mr_referee,type=minecraft:armor_stand] run summon minecraft:armor_stand -1430 75 -149 {Invisible:1b,Marker:1b,Small:1b,CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee","no_overwrite"],Rotation:[-180.0f,0.0f]}
...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1440 51 -158 14
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1440 51 -158 -180 0
