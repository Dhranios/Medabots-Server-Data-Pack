...
execute if entity @e[scores={Stage=28},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1596,y=42,z=-618,dx=22,dy=7,dz=44,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
