...
execute if entity @e[x=-1665,y=42,z=-768,dx=61,dy=7,dz=61,tag=mr_referee] store result score @s BattlingMedabots if entity @e[scores={Stage=31,Medabot=0..,Battle=1..2}]
