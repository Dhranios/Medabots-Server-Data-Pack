...
execute if entity @e[scores={Stage=32},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1602,y=42,z=-815,dx=61,dy=7,dz=62,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
