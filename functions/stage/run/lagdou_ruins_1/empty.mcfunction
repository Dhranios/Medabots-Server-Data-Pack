...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1298 51 -87 1000
...
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1298 51 -87 -180 0
