...
execute if entity @s[scores={BattlingMedabots=2..}] unless entity @e[x=-1329,y=0,z=-115,dx=61,dy=50,dz=61,tag=mr_referee] run summon minecraft:armor_stand -1298 46 -73 {Invisible:1b,Marker:1b,Small:1b,CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee","not_7","no_overwrite"],Rotation:[-180.0f,0.0f]}
