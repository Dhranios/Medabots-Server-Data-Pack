...
execute if entity @e[x=-1609.5,y=45,z=-298.5,distance=..0.7,tag=mission] store result score @s BattlingMedabots if entity @e[x=-1619,y=42,z=-308,dx=17,dy=7,dz=17,scores={Stage=21,Medabot=0..}]
...
execute if block -1622 46 -300 minecraft:iron_door[open=false] as @s[scores={BattlingMedabots=1}] run setblock -1622 45 -300 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/open_door",mode:"LOAD"}
