...
execute if block -1601 44 -286 minecraft:orange_wool run scoreboard players set @e[x=-1620.5,y=45,z=-253.5,distance=..0.7,tag=press_wall,scores={PowerAmount=0}] PowerAmount 1
execute if block -1601 44 -286 minecraft:yellow_wool run scoreboard players set @e[x=-1620.5,y=45,z=-253.5,distance=..0.7,tag=press_wall,scores={PowerAmount=1}] PowerAmount 0
...
execute if entity @e[x=-1634,y=42,z=-315,dx=127,dy=7,dz=64,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=7,Medabot=0..,Battle=1..2}]
