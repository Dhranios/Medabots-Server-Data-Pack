...
execute if entity @e[x=-1608.5,y=45,z=-299.5,distance=..0.7,tag=mission,scores={Dialog=81}] run title @s[scores={BattlingMedabots=1,Death=0}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
...
execute if entity @e[x=-1608.5,y=45,z=-299.5,distance=..0.7,tag=mission,scores={Dialog=81}] if block -1624 46 -284 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1,Death=0}] run setblock -1624 45 -284 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
