...
advancement grant @s[x=-1566.5,y=45,z=-311.5,distance=..0.7,tag=hostile,gamemode=adventure] only medabots_server:wave_1/torutoru_land_master ruins_out_a_second_go
