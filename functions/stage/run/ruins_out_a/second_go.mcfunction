...
execute if block -1552 44 -260 minecraft:light_blue_wool run scoreboard players set @e[x=-1551.5,y=45,z=-258.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=0}] PowerAmount 1
execute if block -1552 44 -260 minecraft:blue_wool run scoreboard players set @e[x=-1551.5,y=45,z=-258.5,distance=..0.7,tag=hammer_punch,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1624 45 -284 minecraft:iron_door[open=false] if block -1602 44 -286 minecraft:lime_wool run scoreboard players set @e[x=-1601.5,y=45,z=-301.5,distance=..0.7,tag=press_wall,scores={PowerAmount=0}] PowerAmount 1
execute if block -1624 45 -284 minecraft:iron_door[open=true] run scoreboard players set @e[x=-1601.5,y=45,z=-301.5,distance=..0.7,tag=press_wall,scores={PowerAmount=1}] PowerAmount 0
execute if block -1624 45 -284 minecraft:iron_door[open=false] if block -1602 44 -286 minecraft:lime_wool run scoreboard players set @e[x=-1596.5,y=45,z=-284.5,distance=..0.7,tag=press_wall,scores={PowerAmount=0}] PowerAmount 1
execute if block -1624 45 -284 minecraft:iron_door[open=true] run scoreboard players set @e[x=-1596.5,y=45,z=-284.5,distance=..0.7,tag=press_wall,scores={PowerAmount=1}] PowerAmount 0
execute if block -1609 44 -283 minecraft:orange_wool run scoreboard players set @e[x=-1620.5,y=45,z=-253.5,distance=..0.7,tag=press_wall,scores={PowerAmount=0}] PowerAmount 1
execute if block -1609 44 -283 minecraft:yellow_wool run scoreboard players set @e[x=-1620.5,y=45,z=-253.5,distance=..0.7,tag=press_wall,scores={PowerAmount=1}] PowerAmount 0
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1623.5,y=45,z=-283.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
