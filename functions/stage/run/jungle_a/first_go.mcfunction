execute if entity @s[scores={Death=1..}] run function medabots_server:stage/clean_up/jungle_a/first_go
...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run function medabots_server:stage/clean_up/jungle_a/first_go
...
advancement grant @s[scores={BattlingMedabots=1,Death=0}] only medabots_server:stages/wave_1/jungle_a_first_go
teleport @s[scores={BattlingMedabots=1,Death=0}] -1673 51 -148 -180 0
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run bossbar set medabots_server:jungle_a/robattle players
tag @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:wave_1/story_progression={meet_koji=true,meet_director_tune=false}}] add dialog_infinity_meet_director_tune
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots