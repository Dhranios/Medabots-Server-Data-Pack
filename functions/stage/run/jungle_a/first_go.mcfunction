...
execute unless entity @e[x=-1706,y=42,z=-179,dx=63,dy=8,dz=63,scores={Medabot=0..,Battle=1..2,Stage=3},tag=enemy_medabot] run bossbar set medabots_server:jungle_a/time players @s[scores={Battle=1..}]
...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1661.5,y=45,z=-123.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1660.5,y=45,z=-133.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1}] run kill @e[x=-1706,y=42,z=-179,dx=63,dy=7,dz=63,tag=mission]
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:jungle_a/robattle players
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:stages/wave_1/jungle_a_first_go
teleport @s[scores={BattlingMedabots=1}] -1673 51 -148 -180 0
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:jungle_a/robattle players
tag @s[scores={BattlingMedabots=1},advancements={medabots_server:wave_1/story_progression={meet_koji=true,meet_director_tune=false}}] add dialog_infinity_meet_director_tune
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots