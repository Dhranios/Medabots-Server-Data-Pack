...
execute if block -1690 44 -156 minecraft:light_blue_wool run tag @e[x=-1697.5,y=45,z=-144.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1690 44 -156 minecraft:blue_wool run tag @e[x=-1697.5,y=45,z=-144.5,distance=..0.7,tag=door,tag=open] remove open
execute if block -1680 44 -168 minecraft:lime_wool run tag @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1682 44 -170 minecraft:lime_wool run tag @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1684 44 -169 minecraft:lime_wool run tag @e[x=-1686.5,y=45,z=-172.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1651 44 -156 minecraft:lime_wool run tag @e[x=-1644.5,y=45,z=-153.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1680 44 -168 minecraft:lime_wool run tag @e[x=-1679.5,y=45,z=-163.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1682 44 -170 minecraft:lime_wool run tag @e[x=-1681.5,y=45,z=-173.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1684 44 -169 minecraft:lime_wool run tag @e[x=-1683.5,y=45,z=-163.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
...
tag @s[tag=clear_stage,advancements={medabots_server:wave_1/story_progression={rubberobo_enters_jungle_a=true,rubberobo_leaves_jungle_a=false}}] add dialog_infinity_rubberobo_leaves_jungle_a
