...
execute if entity @e[x=-1651.5,y=45,z=-126.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1662,y=42,z=-135,dx=17,dy=8,dz=17,scores={Stage=9,Medabot=0..}]
...
execute if entity @e[x=-1706,y=42,z=-179,dx=63,dy=8,dz=63,tag=mr_referee,type=minecraft:armor_stand] store result score @s BattlingMedabots if entity @e[x=-1702,y=42,z=-178,dx=17,dy=8,dz=15,scores={Stage=9,Medabot=0..}]
execute as @e[x=-1705,y=42,z=-179,dx=63,dy=8,dz=63,type=!minecraft:player] unless entity @s[scores={Stage=8}] run scoreboard players set @s Stage 9
execute unless entity @s[x=-1705,y=42,z=-179,dx=63,dy=8,dz=63,scores={Battle=1..}] run function medabots_server:stage/clean_up/jungle_a/second_go
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:wave_1/torutoru_land_master jungle_a_second_go
