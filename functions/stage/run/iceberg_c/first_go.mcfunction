...
execute if block -1569 43 -680 minecraft:lime_wool run scoreboard players set @e[x=-1540.5,y=44,z=-660.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1512 43 -680 minecraft:lime_wool run scoreboard players set @e[x=-1540.5,y=44,z=-659.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1560.5,y=44,z=-664.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @e[x=-1570,y=42,z=-685,dx=60,dy=7,dz=74,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=26,Medabot=0..,Battle=1..2}]
