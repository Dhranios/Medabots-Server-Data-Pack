execute unless entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] run bossbar set medabots_server:ruins_out_b/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:ruins_out_b/time value
execute unless entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] store result bossbar medabots_server:ruins_out_b/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:ruins_out_b/robattle value
execute if entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] store result bossbar medabots_server:ruins_out_b/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,scores={Stage=16},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1858,y=0,z=-536,dx=94,dy=50,dz=95,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
