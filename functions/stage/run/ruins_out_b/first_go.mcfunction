...
execute if entity @e[x=-1849.5,y=45,z=-497.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[scores={Stage=16},tag=guard,tag=mission,type=minecraft:area_effect_cloud_entity] run tag @s add mission_success
...
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run scoreboard players set @e[x=-1842.5,y=45,z=-495.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run scoreboard players set @e[x=-1811.5,y=45,z=-474.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run kill @e[x=-1849.5,y=45,z=-497.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run tag @e[scores={Stage=16,Medabot=0..,Battle=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] as @a[scores={Stage=16,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run bossbar set medabots_server:ruins_out_b/robattle players
