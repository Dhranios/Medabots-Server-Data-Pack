...
execute if block -1784 44 -479 minecraft:blue_wool run tag @e[x=-1799.5,y=45,z=-480.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1784 44 -479 minecraft:light_blue_wool unless entity @e[x=-1852.5,y=45,z=-496.5,distance=..0.7,tag=blue_floor_switch_timer,scores={FloorSwitchTime=0..40}] run tag @e[x=-1799.5,y=45,z=-480.5,distance=..0.7,tag=door,tag=open] remove open
