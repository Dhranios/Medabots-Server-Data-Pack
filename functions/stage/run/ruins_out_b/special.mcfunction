...
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:wave_1/story_progression={peace_kiss=true,peace_kiss_defeated=false}}] add dialog_infinity_peace_kiss_defeated
