...
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/wave_1/lagdou_ruins_4_first_go=true}] only medabots_server:stages/wave_1/lagdou_ruins_4_second_go
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/wave_1/lagdou_ruins_4_first_go=false}] only medabots_server:stages/wave_1/lagdou_ruins_4_first_go
...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[scores={Stage=39},type=!minecraft:player] add dead
...
execute as @e[x=-1376,y=38,z=-205,dx=62,dy=9,dz=86,type=!minecraft:player] unless entity @s[scores={Stage=39}] run scoreboard players set @s Stage 39