...
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/lagdou_ruins_4_first_go=true}] only medabots_server:stages/lagdou_ruins_4_second_go
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/lagdou_ruins_4_first_go=false}] only medabots_server:stages/lagdou_ruins_4_first_go
