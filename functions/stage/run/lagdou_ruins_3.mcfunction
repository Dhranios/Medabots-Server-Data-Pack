execute store result score @s BattlingMedabots if entity @e[scores={Stage=89,Medabot=0..,Battle=1..}]
...
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/lagdou_ruins_3_first_go=true}] only medabots_server:stages/lagdou_ruins_3_second_go
advancement grant @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:stages/lagdou_ruins_3_first_go=false}] only medabots_server:stages/lagdou_ruins_3_first_go
...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[scores={Stage=89},type=!minecraft:player] add dead
...
execute as @e[x=-1256,y=0,z=-58,dx=59,dy=48,dz=83,type=!minecraft:player] unless entity @s[scores={Stage=89}] run scoreboard players set @s Stage 89