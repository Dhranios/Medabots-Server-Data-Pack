execute if entity @e[x=-1389,y=36,z=-114,dx=56,dy=14,dz=98,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=45,Medabot=0..,Battle=1..}]
execute if entity @s[scores={BattlingMedabots=2..}] unless entity @e[x=-1389,y=36,z=-114,dx=56,dy=14,dz=98,tag=mr_referee,type=minecraft:armor_stand] run summon minecraft:armor_stand -1356 39 -77 {Invisible:1b,Marker:1b,Small:1b,CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee","not_7","no_overwrite"],Rotation:[90.0f,0.0f]}
