...
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=!minecraft:player] run tag @s[x=-1600.5,y=45,z=-175.5,distance=..0.7,tag=hostile,gamemode=adventure,advancements={medabots_server:wave_1/story_progression={rubberobo_enters_rock_a=true,rubberobo_leaves_rock_a=false}}] add dialog_infinity_rubberobo_leaves_rock_a
