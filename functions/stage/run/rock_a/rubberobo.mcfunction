...
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=minecraft:zombie] run stopsound @s[x=-1601,y=45,z=-175,dy=4,tag=hostile,gamemode=adventure] music
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=minecraft:zombie] run playsound medabots_server:music.stage.stage_end music @s[x=-1601,y=45,z=-175,dy=4,tag=hostile,gamemode=adventure] -1604 51 -149 1000
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=minecraft:zombie] run scoreboard players set @s[x=-1601,y=45,z=-175,dy=4,tag=hostile,gamemode=adventure] Battle 0
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=minecraft:zombie] run scoreboard players set @s[x=-1601,y=45,z=-175,dy=4,tag=hostile,gamemode=adventure] MusicType 1
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=minecraft:zombie] run scoreboard players set @s[x=-1601,y=45,z=-175,dy=4,tag=hostile,gamemode=adventure] Music 299
...
execute unless entity @e[tag=rubberobo,scores={Stage=2},type=minecraft:zombie] run teleport @s[x=-1601,y=45,z=-175,dy=4,tag=hostile,gamemode=adventure] -1604 51 -149 -180 0