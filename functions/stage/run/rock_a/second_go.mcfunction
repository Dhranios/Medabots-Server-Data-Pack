execute if entity @s[scores={Death=1..}] run function medabots_server:stage/clean_up/rock_a/second_go
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/rock_a/second_go
execute if entity @s[scores={Battle=0}] run function medabots_server:other/death
execute unless entity @e[x=-1636,y=43,z=-180,dx=63,dy=7,dz=63,scores={Medabot=0..,Battle=1..2,Stage=2},tag=enemy_medabot] run bossbar set medabots_server:rock_a/time players @s
...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run function medabots_server:stage/clean_up/rock_a/second_go
...
advancement grant @s[scores={BattlingMedabots=1,Death=0}] only medabots_server:stages/wave_1/rock_a_second_go
