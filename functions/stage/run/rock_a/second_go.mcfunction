...
execute if entity @e[x=-1636,y=43,z=-180,dx=63,dy=7,dz=63,tag=mr_referee,type=minecraft:armor_stand] store result score @s BattlingMedabots if entity @e[x=-1612,y=43,z=-136,dx=20,dy=7,dz=18,scores={Stage=6,Medabot=0..}]
execute as @e[x=-1636,y=43,z=-180,dx=63,dy=7,dz=63,type=!minecraft:player] unless entity @s[scores={Stage=5}] run scoreboard players set @s Stage 6
execute unless entity @s[x=-1636,y=43,z=-180,dx=63,dy=7,dz=63,scores={Battle=1..}] run function medabots_server:stage/clean_up/rock_a/second_go
