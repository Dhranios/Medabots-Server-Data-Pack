...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1603 51 -149 14
...
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1603 51 -149 -180 0
