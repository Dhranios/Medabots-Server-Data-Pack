execute if entity @s[scores={Death=1..}] run function medabots_server:stage/clean_up/laboratory_a/first_go
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/laboratory_a/first_go
execute if entity @s[scores={Battle=0}] run function medabots_server:other/death
execute unless entity @e[x=-1812,y=43,z=-322,dx=80,dy=7,dz=72,scores={Medabot=0..,Battle=1..2,Stage=9},tag=enemy_medabot] run bossbar set medabots_server:laboratory_a/time players @s[scores={Death=0,Battle=1..}]
...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1760.5,y=44,z=-270.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1753.5,y=44,z=-276.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1751.5,y=44,z=-261.5,distance=..0.7,tag=door,tag=!open] add open
...
execute if entity @e[x=-1799.5,y=44,z=-261.5,distance=..0.7,tag=mission,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[x=-1808.5,y=44,z=-272,dx=20,dy=7,dz=24,scores={Stage=9,Medabot=0..,Battle=1..}]
title @s[scores={BattlingMedabots=1,Death=0}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1798.5,y=44,z=-271.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1809.5,y=44,z=-290.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run kill @e[x=-1812,y=43,z=-322,dx=80,dy=7,dz=72,tag=mission]
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run bossbar set medabots_server:laboratory_a/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run function medabots_server:stage/clean_up/laboratory_a/first_go
...
advancement grant @s[scores={BattlingMedabots=1,Death=0}] only medabots_server:stages/wave_1/laboratory_a_first_go
