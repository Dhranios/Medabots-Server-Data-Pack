...
execute if entity @e[x=-1752.5,y=44,z=-269.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1761,y=41,z=-276,dx=15,dy=7,dz=15,scores={Stage=9,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1799.5,y=44,z=-261.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1808.5,y=44,z=-270,dx=20,dy=7,dz=20,scores={Stage=9,Medabot=0..,Battle=1..}]
