...
execute if block -1799 45 -272 minecraft:iron_door[open=true] if block -1810 45 -291 minecraft:iron_door[open=false] if entity @s[x=-1801,y=44,z=-272,dx=3,dy=3,dz=3] run function medabots_server:stage/create/laboratory_a/second_go_battle/1
execute if entity @e[x=-1799.5,y=44,z=-261.5,distance=..0.7,tag=mission,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[x=-1808.5,y=44,z=-272,dx=20,dy=7,dz=22,scores={Stage=9,Medabot=0..,Battle=1..}]
title @s[scores={BattlingMedabots=1,Death=0}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
