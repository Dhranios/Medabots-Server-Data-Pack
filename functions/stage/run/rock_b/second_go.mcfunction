...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1603 51 -351 1000
...
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1603 51 -351 -180 0
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run bossbar set medabots_server:rock_b/robattle players
