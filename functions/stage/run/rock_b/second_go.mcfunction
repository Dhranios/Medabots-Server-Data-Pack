...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1594.5,y=45,z=-343.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1582.5,y=45,z=-342.5,distance=..0.7,tag=door,tag=!open] add open
