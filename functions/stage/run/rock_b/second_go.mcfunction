...
execute if entity @e[x=-1614.5,y=45,z=-355.5,distance=..0.7,tag=mission,scores={Dialog=81}] unless entity @e[x=-1570,y=43,z=-414,dx=62,dy=7,dz=95,scores={Stage=11},tag=guard,tag=mission_entity] run tag @s add mission_success
