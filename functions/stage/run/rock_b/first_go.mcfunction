execute unless entity @e[x=-1636,y=43,z=-382,dx=63,dy=7,dz=63,scores={Medabot=0..,Battle=1..2,Stage=11},tag=enemy_medabot] run bossbar set medabots_server:rock_b/time players @s[scores={Battle=1..}]
