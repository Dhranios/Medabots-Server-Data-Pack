execute unless entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] run bossbar set medabots_server:seashore_c/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:seashore_c/time value
execute unless entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] store result bossbar medabots_server:seashore_c/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:seashore_c/robattle value
execute if entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] store result bossbar medabots_server:seashore_c/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,scores={Stage=25},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
