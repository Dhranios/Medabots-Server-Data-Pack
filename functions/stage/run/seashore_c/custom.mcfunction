...
execute as @e[x=-1570,y=42,z=-608,dx=60,dy=7,dz=60,tag=build_stage,limit=1] run data merge entity @s {Item:{tag:{display:{Name:'{"italic":false,"color":"white","translate":"medabots_server:item.custom_stage","with":[{"translate":"medabots_server:location.seashore","with":[{"text":"C"}]}]}'}}}}
