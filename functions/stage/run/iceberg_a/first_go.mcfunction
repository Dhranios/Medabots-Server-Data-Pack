execute unless entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] run bossbar set medabots_server:iceberg_a/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:iceberg_a/time value
execute unless entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] store result bossbar medabots_server:iceberg_a/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:iceberg_a/robattle value
execute if entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] store result bossbar medabots_server:iceberg_a/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,scores={Stage=6},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1764,y=41,z=-247,dx=88,dy=7,dz=63,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
...
execute if block -1737 44 -222 minecraft:iron_door[open=true] run tag @e[x=-1732.5,y=44,z=-220.5,distance=..0.7,tag=action_floor] add enabled
execute if block -1737 44 -222 minecraft:iron_door[open=false] run tag @e[x=-1732.5,y=44,z=-220.5,distance=..0.7,tag=action_floor] remove enabled
execute if block -1737 44 -222 minecraft:iron_door[open=true] run tag @e[x=-1730.5,y=44,z=-224.5,distance=..0.7,tag=action_floor] add enabled
execute if block -1737 44 -222 minecraft:iron_door[open=false] run tag @e[x=-1730.5,y=44,z=-224.5,distance=..0.7,tag=action_floor] remove enabled
execute if block -1737 44 -222 minecraft:iron_door[open=true] run tag @e[x=-1721.5,y=44,z=-218.5,distance=..0.7,tag=action_floor] add enabled
execute if block -1737 44 -222 minecraft:iron_door[open=false] run tag @e[x=-1721.5,y=44,z=-218.5,distance=..0.7,tag=action_floor] remove enabled
...
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:wave_1/story_progression={kuwagata_medal=true,meet_jaxy=false}}] add dialog_infinity_meet_jaxy
