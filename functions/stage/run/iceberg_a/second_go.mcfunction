...
execute if block -1720 44 -224 minecraft:chest run setblock -1720 45 -224 minecraft:barrier
...
execute if block -1746 44 -209 minecraft:chest run setblock -1746 45 -209 minecraft:barrier
execute if block -1750 44 -202 minecraft:chest run setblock -1750 45 -202 minecraft:barrier
execute if block -1755 44 -208 minecraft:chest run setblock -1755 45 -208 minecraft:barrier
...
execute if block -1755 44 -190 minecraft:chest run setblock -1755 45 -190 minecraft:barrier
execute if block -1754 44 -191 minecraft:chest run setblock -1754 45 -191 minecraft:barrier
execute if block -1754 44 -190 minecraft:chest run setblock -1754 45 -190 minecraft:barrier
...
execute if block -1728 44 -196 minecraft:chest run setblock -1728 45 -196 minecraft:barrier
...
execute if block -1681 44 -194 minecraft:chest run setblock -1681 45 -194 minecraft:barrier
...
execute if block -1680 44 -193 minecraft:chest run setblock -1680 45 -193 minecraft:barrier
execute if block -1680 44 -188 minecraft:chest run setblock -1680 45 -188 minecraft:barrier
execute if block -1734 44 -230 minecraft:chest run setblock -1734 45 -230 minecraft:barrier
execute if block -1735 44 -229 minecraft:chest run setblock -1735 45 -229 minecraft:barrier
execute if block -1732 44 -229 minecraft:chest run setblock -1732 45 -229 minecraft:barrier
...
execute if block -1720 44 -224 minecraft:air if block -1720 45 -224 minecraft:barrier run summon minecraft:tnt -1720 44 -224 {CustomName:"{\"translate\":\"medabots_server:entity.bomb\"}",Fuse:100s,Tags:["bomb","hostile","killerable"]}
execute if block -1720 44 -224 minecraft:air run setblock -1720 45 -224 minecraft:air
...
execute if block -1746 44 -209 minecraft:air run setblock -1746 45 -209 minecraft:air
execute if block -1750 44 -202 minecraft:air if block -1750 45 -202 minecraft:barrier run summon minecraft:tnt -1750 44 -202 {CustomName:"{\"translate\":\"medabots_server:entity.bomb\"}",Fuse:100s,Tags:["bomb","hostile","killerable"]}
execute if block -1750 44 -202 minecraft:air run setblock -1750 45 -202 minecraft:air
execute if block -1755 44 -208 minecraft:air run setblock -1755 45 -208 minecraft:air
...
execute if block -1755 44 -190 minecraft:air run setblock -1755 45 -190 minecraft:air
execute if block -1754 44 -191 minecraft:air run setblock -1754 45 -191 minecraft:air
execute if block -1754 44 -190 minecraft:air run setblock -1754 45 -190 minecraft:air
...
execute if block -1728 44 -196 minecraft:air run setblock -1728 45 -196 minecraft:air
...
execute if block -1681 44 -194 minecraft:air run setblock -1681 45 -194 minecraft:air
...
execute if block -1732 44 -229 minecraft:air run setblock -1732 45 -229 minecraft:air
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:stages/iceberg_a_second_go
