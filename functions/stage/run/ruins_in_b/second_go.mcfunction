...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1}] -1620 50 -526 14
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:stages/wave_1/ruins_in_b_second_go
teleport @s[scores={BattlingMedabots=1}] -1620 50 -526 -180 0
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:ruins_in_b/robattle players
