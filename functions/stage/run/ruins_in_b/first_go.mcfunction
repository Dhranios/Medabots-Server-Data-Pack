...
execute if block -1603 43 -544 minecraft:light_blue_wool run scoreboard players set @e[x=-1602.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,scores={PowerAmount=0}] PowerAmount 1
execute if block -1603 43 -544 minecraft:blue_wool run scoreboard players set @e[x=-1602.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,scores={PowerAmount=1}] PowerAmount 0
execute if block -1601 43 -544 minecraft:light_blue_wool run scoreboard players set @e[x=-1600.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,scores={PowerAmount=0}] PowerAmount 1
execute if block -1601 43 -544 minecraft:blue_wool run scoreboard players set @e[x=-1600.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,scores={PowerAmount=1}] PowerAmount 0
