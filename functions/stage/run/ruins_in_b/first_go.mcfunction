...
execute if block -1600 43 -505 minecraft:blue_wool run tag @e[x=-1578.5,y=44,z=-506.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1600 43 -505 minecraft:light_blue_wool run tag @e[x=-1578.5,y=44,z=-506.5,distance=..0.7,tag=door,tag=open] remove open
execute if block -1600 43 -535 minecraft:blue_wool run tag @e[x=-1588.5,y=44,z=-506.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1600 43 -535 minecraft:light_blue_wool run tag @e[x=-1588.5,y=44,z=-506.5,distance=..0.7,tag=door,tag=open] remove open
execute if block -1588 43 -540 minecraft:lime_wool run tag @e[x=-1620.5,y=44,z=-531.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1602 43 -571 minecraft:lime_wool run tag @e[x=-1595.5,y=44,z=-565.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1591 43 -562 minecraft:lime_wool run tag @e[x=-1595.5,y=44,z=-565.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1588 43 -562 minecraft:lime_wool run tag @e[x=-1595.5,y=44,z=-565.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1591 43 -571 minecraft:lime_wool run tag @e[x=-1595.5,y=44,z=-565.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1588 43 -571 minecraft:lime_wool run tag @e[x=-1595.5,y=44,z=-565.5,distance=..0.7,tag=door,tag=!open] add open
...
execute if block -1600 43 -505 minecraft:blue_wool run tag @e[x=-1606.5,y=44,z=-488.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1600 43 -505 minecraft:light_blue_wool run tag @e[x=-1606.5,y=44,z=-488.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1600 43 -505 minecraft:blue_wool run tag @e[x=-1599.5,y=44,z=-488.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1600 43 -505 minecraft:light_blue_wool run tag @e[x=-1599.5,y=44,z=-488.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1600 43 -535 minecraft:blue_wool run tag @e[x=-1606.5,y=44,z=-492.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1600 43 -535 minecraft:light_blue_wool run tag @e[x=-1606.5,y=44,z=-492.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1600 43 -535 minecraft:blue_wool run tag @e[x=-1599.5,y=44,z=-492.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1600 43 -535 minecraft:light_blue_wool run tag @e[x=-1599.5,y=44,z=-492.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1588 43 -540 minecraft:lime_wool run tag @e[x=-1587.5,y=44,z=-528.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1603 43 -544 minecraft:light_blue_wool run tag @e[x=-1602.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1603 43 -544 minecraft:blue_wool run tag @e[x=-1602.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1601 43 -544 minecraft:light_blue_wool run tag @e[x=-1600.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1601 43 -544 minecraft:blue_wool run tag @e[x=-1600.5,y=44,z=-544.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
