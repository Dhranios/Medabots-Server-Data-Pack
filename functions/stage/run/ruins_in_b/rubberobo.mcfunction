...
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:wave_1/story_progression={rubberobo_enters_ruins_in_b=true,rubberobo_leaves_ruins_in_b=false}}] add dialog_infinity_rubberobo_leaves_ruins_in_b
