...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1345 51 -127 1000
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1345 51 -127 -180 0
