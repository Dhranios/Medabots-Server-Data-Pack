...
execute if entity @s[scores={BattlingMedabots=2..}] unless entity @e[x=-1376,y=39,z=-205,dx=62,dy=10,dz=86,tag=mr_referee,type=minecraft:armor_stand] run summon minecraft:armor_stand -1351 45 -159 {Invisible:1b,Marker:1b,Small:1b,CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee","not_7","no_overwrite"],Rotation:[90.0f,0.0f]}
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/lagdou_ruins_4/darkness
