...
execute if entity @s[scores={BattlingMedabots=2..}] unless entity @e[x=-1329,y=39,z=-58,dx=68,dy=11,dz=53,tag=mr_referee,type=minecraft:armor_stand] run summon minecraft:armor_stand -1289 46 -28 {Invisible:1b,Marker:1b,Small:1b,CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee","no_overwrite"],Rotation:[-90.0f,0.0f]}
...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1295 51 -32 1000
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1295 51 -32 -180 0
