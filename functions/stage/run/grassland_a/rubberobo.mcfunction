...
execute if block -1541 44 -152 minecraft:lime_wool run scoreboard players set @e[x=-1534.5,y=45,z=-157.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1530 44 -152 minecraft:lime_wool run scoreboard players set @e[x=-1523.5,y=45,z=-159.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1520 44 -174 minecraft:lime_wool run scoreboard players set @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1532 44 -174 minecraft:yellow_wool run scoreboard players set @e[x=-1546.5,y=45,z=-171.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1532 44 -174 minecraft:orange_wool run scoreboard players set @e[x=-1546.5,y=45,z=-171.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
execute if block -1537 44 -169 minecraft:yellow_wool run scoreboard players set @e[x=-1547.5,y=45,z=-171.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1537 44 -169 minecraft:orange_wool run scoreboard players set @e[x=-1547.5,y=45,z=-171.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
execute if block -1542 44 -174 minecraft:yellow_wool run scoreboard players set @e[x=-1548.5,y=45,z=-171.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1542 44 -174 minecraft:orange_wool run scoreboard players set @e[x=-1548.5,y=45,z=-171.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
