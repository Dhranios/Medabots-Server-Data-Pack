...
execute if block -1527 44 -171 minecraft:light_blue_wool run scoreboard players set @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1527 44 -171 minecraft:blue_wool run scoreboard players set @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
