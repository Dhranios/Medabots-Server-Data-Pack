...
execute if block -1527 44 -171 minecraft:light_blue_wool run tag @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1527 44 -171 minecraft:blue_wool run tag @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,tag=open] remove open
...
execute if entity @s[x=-1551,y=45,z=-171,dy=4,tag=hostile,gamemode=adventure] run function medabots_server:stage/clean_up/grassland_a/first_go
stopsound @s[x=-1551,y=45,z=-171,dy=4,tag=hostile,gamemode=adventure] music
playsound medabots_server:music.stage.stage_end music @s[x=-1551,y=45,z=-171,dy=4,tag=hostile,gamemode=adventure] -1539 51 -151 14
...
advancement grant @s[x=-1551,y=45,z=-171,dy=4,tag=hostile,gamemode=adventure] only medabots_server:stages/wave_1/grassland_a_first_go
tag @s[x=-1551,y=45,z=-171,dy=4,tag=hostile,gamemode=adventure,advancements={medabots_server:wave_1/story_progression={meet_karin=true,meet_max=false}}] add dialog_infinity_meet_max
