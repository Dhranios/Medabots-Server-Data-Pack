...
execute if block -1541 44 -152 minecraft:lime_wool run tag @e[x=-1535.5,y=45,z=-157.5,distance=..0.7,tag=door,tag=!open] add open
...
execute if block -1519 44 -173 minecraft:yellow_wool run tag @e[x=-1526.5,y=45,z=-170.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1519 44 -173 minecraft:orange_wool run tag @e[x=-1527.5,y=45,z=-170.5,distance=..0.7,tag=door,tag=open] remove open
execute if block -1534 44 -168 minecraft:lime_wool if block -1536 44 -177 minecraft:lime_wool if block -1542 44 -167 minecraft:lime_wool if block -1542 44 -176 minecraft:lime_wool run tag @e[x=-1546.5,y=45,z=-171.5,distance=..0.7,tag=door,tag=!open] add open
