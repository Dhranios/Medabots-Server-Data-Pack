...
execute if entity @e[x=-1570,y=43,z=-180,dx=63,dy=7,dz=63,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=1,Medabot=0..,Battle=1..2}]
