...
execute unless entity @e[scores={Stage=1},tag=rubberobo] run playsound medabots_server:music.stage.stage_end music @s[x=-1516,y=45,z=-174,dy=4,tag=hostile,gamemode=adventure] -1539 51 -151 1000
