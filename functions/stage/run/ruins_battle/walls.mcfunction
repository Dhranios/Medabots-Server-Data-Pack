...
tag @s[scores={BattlingMedabots=1},tag=story_battle,advancements={medabots_server:wave_1/story_progression={vs_squidguts=true,vs_squidguts_battle=false}}] add dialog_infinity_vs_squidguts_battle
