...
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={motivated_fight=true,motivated_fight_battle=false}}] add dialog_infinity_motivated_fight_battle
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={vs_screws=true,vs_screws_battle=false}}] add dialog_infinity_vs_screws_battle
