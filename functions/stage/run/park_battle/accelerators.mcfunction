...
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={shrimplips_jammy=true,shrimplips_jammy_battle=false}}] add dialog_infinity_shrimplips_jammy_battle
