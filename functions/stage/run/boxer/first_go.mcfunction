...
execute if entity @e[x=-1871.5,y=44,z=-553.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1880,y=42,z=-562,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1879 45 -562 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1879 44 -562 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1879 44 -562 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1879 44 -562 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
...
execute if entity @e[x=-1862.5,y=44,z=-571.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1876,y=42,z=-579,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1876 45 -571 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1876 44 -571 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1876 44 -571 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1876 44 -571 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1876 44 -571 minecraft:structure_block run setblock -1876 45 -571 minecraft:redstone_block
...
execute if entity @e[x=-1871.5,y=44,z=-588.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1880,y=42,z=-596,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1880 45 -582 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1880 44 -582 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1880 44 -582 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1880 44 -582 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1880 44 -582 minecraft:structure_block run setblock -1880 45 -582 minecraft:redstone_block
...
execute if entity @e[x=-1888.5,y=44,z=-594.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1897,y=42,z=-603,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1889 45 -585 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1889 44 -585 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1889 44 -585 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1889 44 -585 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1889 44 -585 minecraft:structure_block run setblock -1889 45 -585 minecraft:redstone_block
...
execute if entity @e[x=-1906.5,y=44,z=-588.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1880,y=42,z=-562,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1900 45 -581 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1900 44 -581 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1900 44 -581 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1900 44 -581 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1900 44 -581 minecraft:structure_block run setblock -1900 45 -581 minecraft:redstone_block
...
execute if entity @e[x=-1915.5,y=44,z=-570.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1920,y=42,z=-579,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1903 45 -572 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1903 44 -572 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1903 44 -572 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1903 44 -572 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1903 44 -572 minecraft:structure_block run setblock -1903 45 -572 minecraft:redstone_block
...
execute if entity @e[x=-1906.5,y=44,z=-553.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud] store result score @s BattlingMedabots if entity @e[x=-1914,y=42,z=-562,dx=15,dy=7,dz=15,scores={Stage=79,Medabot=0..,Battle=1..}]
...
execute if block -1899 45 -561 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1899 44 -561 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1899 44 -561 minecraft:structure_block if entity @s[scores={BattlingMedabots=1}] run setblock -1899 44 -561 minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1899 44 -561 minecraft:structure_block run setblock -1899 45 -561 minecraft:redstone_block
execute if block -1891 45 -558 minecraft:iron_door[open=true] if entity @s[scores={BattlingMedabots=1}] run setblock -1891 44 -558 minecraft:structure_block[mode=load]{name:"medabots_server:stage/door",mode:"LOAD"}
...
execute if block -1891 44 -558 minecraft:structure_block run setblock -1891 45 -558 minecraft:redstone_block
execute if entity @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=mr_referee] store result score @s BattlingMedabots if entity @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,scores={Stage=79,Medabot=0..,Battle=1..}]
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:stages/boxer_first_go
