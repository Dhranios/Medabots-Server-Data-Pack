...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1878.5,y=44,z=-561.5,distance=..0.7,tag=door,tag=!open] add open
...
title @s[scores={BattlingMedabots=1}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1898.5,y=44,z=-560.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[x=-1890.5,y=44,z=-557.5,distance=..0.7,tag=door,tag=open] remove open
execute if entity @s[scores={BattlingMedabots=1}] run kill @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=mission]
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:boxer/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1899 45 -561 minecraft:iron_door[open=true] if block -1891 45 -558 minecraft:iron_door[open=false] unless entity @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=mr_referee] if entity @s[x=-1899,y=44,z=-562,dx=3,dy=3,dz=3] run function medabots_server:stage/create/boxer/first_go_battle/7
