...
execute if entity @e[x=-1905.5,y=44,z=-554.5,distance=..0.7,tag=press_wall_timer,scores={Time=0}] run tag @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=press_wall] remove retract
execute if entity @e[x=-1905.5,y=44,z=-554.5,distance=..0.7,tag=press_wall_timer,scores={Time=80}] run tag @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=press_wall] remove extend
execute if entity @e[x=-1905.5,y=44,z=-554.5,distance=..0.7,tag=press_wall_timer,scores={Time=80}] run tag @e[x=-1921,y=42,z=-603,dx=64,dy=7,dz=64,tag=press_wall] add retract
...
execute if entity @e[x=-1871.5,y=44,z=-553.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1880,y=42,z=-562,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1862.5,y=44,z=-571.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1876,y=42,z=-579,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1871.5,y=44,z=-588.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1880,y=42,z=-596,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1888.5,y=44,z=-594.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1897,y=42,z=-603,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1906.5,y=44,z=-588.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1880,y=42,z=-562,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1915.5,y=44,z=-570.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1920,y=42,z=-579,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
...
execute if entity @e[x=-1906.5,y=44,z=-553.5,distance=..0.7,tag=mission,scores={Time=81}] store result score @s BattlingMedabots if entity @e[x=-1914,y=42,z=-562,dx=15,dy=7,dz=15,scores={Stage=80,Medabot=0..,Battle=1..}]
