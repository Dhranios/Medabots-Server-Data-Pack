...
execute if entity @s[tag=mission_success] as @a[x=-1854,y=0,z=-633,dx=91,dy=49,dz=94,scores={Stage=19,Medabot=0..,Battle=1..},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
