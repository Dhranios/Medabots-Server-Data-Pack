...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Battle=1..}] -1809 51 -587 1000
...
teleport @s[scores={BattlingMedabots=1,Battle=1..}] -1809 51 -587 -180 0
