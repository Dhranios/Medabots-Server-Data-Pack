...
execute if block -1785 44 -585 minecraft:green_wool if block -1800 44 -568 minecraft:orange_wool run scoreboard players set @e[x=-1785.5,y=45,z=-582.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
execute if block -1800 44 -568 minecraft:yellow_wool run scoreboard players set @e[x=-1785.5,y=45,z=-582.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1785 44 -585 minecraft:lime_wool run scoreboard players set @e[x=-1785.5,y=45,z=-582.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1778 44 -610 minecraft:lime_wool run scoreboard players set @e[x=-1777.5,y=45,z=-585.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1775 44 -583 minecraft:lime_wool run scoreboard players set @e[x=-1774.5,y=45,z=-583.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1775 44 -583 minecraft:lime_wool run scoreboard players set @e[x=-1790.5,y=45,z=-584.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1800 44 -568 minecraft:orange_wool run scoreboard players set @e[x=-1795.5,y=45,z=-567.5,distance=..0.7,tag=press_wall,scores={PowerAmount=1}] PowerAmount 0
execute if block -1800 44 -568 minecraft:yellow_wool run scoreboard players set @e[x=-1795.5,y=45,z=-567.5,distance=..0.7,tag=press_wall,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/park_a/second_go
advancement grant @s[scores={BattlingMedabots=1,Battle=1..}] only medabots_server:stages/wave_1/park_a_second_go
