...
execute if entity @e[scores={Stage=55},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-2003,y=42,z=-329,dx=93,dy=7,dz=78,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
