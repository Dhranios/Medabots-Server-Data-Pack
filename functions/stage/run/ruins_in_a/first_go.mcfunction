execute unless entity @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,scores={Stage=8},tag=hide_normal_time] run bossbar set medabots_server:ruins_in_a/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,scores={Stage=8},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:ruins_in_a/time value
execute unless entity @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,scores={Stage=8},tag=hide_normal_time] store result bossbar medabots_server:ruins_in_a/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,scores={Stage=8},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:ruins_in_a/robattle value
execute if entity @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,scores={Stage=8},tag=hide_normal_time] store result bossbar medabots_server:ruins_in_a/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,scores={Stage=8},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1729,y=43,z=-344,dx=90,dy=7,dz=92,tag=mission] at @s run function medabots_server:stage/mission_time_up
...
execute if block -1661 43 -311 minecraft:orange_wool run tag @e[x=-1660.5,y=44,z=-305.5,distance=..0.7,tag=door,tag=open] remove open
...
execute if block -1711 43 -254 minecraft:lime_wool run tag @e[x=-1706.5,y=44,z=-253.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1711 43 -254 minecraft:green_wool if block -1702 43 -264 minecraft:orange_wool run tag @e[x=-1706.5,y=44,z=-253.5,distance=..0.7,tag=door,tag=open] remove open
...
execute if block -1726 43 -255 minecraft:lime_wool run tag @e[x=-1715.5,y=44,z=-253.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1726 43 -255 minecraft:green_wool if block -1702 43 -260 minecraft:orange_wool run tag @e[x=-1715.5,y=44,z=-253.5,distance=..0.7,tag=door,tag=open] remove open
...
execute if block -1683 44 -274 minecraft:iron_door[open=true] run tag @e[x=-1716.5,y=44,z=-298.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1683 44 -274 minecraft:iron_door[open=false] if block -1716 43 -297 minecraft:orange_wool run tag @e[x=-1716.5,y=44,z=-298.5,distance=..0.7,tag=door,tag=open] remove open
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1682.5,y=44,z=-274.5,distance=..0.7,tag=door,tag=!open] add open
...
title @s[scores={BattlingMedabots=1,Battle=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1716.5,y=44,z=-319.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1682.5,y=44,z=-273.5,distance=..0.7,tag=door,tag=!open] add open
...
execute if entity @s[x=-1682,y=44,z=-276,dy=4,tag=hostile,gamemode=adventure] positioned -1683 50 -259 run function medabots_server:stage/clear