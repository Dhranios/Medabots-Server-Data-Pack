...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1650.5,y=44,z=-325.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1682.5,y=44,z=-274.5,distance=..0.7,tag=door,tag=!open] add open
...
title @s[scores={BattlingMedabots=1,Death=0}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1716.5,y=44,z=-319.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1682.5,y=44,z=-273.5,distance=..0.7,tag=door,tag=!open] add open
