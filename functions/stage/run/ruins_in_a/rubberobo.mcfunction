...
execute if block -1650 43 -269 minecraft:lime_wool run tag @e[x=-1657,y=44,z=-284,dx=15,dy=3,dz=11,type=minecraft:area_effect_cloud,tag=press_wall,type=minecraft:area_effect_cloud] add enabled
execute if block -1651 43 -286 minecraft:yellow_wool run tag @e[x=-1657,y=44,z=-284,dx=15,dy=3,dz=11,type=minecraft:area_effect_cloud,tag=press_wall,type=minecraft:area_effect_cloud] add enabled
execute if block -1651 43 -286 minecraft:orange_wool if block -1650 43 -269 minecraft:green_wool run tag @e[x=-1657,y=44,z=-284,dx=15,dy=3,dz=11,type=minecraft:area_effect_cloud,tag=press_wall,type=minecraft:area_effect_cloud] remove enabled
...
execute if entity @s[tag=clear_stage] run function medabots_server:stage/clean_up/ruins_in_a/rubberobo
