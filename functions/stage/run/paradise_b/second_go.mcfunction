execute unless entity @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,scores={Stage=22},tag=hide_normal_time] run bossbar set medabots_server:paradise_b/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,scores={Stage=22},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:paradise_b/time value
execute unless entity @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,scores={Stage=22},tag=hide_normal_time] store result bossbar medabots_server:paradise_b/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,scores={Stage=22},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:paradise_b/robattle value
execute if entity @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,scores={Stage=22},tag=hide_normal_time] store result bossbar medabots_server:paradise_b/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,scores={Stage=22},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1665,y=42,z=-637,dx=64,dy=7,dz=63,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] positioned -1634 51 -606 run function medabots_server:stage/clear
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots