...
execute if block -1646 44 -632 minecraft:lime_wool run scoreboard players set @e[x=-1644.5,y=45,z=-628.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if block -1643 44 -623 minecraft:lime_wool run scoreboard players set @e[x=-1647.5,y=45,z=-612.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1609.5,y=45,z=-590.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission,type=minecraft:area_effect_cloud_entity,scores={Stage=22}] run tag @s remove run_until_the_time_is_up
...
execute if entity @e[x=-1609.5,y=45,z=-590.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1617.5,y=45,z=-588.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1657.5,y=45,z=-582.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission,type=minecraft:area_effect_cloud_entity,scores={Stage=22}] run tag @s remove run_until_the_time_is_up
...
execute if entity @e[x=-1657.5,y=45,z=-582.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1655.5,y=45,z=-588.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1651.5,y=45,z=-601.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission,type=minecraft:area_effect_cloud_entity,scores={Stage=22}] run tag @s remove run_until_the_time_is_up
...
execute if entity @e[x=-1651.5,y=45,z=-601.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1649.5,y=45,z=-599.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] as @e[x=-1640.5,y=45,z=-608.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[tag=mission,type=minecraft:area_effect_cloud_entity,scores={Stage=22}] run tag @s remove run_until_the_time_is_up
...
execute if entity @e[x=-1640.5,y=45,z=-608.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,tag=!run_until_the_time_is_up] run scoreboard players set @e[x=-1643.5,y=45,z=-606.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
