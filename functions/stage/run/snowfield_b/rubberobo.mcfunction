...
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:wave_1/story_progression={rubberobo_enters_snowfield_b=true,rubberobo_leaves_snowfield_b=false}}] add dialog_infinity_rubberobo_leaves_snowfield_b
