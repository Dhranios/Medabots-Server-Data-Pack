...
execute if block -1731 44 -514 minecraft:lime_wool run scoreboard players set @e[x=-1727.5,y=45,z=-512.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
