execute store result score @s BattlingMedabots if entity @e[scores={Stage=88,Medabot=0..}]
...
scoreboard players add @s[scores={BattlingMedabots=1,Death=0,LagdouKill=2..3}] LagdouKill 1
