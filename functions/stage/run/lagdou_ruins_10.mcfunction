...
execute if entity @s[scores={BattlingMedabots=1}] run tag @e[scores={Stage=96},type=!minecraft:player] add dead
...
execute as @e[x=-1389,y=36,z=-114,dx=56,dy=13,dz=98,type=!minecraft:player] unless entity @s[scores={Stage=96}] run scoreboard players set @s Stage 96