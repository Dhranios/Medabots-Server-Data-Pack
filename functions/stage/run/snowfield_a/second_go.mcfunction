...
execute if block -1649 44 -227 minecraft:lime_wool if block -1632 44 -225 minecraft:lime_wool if block -1627 44 -232 minecraft:lime_wool if block -1643 44 -236 minecraft:lime_wool run scoreboard players set @e[x=-1660.5,y=45,z=-242,dx=6,dy=1,dz=19,tag=laser_trap,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=clear_stage] run function medabots_server:stage/clean_up/snowfield_a/second_go
