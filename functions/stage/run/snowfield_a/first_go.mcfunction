...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1622.5,y=45,z=-202.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1629.5,y=45,z=-200.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run tag @e[x=-1636.5,y=45,z=-209.5,distance=..0.7,tag=door,tag=!open] add open
