...
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] run title @s[scores={BattlingMedabots=1}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] if block -1623 46 -203 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1623 45 -203 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] if block -1630 46 -201 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1}] run setblock -1630 45 -201 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
