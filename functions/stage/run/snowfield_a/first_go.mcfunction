execute unless entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Medabot=0..,Battle=1..2,Stage=5},tag=enemy_medabot] run bossbar set medabots_server:snowfield_a/time players @s[scores={Battle=1..}]
