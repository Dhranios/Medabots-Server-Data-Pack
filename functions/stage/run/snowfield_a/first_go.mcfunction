...
execute if entity @e[scores={Stage=5},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @e[scores={Stage=5},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
...
execute if block -1594 44 -218 minecraft:orange_wool run scoreboard players set @e[x=-1589.5,y=45,z=-206.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1632 44 -225 minecraft:lime_wool if block -1627 44 -232 minecraft:lime_wool if block -1643 44 -236 minecraft:lime_wool if block -1649 44 -227 minecraft:lime_wool run scoreboard players set @e[x=-1650.5,y=45,z=-229.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if block -1617 44 -226 minecraft:light_blue_wool run scoreboard players set @e[x=-1617.5,y=45,z=-225.5,distance=..0.7,tag=laser_trap,scores={PowerAmount=0}] PowerAmount 1
execute if block -1617 44 -226 minecraft:blue_wool run scoreboard players set @e[x=-1617.5,y=45,z=-225.5,distance=..0.7,tag=laser_trap,scores={PowerAmount=1}] PowerAmount 0
execute if block -1663 44 -187 minecraft:light_blue_wool run scoreboard players set @e[x=-1656.5,y=45,z=-210.5,distance=..0.7,tag=spring_wall,scores={PowerAmount=0}] PowerAmount 1
execute if block -1663 44 -187 minecraft:blue_wool run scoreboard players set @e[x=-1656.5,y=45,z=-210.5,distance=..0.7,tag=spring_wall,scores={PowerAmount=1}] PowerAmount 0
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1622.5,y=45,z=-202.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1629.5,y=45,z=-200.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1636.5,y=45,z=-209.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run kill @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mission]
...
execute if entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=5,Medabot=0..,Battle=1..2}]
