execute if entity @s[scores={Death=1..}] run function medabots_server:stage/clean_up/snowfield_a/first_go
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/snowfield_a/first_go
execute if entity @s[scores={Battle=0}] run function medabots_server:other/death
execute unless entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Medabot=0..,Battle=1..2,Stage=5},tag=enemy_medabot] run bossbar set medabots_server:snowfield_a/time players @s
...
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] run title @s[scores={BattlingMedabots=1,Death=0}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] if block -1623 46 -203 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1,Death=0}] run setblock -1623 45 -203 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] if block -1630 46 -201 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1,Death=0}] run setblock -1630 45 -201 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if entity @e[x=-1628.5,y=45,z=-206.5,distance=..0.7,tag=mission,scores={Dialog=81}] if block -1637 46 -210 minecraft:iron_door[open=false] if entity @s[scores={BattlingMedabots=1,Death=0}] run setblock -1637 45 -210 minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run kill @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mission]
...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run bossbar set medabots_server:snowfield_a/robattle players
tag @s[scores={BattlingMedabots=1,Death=0},advancements={medabots_server:wave_1/story_progression={vs_spyke_battle=true,kuwagata_medal=false}}] add dialog_infinity_kuwagata_medal
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
