execute unless entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] run bossbar set medabots_server:snowfield_a/time players @s[scores={Battle=1..}]
execute unless entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:snowfield_a/time value
execute unless entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] store result bossbar medabots_server:snowfield_a/time value run scoreboard players operation #temp Time += #1 Constants
execute if entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] store result score #temp Time run bossbar get medabots_server:snowfield_a/robattle value
execute if entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] store result bossbar medabots_server:snowfield_a/robattle value if score #temp Time matches 1.. run scoreboard players operation #temp Time -= #1 Constants
execute if entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mission] at @s run function medabots_server:stage/mission_time_up
execute if entity @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,scores={Stage=5},tag=hide_normal_time] if score #temp Time matches 0 as @e[x=-1668,y=42,z=-247,dx=105,dy=7,dz=63,tag=mr_referee] at @s run function medabots_server:stage/referee_decides
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1622.5,y=45,z=-202.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1629.5,y=45,z=-200.5,distance=..0.7,tag=door,tag=!open] add open
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run tag @e[x=-1636.5,y=45,z=-209.5,distance=..0.7,tag=door,tag=!open] add open
