...
execute if block -1613 44 -203 minecraft:light_blue_wool run scoreboard players add @e[x=-1611.5,y=45,z=-202.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=fan,type=minecraft:area_effect_cloud,tag=!changed] Moving 1
execute if block -1613 44 -203 minecraft:light_blue_wool run tag @e[x=-1611.5,y=45,z=-202.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=fan,type=minecraft:area_effect_cloud,tag=!changed] add changed
execute if block -1613 44 -203 minecraft:blue_wool run scoreboard players remove @e[x=-1611.5,y=45,z=-202.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=fan,type=minecraft:area_effect_cloud,tag=changed] Moving 1
execute if block -1613 44 -203 minecraft:blue_wool run tag @e[x=-1611.5,y=45,z=-202.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=fan,type=minecraft:area_effect_cloud,tag=changed] remove changed
execute if block -1617 44 -226 minecraft:light_blue_wool run tag @e[x=-1617.5,y=45,z=-225.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=laser_trap,type=minecraft:area_effect_cloud] add enabled
execute if block -1617 44 -226 minecraft:blue_wool run tag @e[x=-1617.5,y=45,z=-225.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=laser_trap,type=minecraft:area_effect_cloud] remove enabled
execute if block -1663 44 -187 minecraft:light_blue_wool run tag @e[x=-1656.5,y=45,z=-210.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=spring_wall,type=minecraft:area_effect_cloud] add enabled
execute if block -1663 44 -187 minecraft:blue_wool run tag @e[x=-1656.5,y=45,z=-210.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=spring_wall,type=minecraft:area_effect_cloud] remove enabled
execute if block -1649 44 -227 minecraft:lime_wool if block -1632 44 -225 minecraft:lime_wool if block -1627 44 -232 minecraft:lime_wool if block -1643 44 -236 minecraft:lime_wool run tag @e[x=-1660.5,y=45,z=-242,dx=6,dy=1,dz=19,type=minecraft:area_effect_cloud,tag=laser_trap,type=minecraft:area_effect_cloud] add enabled
