...
execute unless entity @e[tag=rubberobo,scores={Stage=16}] run advancement grant @s[x=-1659.5,y=45,z=-233.5,distance=..0.7,tag=hostile,gamemode=adventure] only medabots_server:stages/snowfield_a_rubberobo
