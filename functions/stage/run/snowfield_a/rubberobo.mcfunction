...
execute unless entity @e[tag=rubberobo,scores={Stage=5}] if entity @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] run function medabots_server:stage/clean_up/snowfield_a/rubberobo
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run stopsound @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] music
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run playsound medabots_server:music.stage.stage_end music @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] -1620 51 -216 14
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run scoreboard players set @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] Battle 0
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run scoreboard players set @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] MusicType 1
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run scoreboard players set @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] Music 299
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run advancement grant @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] only medabots_server:stages/wave_1/snowfield_a_rubberobo
execute unless entity @e[tag=rubberobo,scores={Stage=5}] run teleport @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] -1620 51 -216 -180 0