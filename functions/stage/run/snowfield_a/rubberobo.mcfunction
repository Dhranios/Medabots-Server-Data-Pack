...
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] if entity @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] run function medabots_server:stage/clean_up/snowfield_a/rubberobo
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run stopsound @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] music
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run playsound medabots_server:music.stage.stage_end music @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] -1620 51 -216 1000
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run scoreboard players set @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] Battle 0
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run scoreboard players set @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] MusicType 1
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run scoreboard players set @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] Music 299
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run advancement grant @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] only medabots_server:stages/wave_1/snowfield_a_rubberobo
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run tag @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure,advancements={medabots_server:wave_1/story_progression={rubberobo_enters_snowfield_a=true,rubberobo_leaves_snowfield_a=false}}] add dialog_infinity_rubberobo_leaves_snowfield_a
execute unless entity @e[tag=rubberobo,scores={Stage=5},type=minecraft:zombie] run teleport @s[x=-1660,y=45,z=-234,dy=4,tag=hostile,gamemode=adventure] -1620 51 -216 -180 0