...
execute if block -1984 44 -623 minecraft:lime_wool run tag @e[x=-1982.5,y=45,z=-624.5,distance=..0.7,tag=spring_wall,tag=!enabled] add enabled
execute if block -1984 44 -623 minecraft:lime_wool run tag @e[x=-1981.5,y=45,z=-623.5,distance=..0.7,tag=spring_wall,tag=!enabled] add enabled
execute if block -1984 44 -623 minecraft:lime_wool run tag @e[x=-1981.5,y=45,z=-592.5,distance=..0.7,tag=spring_wall,tag=!enabled] add enabled
