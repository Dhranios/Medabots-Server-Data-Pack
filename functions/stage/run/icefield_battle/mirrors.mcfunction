...
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={vs_gillgirl=true,vs_gillgirl_battle=false}}] add dialog_infinity_vs_gillgirl_battle
