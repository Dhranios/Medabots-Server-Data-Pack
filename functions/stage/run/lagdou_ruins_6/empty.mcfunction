execute if entity @e[x=-1267,y=42,z=-139,dx=60,dy=7,dz=77,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=41,Medabot=0..,Battle=1..}]
