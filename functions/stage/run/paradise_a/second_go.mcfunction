...
execute if block -1689 44 -641 minecraft:lime_wool run scoreboard players set @e[x=-1697.5,y=45,z=-712.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1728 44 -642 minecraft:lime_wool run scoreboard players set @e[x=-1729.5,y=45,z=-711.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if block -1697 44 -728 minecraft:lime_wool if block -1734 44 -715 minecraft:lime_wool run scoreboard players set @e[x=-1713.5,y=45,z=-705.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1682.5,y=45,z=-693.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1688.5,y=45,z=-644.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1691.5,y=45,z=-707.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mission]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,Battle=1..},type=!minecraft:player] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1708.5,y=45,z=-711.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mission]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,Battle=1..},type=!minecraft:player] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1739.5,y=45,z=-707.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mission]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,Battle=1..},type=!minecraft:player] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1713.5,y=45,z=-704.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1739.5,y=45,z=-681.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1742.5,y=45,z=-662.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mission]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,Battle=1..},type=!minecraft:player] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
...
execute if entity @s[tag=mission_success] run title @s title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1741.5,y=45,z=-661.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run scoreboard players set @e[x=-1724.5,y=45,z=-648.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission_success] run kill @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mission]
execute if entity @s[tag=mission_success] run tag @e[scores={Stage=21,Medabot=0..,Battle=1..},type=!minecraft:player] add dead
execute if entity @s[tag=mission_success] as @a[scores={Stage=21,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission_success] run bossbar set medabots_server:paradise_a/robattle players
...
title @s[scores={BattlingMedabots=1,Battle=1..}] title {"translate":"medabots_server:message.stage.mission.complete","color":"green"}
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1723.5,y=45,z=-649.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run scoreboard players set @e[x=-1714.5,y=45,z=-662.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run kill @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mission]
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run bossbar set medabots_server:paradise_a/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
...
execute if entity @e[x=-1761,y=0,z=-730,dx=94,dy=49,dz=94,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=21,Medabot=0..,Battle=1..2}]
