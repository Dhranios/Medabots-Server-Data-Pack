...
execute if block -1747 46 -354 minecraft:iron_door[open=true] if block -1760 44 -368 minecraft:water if entity @s[x=-1750,y=44,z=-356,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/second_go_battle/0
...
execute if entity @e[x=-1754.5,y=44,z=-360.5,distance=..0.7,tag=mission,scores={Dialog=81}] unless entity @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,scores={Stage=13},tag=cannon,tag=mission_entity] run tag @s add mission_success
...
execute if entity @s[scores={BattlingMedabots=1}] run function medabots_server:stage/clean_up/seashore_b/second_go
stopsound @s[scores={BattlingMedabots=1}] music
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1}] -1715 51 -396 14
...
advancement grant @s[scores={BattlingMedabots=1}] only medabots_server:stages/wave_1/seashore_b_second_go
teleport @s[scores={BattlingMedabots=1}] -1715 51 -396 -180 0
execute if entity @s[scores={BattlingMedabots=1}] run bossbar set medabots_server:seashore_b/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots