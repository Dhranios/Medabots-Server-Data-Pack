execute if entity @s[scores={Death=1..}] run function medabots_server:stage/clean_up/seashore_b/second_go
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/seashore_b/second_go
execute if entity @s[scores={Battle=0}] run function medabots_server:other/death
execute unless entity @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,scores={Medabot=0..,Battle=1..2,Stage=13},tag=enemy_medabot] run bossbar set medabots_server:seashore_b/time players @s[scores={Death=0,Battle=1..}]
...
execute if block -1672 45 -438 minecraft:lime_wool run tag @e[x=-1694.5,y=45,z=-410.5,distance=..0.7,tag=door,tag=!open] add open
...
execute if block -1697 44 -411 minecraft:orange_wool if block -1744 44 -411 minecraft:orange_wool run scoreboard players add @e[x=-1695.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=changed] Moving 1
...
execute if block -1697 44 -411 minecraft:orange_wool if block -1744 44 -411 minecraft:orange_wool run scoreboard players remove @e[x=-1644.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=changed] Moving 1
execute if block -1697 44 -411 minecraft:orange_wool if block -1744 44 -411 minecraft:orange_wool run tag @e[x=-1644.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=changed] remove changed
execute if block -1697 44 -411 minecraft:yellow_wool run scoreboard players remove @e[x=-1695.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=!changed] Moving 1
...
execute if block -1697 44 -411 minecraft:yellow_wool run scoreboard players add @e[x=-1644.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=!changed] Moving 1
execute if block -1697 44 -411 minecraft:yellow_wool run tag @e[x=-1644.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=!changed] add changed
execute if block -1744 44 -411 minecraft:yellow_wool run scoreboard players remove @e[x=-1695.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=!changed] Moving 1
...
execute if block -1744 44 -411 minecraft:yellow_wool run scoreboard players add @e[x=-1644.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=!changed] Moving 1
execute if block -1744 44 -411 minecraft:yellow_wool run tag @e[x=-1644.5,y=45,z=-410.5,distance=..0.7,tag=fan,tag=!changed] add changed
...
execute if block -1747 46 -354 minecraft:iron_door[open=true] if block -1760 44 -368 minecraft:water if entity @s[x=-1621,y=45,z=-360,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/second_go_battle/0
execute if entity @e[x=-1754.5,y=44,z=-360.5,distance=..0.7,tag=mission,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,scores={Stage=13,Medabot=0..,Battle=1..}]
execute if entity @e[x=-1754.5,y=44,z=-360.5,distance=..0.7,tag=mission,scores={Dialog=81}] unless entity @e[x=-1762,y=42,z=-369,dx=16,dy=7,dz=21,scores={Stage=13},tag=cannon] run tag @s add mission_success
...
execute if block -1747 46 -413 minecraft:iron_door[open=true] if entity @s[x=-1748,y=45,z=-416,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/second_go_battle/1
execute if entity @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,tag=mr_referee] store result score @s BattlingMedabots if entity @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,scores={Stage=13,Medabot=0..,Battle=1..}]
...
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run function medabots_server:stage/clean_up/seashore_b/second_go
stopsound @s[scores={BattlingMedabots=1,Death=0}] music
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Death=0}] -1715 51 -396 14
...
advancement grant @s[scores={BattlingMedabots=1,Death=0}] only medabots_server:stages/wave_1/seashore_b_second_go
teleport @s[scores={BattlingMedabots=1,Death=0}] -1715 51 -396 -180 0
execute if entity @s[scores={BattlingMedabots=1,Death=0}] run bossbar set medabots_server:seashore_b/robattle players
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots