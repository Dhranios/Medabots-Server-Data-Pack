...
execute if block -1686 44 -436 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
...
execute if block -1717 44 -438 minecraft:light_blue_wool run scoreboard players set @e[x=-1745.5,y=45,z=-411.5,distance=..0.7,tag=door,scores={PowerAmount=1}] PowerAmount 0
...
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:story_progression/infinity={teach_sloan=true,sloan_goes_elsewhere=false}}] add dialog_infinity_sloan_goes_elsewhere
