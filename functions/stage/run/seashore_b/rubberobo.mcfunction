...
execute if entity @s[scores={Battle=0}] run function medabots_server:stage/clean_up/seashore_b/rubberobo
...
execute if block -1747 45 -354 minecraft:iron_door[open=true] if block -1760 44 -368 minecraft:water if entity @s[x=-1750,y=44,z=-356,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/rubberobo_battle/0
execute if entity @e[x=-1754.5,y=44,z=-360.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] store result score @s BattlingMedabots if entity @e[scores={Stage=13,Medabot=0..,Battle=1..2}]
execute if entity @e[x=-1754.5,y=44,z=-360.5,distance=..0.7,tag=mission,type=minecraft:area_effect_cloud,scores={Dialog=81}] unless entity @e[scores={Stage=13},tag=cannon,tag=mission,type=minecraft:area_effect_cloud_entity] run tag @s add mission_success
...
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run scoreboard players set @e[x=-1746.5,y=45,z=-353.5,distance=..0.7,tag=door,type=minecraft:area_effect_cloud,scores={PowerAmount=0}] PowerAmount 1
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run kill @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,tag=mission,type=minecraft:area_effect_cloud]
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run tag @e[scores={Stage=13,Medabot=0..,Battle=1..},type=minecraft:skeleton] add dead
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] as @a[scores={Stage=13,Medabot=0..,Battle=1..2},tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
execute if entity @s[tag=mission,type=minecraft:area_effect_cloud_success] run bossbar set medabots_server:seashore_b/robattle players
tag @s[tag=mission,type=minecraft:area_effect_cloud_success] remove mission_success
scoreboard players reset @s[scores={BattlingMedabots=1..}] BattlingMedabots
execute if block -1747 45 -413 minecraft:iron_door[open=true] if entity @s[x=-1748,y=45,z=-416,dx=3,dy=3,dz=3] run function medabots_server:stage/create/seashore_b/rubberobo_battle/1
execute if entity @e[x=-1762,y=42,z=-442,dx=94,dy=7,dz=94,tag=mr_referee,type=minecraft:armor_stand,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=13,Medabot=0..,Battle=1..2}]
...
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run function medabots_server:stage/clean_up/seashore_b/rubberobo
advancement grant @s[scores={BattlingMedabots=1,Battle=1..}] only medabots_server:stages/wave_1/seashore_b_rubberobo
execute if entity @s[scores={BattlingMedabots=1,Battle=1..}] run bossbar set medabots_server:seashore_b/robattle players
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:story_progression/infinity={rubberobo_enters_seashore_b=true,rubberobo_leaves_seashore_b=false}}] add dialog_infinity_rubberobo_leaves_seashore_b
