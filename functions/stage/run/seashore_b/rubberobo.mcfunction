...
tag @s[scores={BattlingMedabots=1,Battle=1..},advancements={medabots_server:wave_1/story_progression={rubberobo_enters_seashore_b=true,rubberobo_leaves_seashore_b=false}}] add dialog_infinity_rubberobo_leaves_seashore_b
