...
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={desperate_for_love=true,desperate_for_love_battle=false}}] add dialog_infinity_desperate_for_love_battle
