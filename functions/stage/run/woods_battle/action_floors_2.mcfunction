...
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={vs_sloan=true,vs_sloan_battle=false}}] add dialog_infinity_vs_sloan_battle
