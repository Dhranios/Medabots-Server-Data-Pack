...
execute if entity @s[scores={BattlingMedabots=2..}] unless entity @e[x=-1972,y=43,z=-640,dx=48,dy=7,dz=48,tag=mr_referee] run summon minecraft:armor_stand -1948 45 -611 {Invisible:1b,Marker:1b,Small:1b,CustomName:'{"translate":"medabots_server:entity.mr_referee"}',Tags:["mr_referee"],Rotation:[-180.0f,0.0f]}
...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1,Death=0},tag=!story_battle] -1949 51 -617 14
...
teleport @s[scores={BattlingMedabots=1,Death=0}] -1949 51 -617 -180 0
tag @s[scores={BattlingMedabots=1,Death=0},tag=story_battle,advancements={medabots_server:wave_1/story_progression={opening=true,opening_battle=false}}] add dialog_infinity_opening_battle
