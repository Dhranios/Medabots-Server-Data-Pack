...
tag @s[scores={BattlingMedabots=1,Battle=1..},tag=story_battle,advancements={medabots_server:wave_1/story_progression={opening=true,opening_battle=false}}] add dialog_infinity_opening_battle
