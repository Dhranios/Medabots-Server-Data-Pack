...
playsound medabots_server:music.stage.stage_end music @s[scores={BattlingMedabots=1},tag=!story_battle] -1949 51 -617 14
...
tag @s[scores={BattlingMedabots=1},tag=story_battle,advancements={medabots_server:wave_1/story_progression={opening=true,opening_battle=false}}] add dialog_infinity_opening_battle
