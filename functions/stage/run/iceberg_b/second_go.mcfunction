...
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1813.5,y=44,z=-394.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1807.5,y=44,z=-398.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
