...
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1803.5,y=44,z=-405.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1801 43 -396 minecraft:lime_wool run tag @e[x=-1804.5,y=44,z=-405.5,distance=..0.7,tag=door,tag=!open] add open
execute if block -1793 43 -434 minecraft:light_blue_wool run tag @e[x=-1793.5,y=44,z=-433.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1793 43 -434 minecraft:blue_wool run tag @e[x=-1793.5,y=44,z=-433.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1793 43 -435 minecraft:light_blue_wool run tag @e[x=-1793.5,y=44,z=-434.5,distance=..0.7,tag=laser_trap,tag=!enabled] add enabled
execute if block -1793 43 -435 minecraft:blue_wool run tag @e[x=-1793.5,y=44,z=-434.5,distance=..0.7,tag=laser_trap,tag=enabled] remove enabled
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1807.5,y=44,z=-397.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1806.5,y=44,z=-399.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1809.5,y=44,z=-401.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1808 43 -412 minecraft:lime_wool run tag @e[x=-1806.5,y=44,z=-404.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1801 43 -396 minecraft:lime_wool run tag @e[x=-1811.5,y=44,z=-395.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
execute if block -1801 43 -396 minecraft:lime_wool run tag @e[x=-1809.5,y=44,z=-398.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
...
execute if block -1801 43 -396 minecraft:lime_wool run tag @e[x=-1810.5,y=44,z=-404.5,distance=..0.7,tag=action_floor,tag=!enabled] add enabled
...
execute if entity @s[tag=mission_success] run scoreboard players set @a[scores={Stage=15,Medabot=0..,Battle=1..2},tag=enemy_medabot] LeaveStage 1
