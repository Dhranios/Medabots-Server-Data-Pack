...
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] if entity @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] run function medabots_server:stage/clean_up/seashore_a/rubberobo
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run advancement grant @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] only medabots_server:stages/wave_1/seashore_a_rubberobo
