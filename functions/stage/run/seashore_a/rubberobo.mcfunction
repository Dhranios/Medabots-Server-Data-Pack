...
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run stopsound @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] music
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run playsound medabots_server:music.stage.stage_end music @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] -1539 51 -216 1000
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run scoreboard players set @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] Battle 0
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run scoreboard players set @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] MusicType 1
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run scoreboard players set @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] Music 299
...
execute unless entity @e[tag=rubberobo,scores={Stage=4},type=minecraft:zombie] run teleport @s[x=-1538,y=45,z=-228,dy=4,tag=hostile,gamemode=adventure] -1539 51 -216 -180 0