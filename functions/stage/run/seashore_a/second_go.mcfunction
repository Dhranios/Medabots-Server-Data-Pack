...
execute if block -1569 46 -207 minecraft:iron_door[open=false] if block -1556 44 -187 minecraft:lime_wool run setblock -1569 45 -207 minecraft:structure_block[mode=load]{name:"medabots_server:stage/open_door",mode:"LOAD"}
execute if block -1569 45 -207 minecraft:structure_block run setblock -1569 46 -207 minecraft:redstone_block
...
execute if block -1562 45 -235 minecraft:chest run setblock -1562 46 -235 minecraft:barrier
...
execute if block -1517 45 -188 minecraft:air if block -1517 46 -188 minecraft:barrier run summon minecraft:tnt -1517 45 -188 {CustomName:"{\"translate\":\"medabots_server:entity.bomb\"}",Fuse:100s,Tags:["hostile","killerable"]}
...
execute if block -1524 45 -187 minecraft:air if block -1524 46 -187 minecraft:barrier run summon minecraft:tnt -1524 45 -187 {CustomName:"{\"translate\":\"medabots_server:entity.bomb\"}",Fuse:100s,Tags:["hostile","killerable"]}
...
execute if block -1550 45 -186 minecraft:air if block -1550 46 -186 minecraft:barrier run summon minecraft:creeper -1550 45 -186 {Silent:1b,PersistenceRequired:1b,Attributes:[{Name:"generic.maxHealth",Base:100.0d}],Fuse:30s,CustomName:"{\"translate\":\"medabots_server:entity.guard\"}",Team:"StageEnemy",Tags:["hostile","killerable","guard","slow"],NoAI:1b,DeathLootTable:"medabots_server:entities/guard",AbsorptionAmount:10.0f,Health:100.0f}
...
execute if block -1562 45 -235 minecraft:air run setblock -1562 46 -235 minecraft:air
...
execute unless entity @s[x=-1570,y=43,z=-247,dx=63,dy=7,dz=63,scores={Battle=1..}] run function medabots_server:stage/clean_up/seashore_a/second_go
...
advancement grant @s[x=-1537.5,y=45,z=-228.5,distance=..0.7,tag=hostile,gamemode=adventure] only medabots_server:stages/seashore_a_second_go
