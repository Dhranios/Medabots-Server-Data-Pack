...
execute if block -1556 44 -187 minecraft:lime_wool run scoreboard players set @e[x=-1568.5,y=45,z=-206.5,distance=..0.7,tag=door,scores={PowerAmount=0}] PowerAmount 1
...
execute if entity @s[tag=clear_stage] run function medabots_server:stage/clean_up/seashore_a/second_go
