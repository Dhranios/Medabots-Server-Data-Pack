execute if entity @e[x=-1376,y=39,z=-205,dx=62,dy=10,dz=86,tag=mr_referee,tag=finished] store result score @s BattlingMedabots if entity @e[scores={Stage=39,Medabot=0..,Battle=1..}]
execute unless entity @e[scores={Stage=39,Medabot=0..,Battle=1..},tag=main] run tag @s add main
