...
execute unless entity @s[scores={Time=-1..}] run function medabots_server:stage/cannon_scores
...
execute if entity @s[tag=detect] run function medabots_server:stage/cannon_detect
