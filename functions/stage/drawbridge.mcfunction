...
execute unless entity @s[scores={Time=-1..}] run function medabots_server:stage/drawbridge_scores
...
execute if entity @s[scores={Time=0}] run function medabots_server:stage/drawbridge_turn_back

# Reset the pushing
scoreboard players set @s Moving 0

# Push me
execute if entity @s[scores={Time=0}] run function medabots_server:stage/drawbridge_hit
...
execute if entity @s[tag=dead] run function medabots_server:stage/drawbridge_clean_up