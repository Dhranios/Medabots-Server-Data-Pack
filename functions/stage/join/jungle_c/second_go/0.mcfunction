...
execute if entity @s[tag=valid_tinpet,scores={Dialog=0}] run data merge block -1540 51 -545 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/jungle_c/second_go/1"}}'}
