...
tellraw @s[scores={Level=20..,Dialog=0},tag=valid_tinpet,advancements={medabots_server:stages/wave_1/lagdou_ruins_3_second_go=true}] {"translate":"medabots_server:message.stage.player.final","color":"green","extra":[{"text":" "},{"translate":"medabots_server:message.stage.player.wait","color":"green"}]}
execute if entity @s[scores={Level=20..,Dialog=0},tag=valid_tinpet,advancements={medabots_server:stages/wave_1/lagdou_ruins_3_second_go=true}] run tellraw @a {"translate":"medabots_server:message.stage.players.0","color":"green","with":[{"translate":"medabots_server:location.lagdou_ruins","with":[{"text":"4"}]}]}
...
scoreboard players set @s[scores={Level=20..,Dialog=0},tag=valid_tinpet,advancements={medabots_server:stages/wave_1/lagdou_ruins_3_second_go=true}] StageVersion 1
...
execute if entity @s[scores={Level=20..,Dialog=0},tag=valid_tinpet,advancements={medabots_server:stages/wave_1/lagdou_ruins_3_second_go=true}] run function medabots_server:stage/create/lagdou_ruins_4/empty
...
execute unless entity @s[scores={Level=20..,Dialog=0},tag=valid_tinpet] run tellraw @s {"translate":"medabots_server:message.stage.not_matching_requirement","extra":[{"translate":"medabots_server:message.stage.requires.level","with":[{"text":"20"}]}]}
execute unless entity @s[tag=valid_tinpet,scores={Dialog=0},advancements={medabots_server:stages/wave_1/lagdou_ruins_3_first_go=true}] run tellraw @s {"translate":"medabots_server:message.stage.not_matching_requirement","extra":[{"translate":"medabots_server:message.stage.requires.wins.more","with":[{"translate":"medabots_server:location.lagdou_ruins","with":[{"text":"3"}]},{"text":"2"}]}]}
tellraw @s[tag=!valid_tinpet] {"translate":"medabots_server:message.tinpet.not_valid"}
tag @s remove valid_tinpet
