...
execute if entity @s[tag=valid_tinpet,scores={Dialog=0}] run data merge block -1619 52 -477 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!medabot] run function medabots_server:stage/join/jungle_b/first_go/1"}}'}
