...
execute if entity @s[scores={Dialog=0,Error=0}] run setblock -1808 54 -635 minecraft:red_wool
...
execute if entity @s[scores={Dialog=0,Error=0}] run function medabots_server:stage/create/park_a/first_go
