...
scoreboard players set @s[scores={Dialog=0,Error=0}] StageVersion 7
tag @s[scores={Dialog=0,Error=0}] add 0
execute if entity @s[scores={Dialog=0,Error=0}] run function medabots_server:stage/create/woods_battle/cannons
