...
execute if entity @s[tag=-1] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/sign/generic/no_pvp_on"}}'}
execute if entity @s[tag=-1] run setblock -1794 52 -439 minecraft:red_wool
execute if entity @s[tag=-1] run teleport @s -1785 29 -391 90 0
execute if entity @s[tag=-1] run data merge block -1796 51 -435 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/iceberg_b/enter"}}',Text3:'{"translate":"medabots_server:sign.stage.play.main_player"}'}
execute if entity @s[tag=-1] run setblock -1796 52 -437 minecraft:red_wool
...
execute if entity @s[tag=0] if entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=1] if entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!enemy_medabot,tag=!-1] run function medabots_server:stage/join/iceberg_b/second_go/2"}}'}
...
execute if entity @s[tag=0] if entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=1] unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!enemy_medabot,tag=!-1] run function medabots_server:stage/join/iceberg_b/second_go/1"}}'}
...
execute if entity @s[tag=0] unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=1] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!enemy_medabot,tag=!-1] run function medabots_server:stage/join/iceberg_b/second_go/0"}}'}
...
execute if entity @s[tag=1] if entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!enemy_medabot,tag=!-1] run function medabots_server:stage/join/iceberg_b/second_go/2"}}'}
...
execute if entity @s[tag=1] unless entity @a[x=-1824,y=50,z=-438,dx=60,dy=4,dz=90,tag=2] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!enemy_medabot,tag=!-1] run function medabots_server:stage/join/iceberg_b/second_go/1"}}'}
...
execute if entity @s[tag=2] run data merge block -1794 51 -437 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute if entity @s[tag=!enemy_medabot,tag=!-1] run function medabots_server:stage/join/iceberg_b/second_go/2"}}'}
