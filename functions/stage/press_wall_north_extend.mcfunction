...
execute if entity @s[scores={Range=2..,Time=10}] if block ~ ~ ~-1 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-1 minecraft:black_stained_glass
execute if entity @s[scores={Range=2..,Time=10}] if block ~ ~ ~-1 minecraft:air run fill ~ ~ ~ ~ ~ ~-1 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=3..,Time=20}] if block ~ ~ ~-2 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-2 minecraft:black_stained_glass
execute if entity @s[scores={Range=3..,Time=20}] if block ~ ~ ~-2 minecraft:air run fill ~ ~ ~ ~ ~ ~-2 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=4..,Time=30}] if block ~ ~ ~-3 minecraft:air run fill ~ ~ ~ ~ ~ ~-3 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=5..,Time=40}] if block ~ ~ ~-4 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-4 minecraft:black_stained_glass
execute if entity @s[scores={Range=5..,Time=40}] if block ~ ~ ~-4 minecraft:air run fill ~ ~ ~ ~ ~ ~-4 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=6..,Time=50}] if block ~ ~ ~-5 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-5 minecraft:black_stained_glass
execute if entity @s[scores={Range=6..,Time=50}] if block ~ ~ ~-5 minecraft:air run fill ~ ~ ~ ~ ~ ~-5 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=7..,Time=60}] if block ~ ~ ~-6 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-6 minecraft:black_stained_glass
execute if entity @s[scores={Range=7..,Time=60}] if block ~ ~ ~-6 minecraft:air run fill ~ ~ ~ ~ ~ ~-6 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=8..,Time=70}] if block ~ ~ ~-7 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-7 minecraft:black_stained_glass
execute if entity @s[scores={Range=8..,Time=70}] if block ~ ~ ~-7 minecraft:air run fill ~ ~ ~ ~ ~ ~-7 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=9..,Time=80}] if block ~ ~ ~-8 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-8 minecraft:black_stained_glass
execute if entity @s[scores={Range=9..,Time=80}] if block ~ ~ ~-8 minecraft:air run fill ~ ~ ~ ~ ~ ~-8 minecraft:quartz_pillar[axis=z]
...
execute if entity @s[scores={Range=10..,Time=90}] if block ~ ~ ~-9 minecraft:air run fill ~ ~1 ~ ~ ~3 ~-9 minecraft:black_stained_glass
execute if entity @s[scores={Range=10..,Time=90}] if block ~ ~ ~-9 minecraft:air run fill ~ ~ ~ ~ ~ ~-9 minecraft:quartz_pillar[axis=z]