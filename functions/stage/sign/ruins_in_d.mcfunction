...
tellraw @s {"translate":"medabots_server:advancements.passes.ruins_in_d","extra":[{"translate":"medabots_server:message.stage.requires.and"},{"translate":"medabots_server:message.stage.requires.medapart","with":[{"translate":"medabots_server:move.wheel"}]}]}
tellraw @s {"text":""}
