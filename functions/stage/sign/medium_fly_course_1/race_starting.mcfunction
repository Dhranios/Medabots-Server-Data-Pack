scoreboard players set @a[x=-89,y=120,z=-82,dx=6,dy=3,dz=8,tag=racer] FlyCourse 1
scoreboard players set @a[x=-89,y=120,z=-82,dx=6,dy=3,dz=8,tag=racer] Stage 2
scoreboard players set @a[x=-89,y=120,z=-82,dx=6,dy=3,dz=8,tag=racer] Time 220
scoreboard players set @a[x=-89,y=120,z=-82,dx=6,dy=3,dz=8,tag=racer] Rings 0
scoreboard players set @a[x=-89,y=120,z=-82,dx=6,dy=3,dz=8,tag=racer] RingsTotal 0
...
data merge block -89 121 -79 {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"tellraw @s {\\\"translate\\\":\\\"medabots_server:message.stage.fly_course.no_race\\\",\\\"color\\\":\\\"green\\\"}\"}}"}
setblock -90 122 -77 minecraft:diamond_block
data merge block -89 121 -77 {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"tellraw @s {\\\"translate\\\":\\\"medabots_server:message.stage.fly_course.currently_racing\\\",\\\"color\\\":\\\"green\\\"}\"}}",Text3:"{\"translate\":\"medabots_server:sign.stage.fly_course.race\"}"}