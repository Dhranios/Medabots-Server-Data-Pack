tellraw @s {"translate":"medabots_server:message.stage.description.laboratory_d"}
tellraw @s {"translate":"medabots_server:message.stage.requires"}
tellraw @s {"translate":"medabots_server:advancements.passes.laboratory_d","extra":[{"translate":"medabots_server:message.stage.requires.and"},{"translate":"medabots_server:message.stage.requires.medapart","with":[{"translate":"medabots_server:move.tank"}]}]}
tellraw @s {"text":""}
