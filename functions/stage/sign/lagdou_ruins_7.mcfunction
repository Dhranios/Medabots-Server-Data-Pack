tellraw @s {"translate":"medabots_server:message.stage.description.lagdou_ruins_7"}
tellraw @s {"translate":"medabots_server:message.stage.requires","extra":[{"text":" "},{"translate":"medabots_server:message.stage.requires.level","with":[{"text":"35"}]},{"translate":"medabots_server:message.stage.requires.and"},{"translate":"medabots_server:message.stage.requires.wins.more","with":[{"translate":"medabots_server:location.lagdou_ruins","with":[{"text":"6"}]},{"text":"2"}]}]}
tellraw @s {"text":""}
