execute if entity @s[tag=!vs_cpus] run data merge block -1291 50 1 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function medabots_server:stage/try/lagdou_ruins_8/enter"}}'}
execute if entity @s[tag=!vs_cpus] run setblock -1291 51 -1 minecraft:red_wool
