...
execute if entity @s[scores={Error=0,Level=50,LagdouKill=18..},gamemode=adventure] run tag @e[sort=random,tag=join_stage,limit=1] add selected
...
scoreboard players set @s[scores={Error=0,Level=50,LagdouKill=18..},gamemode=adventure] Stage 96
scoreboard players set @s[scores={Error=0,Level=50,LagdouKill=18..},gamemode=adventure] Battle 1
scoreboard players set @s[scores={Error=0,Level=50,LagdouKill=18..},gamemode=adventure] MusicType -1
scoreboard players set @s[scores={Error=0,Level=50,LagdouKill=18..},gamemode=adventure] Music 0
