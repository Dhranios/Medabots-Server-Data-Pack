tellraw @s {"translate":"medabots_server:message.stage.description.easy_fly_course_1"}
...
tellraw @s {"translate":"medabots_server:message.stage.score.scoreholder","with":[{"text":"1"},{"text":"FVbico"},{"text":"529 / 8:13"}]}
