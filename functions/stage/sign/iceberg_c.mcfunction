...
tellraw @s {"translate":"medabots_server:sign.stage.version.first_go","extra":[{"translate":"medabots_server:message.stage.requires.version"},{"translate":"medabots_server:message.stage.requires.wins.1","with":[{"translate":"medabots_server:location.seashore","with":[{"text":"C"}]}]}]}
tellraw @s {"text":""}
