...
tellraw @s {"translate":"medabots_server:advancements.special_items.passes.iceberg_d","extra":[{"translate":"medabots_server:message.stage.requires.and"},{"translate":"medabots_server:message.stage.requires.medapart","with":[{"translate":"medabots_server:move.swim"}]}]}
tellraw @s {"text":""}
