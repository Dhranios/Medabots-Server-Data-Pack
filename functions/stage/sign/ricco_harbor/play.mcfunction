...
scoreboard players set @s[scores={Error=0,Dialog=0},gamemode=adventure] Stage 97
scoreboard players set @s[scores={Error=0,Dialog=0},gamemode=adventure] Battle 1
scoreboard players set @s[scores={Error=0,Dialog=0},gamemode=adventure] MusicType -1
