...
summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:"{\"translate\":\"medabots_server:entity.stage_randomizer\"}",Tags:["join_stage","4"],Duration:1}
#summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:"{\"translate\":\"medabots_server:entity.stage_randomizer\"}",Tags:["join_stage","5"],Duration:1}
...
scoreboard players set @s[scores={Error=0},gamemode=adventure] Stage 87
scoreboard players set @s[scores={Error=0},gamemode=adventure] Battle 1
scoreboard players set @s[scores={Error=0},gamemode=adventure] MusicType 19
