...
execute if entity @s[scores={Error=0,Dialog=0,Level=35},advancements={medabots_server:stages/wave_1/lagdou_ruins_6_second_go=true},gamemode=adventure] run tag @e[sort=random,tag=join_stage,limit=1] add selected
...
scoreboard players set @s[scores={Error=0,Dialog=0,Level=35},advancements={medabots_server:stages/wave_1/lagdou_ruins_6_second_go=true},gamemode=adventure] Stage 93
scoreboard players set @s[scores={Error=0,Dialog=0,Level=35},advancements={medabots_server:stages/wave_1/lagdou_ruins_6_second_go=true},gamemode=adventure] Battle 1
scoreboard players set @s[scores={Error=0,Dialog=0,Level=35},advancements={medabots_server:stages/wave_1/lagdou_ruins_6_second_go=true},gamemode=adventure] MusicType 20
