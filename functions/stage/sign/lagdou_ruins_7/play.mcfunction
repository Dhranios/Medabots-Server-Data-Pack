...
execute if entity @s[scores={Error=0,Level=35,LagdouKill=12..},gamemode=adventure] run tag @e[sort=random,tag=join_stage,limit=1] add selected
...
scoreboard players set @s[scores={Error=0,Level=35,LagdouKill=12..},gamemode=adventure] Stage 93
scoreboard players set @s[scores={Error=0,Level=35,LagdouKill=12..},gamemode=adventure] Battle 1
scoreboard players set @s[scores={Error=0,Level=35,LagdouKill=12..},gamemode=adventure] MusicType 20
scoreboard players set @s[scores={Error=0,Level=35,LagdouKill=12..},gamemode=adventure] Music 0
