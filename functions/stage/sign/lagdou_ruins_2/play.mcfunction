...
execute if entity @s[scores={Error=0,Dialog=0,Level=10},advancements={medabots_server:stages/lagdou_ruins_1_second_go=true},gamemode=adventure] run tag @e[sort=random,tag=join_stage,limit=1] add selected
...
scoreboard players set @s[scores={Error=0,Dialog=0,Level=10},advancements={medabots_server:stages/lagdou_ruins_1_second_go=true},gamemode=adventure] Stage 88
