tellraw @s {"translate":"medabots_server:message.stage.description.jungle_d"}
tellraw @s {"translate":"medabots_server:message.stage.requires"}
tellraw @s {"translate":"medabots_server:advancements.special_items.passes.jungle_d","extra":[{"translate":"medabots_server:message.stage.requires.and"},{"translate":"medabots_server:message.stage.requires.medapart","with":[{"translate":"medabots_server:move.multi_legged"}]}]}
tellraw @s {"text":""}
