...
execute if entity @s[advancements={medabots_server:wave_1/story_progression={rubberobo_breakout=true,rubberobo_enters_rock_a=false}}] run tag @s add dialog_infinity_rubberobo_enters_rock_a