...
execute unless entity @s[scores={Time=-100..}] run function medabots_server:stage/action_floor_scores
...
# Guard
execute if entity @s[scores={Time=50},tag=guard] run function medabots_server:stage/action_floor_guard
...
# Cannon
execute if entity @s[scores={Time=50},tag=cannon] run function medabots_server:stage/action_floor_cannon
...
execute if entity @s[tag=dead] run function medabots_server:stage/action_floor_clean_up