...
execute if entity @a[tag=target] facing entity @a[tag=target] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,tag=!guard,tag=!floor_switch,tag=!move_target] positioned as @s run function medabots_server:stage/guard_can_move
...
execute unless entity @a[tag=target] as @e[tag=move_target] facing entity @s feet if score @s GuardNr = @e[distance=..0.1,limit=1,sort=nearest,tag=guard] GuardNr as @e[distance=..0.1,limit=1,sort=nearest,tag=guard] rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,tag=!guard,tag=!floor_switch,tag=!move_target] positioned as @s run function medabots_server:stage/guard_can_move
execute if entity @s[tag=can_move] unless entity @a[tag=target] as @e[tag=move_target] facing entity @s feet if score @s GuardNr = @e[distance=..0.1,limit=1,sort=nearest,tag=guard] GuardNr as @e[distance=..0.1,limit=1,sort=nearest,tag=guard] rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,tag=!guard,tag=!floor_switch,tag=!move_target] positioned as @s run function medabots_server:stage/guard_move
execute if entity @s[tag=!can_move] run scoreboard players set @s Time 30
execute unless entity @a[tag=target] at @e[tag=move_target,distance=..0.4] if score @s GuardNr = @e[distance=..0.4,limit=1,sort=nearest,tag=move_target] GuardNr run scoreboard players set @s Time 30
