...
# execute if entity @s[scores={StageBuild=5..8}] run function medabots_server:stage/build/floor_switch
# execute if entity @s[scores={StageBuild=9},tag=allowed,advancements={medabots_server:special_items/stone=true}] run function medabots_server:stage/build/stone
# execute if entity @s[scores={StageBuild=10},advancements={medabots_server:special_items/accelerator=true}] run function medabots_server:stage/build/accelerator
# execute if entity @s[scores={StageBuild=11..14},tag=allowed,advancements={medabots_server:special_items/gas_floor=true}] run function medabots_server:stage/build/gas_floor
# execute if entity @s[scores={StageBuild=15},tag=allowed,advancements={medabots_server:special_items/hole=true}] run function medabots_server:stage/build/hole
# execute if entity @s[scores={StageBuild=16},tag=allowed,advancements={medabots_server:special_items/hammer_punch=true}] run function medabots_server:stage/build/hammer_punch
# execute if entity @s[scores={StageBuild=17},tag=allowed,advancements={medabots_server:special_items/spring_wall=true}] run function medabots_server:stage/build/spring_wall
# execute if entity @s[scores={StageBuild=18},tag=allowed,advancements={medabots_server:special_items/press_wall=true}] run function medabots_server:stage/build/press_wall
# execute if entity @s[scores={StageBuild=19}] run function medabots_server:stage/build/door
# execute if entity @s[scores={StageBuild=20},tag=allowed] run function medabots_server:stage/build/wall
# execute if entity @s[scores={StageBuild=21},tag=allowed,advancements={medabots_server:special_items/glass=true}] run function medabots_server:stage/build/glass
# execute if entity @s[scores={StageBuild=22..23},tag=allowed,advancements={medabots_server:special_items/mirror=true}] run function medabots_server:stage/build/mirror
# execute if entity @s[scores={StageBuild=24},tag=allowed,advancements={medabots_server:special_items/laser_trap=true}] run function medabots_server:stage/build/laser_trap
# execute if entity @s[scores={StageBuild=25},tag=allowed,advancements={medabots_server:special_items/fan=true}] run function medabots_server:stage/build/fan
