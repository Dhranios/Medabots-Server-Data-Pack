...
tag @a[scores={StageBuild=-4}] add bound
tellraw @a[scores={StageBuild=-4}] {"translate":"medabots_server:message.stage.stage_builder.floor_switch.bound","with":[{"selector":"@s"}],"color":"green"}
