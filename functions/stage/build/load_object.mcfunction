...
execute store result score @e[tag=new,tag=round_stone,limit=1] Moving run data get entity @s Item.tag.medabots_server.stage_data[0].additional_data[0]
execute store result score @e[tag=new,tag=ice_block,limit=1] Moving run data get entity @s Item.tag.medabots_server.stage_data[0].additional_data[0]
