...
execute as @e[type=!minecraft:falling_block,type=!minecraft:shulker,type=!minecraft:item,tag=!build_stage,type=!minecraft:player] at @s if score @s Stage = #temp Stage run function medabots_server:stage/build/save_object
