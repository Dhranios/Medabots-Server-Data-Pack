...
execute if entity @e[tag=!goal_area,tag=!starting_area,limit=1,type=!minecraft:player,tag=dead,tag=!has_floor_switch] run tellraw @s {"translate":"medabots_server:message.stage.stage_builder.removed","with":[{"selector":"@e[tag=!goal_area,tag=!starting_area,limit=1,tag=dead]"}],"color":"green"}
execute if entity @e[tag=!goal_area,tag=!starting_area,limit=1,type=!minecraft:player,tag=dead,tag=has_floor_switch] run tellraw @s {"translate":"medabots_server:message.stage.stage_builder.removed.floor_switch","with":[{"selector":"@e[tag=!goal_area,tag=!starting_area,limit=1,tag=dead]"}],"color":"green"}
