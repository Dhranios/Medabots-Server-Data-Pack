...
execute if entity @e[distance=..0.7,tag=pot,tag=!cannon,tag=!guard,tag=!bomb,tag=!balloon_bomb,tag=!jammy] if entity @s[tag=allowed,scores={StageBuild=74}] run function medabots_server:set_blocks/pot/guard/medium
...
execute unless entity @e[distance=..0.7,tag=pot,tag=!cannon,tag=!guard,tag=!bomb,tag=!balloon_bomb,tag=!jammy] if entity @s[tag=allowed,scores={StageBuild=74}] run function medabots_server:spawn_entities/guard/medium
