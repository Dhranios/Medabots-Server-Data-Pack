# Push me
execute if entity @s[scores={Moving=0}] run function medabots_server:stage/round_stone_hit
...
execute if entity @s[scores={Moving=1..}] run function medabots_server:stage/round_stone_valid_move
...
# Crush enemies
execute if entity @s[scores={Moving=1..}] run function medabots_server:stage/round_stone_crush

# Remove model and collision if dead
execute if entity @s[tag=dead] run function medabots_server:stage/round_stone_death
