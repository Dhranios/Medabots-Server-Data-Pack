...
setblock -1648 46 -177 minecraft:air
...
fill -1687 45 -174 -1687 48 -173 minecraft:air
...
tag @a[scores={Stage=9},tag=enemy_medabot] remove enemy_medabot
...
teleport @a[scores={Stage=9}] -1673 51 -148 -180 0
tag @e[scores={Stage=9},type=!minecraft:player] add dead
scoreboard players reset @a[scores={Stage=9}] Stage
