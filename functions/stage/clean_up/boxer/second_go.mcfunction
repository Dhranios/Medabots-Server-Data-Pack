...
scoreboard players set @a[scores={Stage=80}] Music 0
scoreboard players set @a[scores={Stage=80}] MusicType 22
scoreboard players set @a[scores={Stage=80}] Battle 0
tag @e[scores={Stage=80},type=!minecraft:player] add dead
