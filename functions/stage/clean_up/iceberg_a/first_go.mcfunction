...
setblock -1720 45 -212 minecraft:air
...
setblock -1746 45 -208 minecraft:air
setblock -1747 45 -209 minecraft:air
setblock -1753 45 -204 minecraft:air
setblock -1756 45 -203 minecraft:air
setblock -1756 45 -192 minecraft:air
...
tag @a[scores={Stage=17},tag=enemy_medabot] remove enemy_medabot
...
teleport @a[scores={Stage=17}] -1704 50 -221 -180 0
