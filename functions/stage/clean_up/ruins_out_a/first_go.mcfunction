...
fill -1603 45 -301 -1603 48 -299 minecraft:air
...
tag @a[scores={Stage=20},tag=enemy_medabot] remove enemy_medabot
scoreboard players set @a[scores={Stage=20}] Music 0
scoreboard players set @a[scores={Stage=20}] MusicType 1
scoreboard players set @a[scores={Stage=20}] Battle 0
teleport @a[scores={Stage=20}] -1570 51 -284 -180 0
