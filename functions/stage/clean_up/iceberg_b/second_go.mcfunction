...
scoreboard players set @a[scores={Stage=15}] Music 0
scoreboard players set @a[scores={Stage=15}] MusicType 1
scoreboard players set @a[scores={Stage=15}] Battle 0
teleport @a[scores={Stage=15}] -1795 50 -419 -180 0
