...
tag @e[distance=..0.5,tag=hostile,tag=!press_wall,type=!minecraft:item,tag=!rubberobo] add dead
...
execute if entity @s[scores={Moving=1}] positioned ~0.2 ~ ~ run tag @e[distance=..0.7,tag=hostile,tag=!press_wall,type=!minecraft:item,tag=!rubberobo] add dead
...
execute if entity @s[scores={Moving=2}] positioned ~ ~ ~0.2 run tag @e[distance=..0.7,tag=hostile,tag=!press_wall,type=!minecraft:item,tag=!rubberobo] add dead
...
execute if entity @s[scores={Moving=3}] positioned ~-0.2 ~ ~ run tag @e[distance=..0.7,tag=hostile,tag=!press_wall,type=!minecraft:item,tag=!rubberobo] add dead
...
execute if entity @s[scores={Moving=4}] positioned ~ ~ ~-0.2 run tag @e[distance=..0.7,tag=hostile,tag=!press_wall,type=!minecraft:item,tag=!rubberobo] add dead
