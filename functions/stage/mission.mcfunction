...
execute if entity @s[tag=mission_success] as @a[scores={Medabot=0..,Battle=1..2},tag=this_mission,tag=enemy_medabot] run function medabots_server:stage/left_server_enforced
