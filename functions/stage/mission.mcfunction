...
execute if entity @s[tag=custom_stage,tag=!open_the_exit_door] run tag @e[distance=..0.7,tag=powered,tag=door] add no_open
execute if entity @s[tag=custom_stage,tag=open_the_exit_door] if entity @e[distance=..0.7,tag=powered,tag=door] run tag @s add mission_success
...
execute if entity @s[tag=custom_stage,tag=destroy_all_cannons] unless entity @e[tag=mission_entity,tag=this_mission,tag=cannon] run tag @s add mission_success
execute if entity @s[tag=custom_stage,tag=defeat_all_guards] unless entity @e[tag=mission_entity,tag=this_mission,tag=guard] run tag @s add mission_success
...
execute if entity @s[tag=mission_success] run scoreboard players set @e[scores={Medabot=0..,Battle=1..2},tag=this_mission,tag=enemy_medabot,type=minecraft:player] LeaveStage 1
