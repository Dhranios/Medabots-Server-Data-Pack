...
execute as @e[tag=medabot_model] at @e[scores={MedabotNr=0..}] if score @s MedabotNr = @e[distance=..0.1,tag=hostile,limit=1] MedabotNr run function medabots_server:animations/medabot/main
