...
execute positioned ~ ~-1 ~ run tag @e[distance=..0.7,tag=hostile] add had_death
execute positioned ~ ~-1 ~ run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=1}] positioned ~1 ~-1 ~ run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=2}] positioned ~ ~-1 ~1 run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=3}] positioned ~-1 ~-1 ~ run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=4}] positioned ~ ~-1 ~-1 run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute positioned ~ ~-2 ~ run tag @e[distance=..0.7,tag=hostile] add had_death
execute positioned ~ ~-2 ~ run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=1}] positioned ~1 ~-2 ~ run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=2}] positioned ~ ~-2 ~1 run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=3}] positioned ~-1 ~-2 ~ run tag @e[distance=..0.7,tag=hostile] add crushed
...
execute if entity @s[scores={Moving=4}] positioned ~ ~-2 ~-1 run tag @e[distance=..0.7,tag=hostile] add crushed
