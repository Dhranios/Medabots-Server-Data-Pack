...
execute if entity @a[tag=target] facing entity @a[tag=target] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,type=!minecraft:area_effect_cloud] positioned as @s run function medabots_server:entities/guard/can_move
...
execute unless entity @a[tag=target] as @e[tag=move_target] facing entity @s feet if score @s GuardNr = @e[distance=..0.1,limit=1,sort=nearest,tag=guard] GuardNr as @e[distance=..0.1,limit=1,sort=nearest,tag=guard] rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,type=!minecraft:area_effect_cloud] positioned as @s run function medabots_server:entities/guard/can_move
