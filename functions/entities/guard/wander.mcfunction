...
execute as @e[tag=move_target] if score @s GuardNr = #temp GuardNr GuardNr run tag @s add this_move_target
...
execute if entity @e[tag=target] facing entity @e[tag=target] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,type=!minecraft:area_effect_cloud] positioned as @s run function medabots_server:entities/guard/can_move_start
execute if entity @s[tag=can_move] if entity @e[tag=target] facing entity @e[tag=target] feet rotated ~ 0 run function medabots_server:entities/guard/move
execute if entity @s[tag=!has_move_target] unless entity @e[tag=target] run function medabots_server:entities/guard/spawn_move_target
execute unless entity @e[tag=target] facing entity @e[tag=this_move_target,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,type=!minecraft:area_effect_cloud,limit=1] positioned as @s run function medabots_server:entities/guard/can_move_start
execute if entity @s[tag=can_move] unless entity @e[tag=target] facing entity @e[tag=this_move_target,limit=1] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,type=!minecraft:area_effect_cloud,limit=1] positioned as @s run function medabots_server:entities/guard/move
execute if entity @s[tag=!can_move] run scoreboard players set @s Time 30
execute unless entity @e[tag=target] if entity @e[tag=this_move_target,limit=1,distance=..1.1] run scoreboard players set @s Time 30
execute unless entity @e[tag=target] run kill @e[tag=this_move_target,limit=1,distance=..1.1]
...
execute if entity @s[tag=walking,scores={Sound=0}] run playsound medabots_server:entity.guard.move hostile @e ~ ~ ~ 1
