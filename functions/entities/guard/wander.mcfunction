...
execute if entity @a[tag=target] facing entity @a[tag=target] feet rotated ~ 0 positioned ^ ^ ^0.4 unless entity @e[distance=..0.2,tag=!guard,tag=!floor_switch,tag=!move_target] positioned as @s run function medabots_server:entities/guard/can_move
