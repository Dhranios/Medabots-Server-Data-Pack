...
tag @a[distance=..0.5,tag=hostile] add dead
execute as @e[distance=..0.5,tag=hostile,tag=!balloon_bomb,type=!minecraft:item] run data merge entity @s {AbsorptionAmount:0f}
...
execute if entity @s[scores={Moving=1}] positioned ~1 ~ ~ run tag @a[distance=..0.7,tag=hostile] add dead
execute if entity @s[scores={Moving=1}] positioned ~1 ~ ~ as @e[distance=..0.5,tag=hostile,tag=!balloon_bomb,type=!minecraft:item] run data merge entity @s {AbsorptionAmount:0f}
...
execute if entity @s[scores={Moving=2}] positioned ~ ~ ~1 run tag @a[distance=..0.7,tag=hostile] add dead
execute if entity @s[scores={Moving=2}] positioned ~ ~ ~1 as @e[distance=..0.5,tag=hostile,tag=!balloon_bomb,type=!minecraft:item] run data merge entity @s {AbsorptionAmount:0f}
...
execute if entity @s[scores={Moving=3}] positioned ~-1 ~ ~ run tag @a[distance=..0.7,tag=hostile] add dead
execute if entity @s[scores={Moving=3}] positioned ~-1 ~ ~ as @e[distance=..0.5,tag=hostile,tag=!balloon_bomb,type=!minecraft:item] run data merge entity @s {AbsorptionAmount:0f}
...
execute if entity @s[scores={Moving=4}] positioned ~ ~ ~-1 run tag @a[distance=..0.7,tag=hostile] add dead
execute if entity @s[scores={Moving=4}] positioned ~ ~ ~-1 as @e[distance=..0.5,tag=hostile,tag=!balloon_bomb,type=!minecraft:item] run data merge entity @s {AbsorptionAmount:0f}