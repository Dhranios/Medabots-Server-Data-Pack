execute as @a[distance=..0.5,tag=hostile,tag=!had_death] run tellraw @a {"translate":"medabots_server:death.balloon_bomb","with":[{"selector":"@s"},{"translate":"medabots_server:entity.balloon_bomb"}]}
