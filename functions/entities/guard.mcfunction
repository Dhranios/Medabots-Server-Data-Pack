...
execute if entity @s[scores={Time=0}] positioned ^ ^ ^1 if entity @a[tag=hostile,distance=..1.05,tag=!enemy_medabot] run function medabots_server:entities/guard/attack

# Walk to target or random location
execute if entity @s[scores={Time=0}] run function medabots_server:entities/guard/wander
