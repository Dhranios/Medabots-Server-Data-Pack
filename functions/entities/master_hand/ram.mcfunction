...
execute store result entity @s[scores={Time=20}] Pos[1] double 1 run scoreboard players get @s HomeY
...
tag @s[scores={Time=100}] remove ram
tag @s[scores={Time=100}] add idle
tag @s[scores={Time=100}] remove has_target
tag @s[scores={Time=100}] remove attack_ram
