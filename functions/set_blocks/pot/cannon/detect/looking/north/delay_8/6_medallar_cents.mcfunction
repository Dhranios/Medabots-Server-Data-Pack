summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.pot"}',Tags:["pot","cannon","delay_8","detect","looking","north","6_medallar_cents"],Duration:2147483647}
