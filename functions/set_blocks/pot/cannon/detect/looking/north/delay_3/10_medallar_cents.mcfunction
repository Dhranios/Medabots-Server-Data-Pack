summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.pot"}',Tags:["pot","cannon","delay_3","detect","looking","north","10_medallar_cents"],Duration:2147483647}
