summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.pot"}',Tags:["pot","cannon","delay_8","detect","looking","south","10_medallar_cents"],Duration:2147483647}
