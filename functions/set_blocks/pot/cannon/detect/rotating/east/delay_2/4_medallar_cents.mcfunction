summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.pot"}',Tags:["pot","cannon","delay_2","detect","rotating","east","4_medallar_cents"],Duration:2147483647}
