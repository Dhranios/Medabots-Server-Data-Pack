summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.door"}',Tags:["door","west"],Duration:2147483647}
...
fill ~ ~2 ~ ~ ~3 ~1 minecraft:barrier replace minecraft:air