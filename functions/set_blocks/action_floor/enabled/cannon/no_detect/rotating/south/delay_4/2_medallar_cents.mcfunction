summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.action_floor"}',Tags:["action_floor","cannon","delay_4","rotating","south","2_medallar_cents","enabled"],Duration:2147483647}
