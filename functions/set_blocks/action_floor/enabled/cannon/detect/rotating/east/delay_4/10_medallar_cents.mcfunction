summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.action_floor"}',Tags:["action_floor","enabled","cannon","delay_4","detect","rotating","east","10_medallar_cents"],Duration:2147483647}
