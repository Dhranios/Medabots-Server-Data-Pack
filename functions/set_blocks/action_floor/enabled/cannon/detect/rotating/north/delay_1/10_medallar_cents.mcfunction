summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.action_floor"}',Tags:["action_floor","enabled","cannon","delay_1","detect","rotating","north","10_medallar_cents"],Duration:2147483647}
