summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.action_floor"}',Tags:["action_floor","enabled","cannon","delay_2","detect","looking","east","2_medallar_cents"],Duration:2147483647}
