summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.action_floor"}',Tags:["action_floor","guard","slow","6_medallar_cents","enabled"],Duration:2147483647}
