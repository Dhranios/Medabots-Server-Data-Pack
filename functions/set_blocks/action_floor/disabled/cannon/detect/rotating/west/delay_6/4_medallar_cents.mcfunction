summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'{"translate":"medabots_server:block.action_floor"}',Tags:["action_floor","cannon","delay_6","detect","rotating","west","4_medallar_cents"],Duration:2147483647}
