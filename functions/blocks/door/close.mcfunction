execute if block ~ ~ ~ minecraft:iron_door[facing=west] run setblock ~ ~ ~ minecraft:structure_block[mode=load]{rotation:"COUNTERCLOCKWISE_90",name:"medabots_server:stage/door",mode:"LOAD"}
execute if block ~ ~ ~ minecraft:iron_door[facing=south] run setblock ~ ~ ~ minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_180",name:"medabots_server:stage/door",mode:"LOAD"}
execute if block ~ ~ ~ minecraft:iron_door[facing=north] run setblock ~ ~ ~ minecraft:structure_block[mode=load]{name:"medabots_server:stage/door",mode:"LOAD"}
execute if block ~ ~ ~ minecraft:iron_door[facing=east] run setblock ~ ~ ~ minecraft:structure_block[mode=load]{rotation:"CLOCKWISE_90",name:"medabots_server:stage/door",mode:"LOAD"}
