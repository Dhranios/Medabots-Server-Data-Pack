...
execute if entity @s[tag=east] if block ~1 ~-1 ~ minecraft:black_glazed_terracotta[facing=north] run tag @s add black_glazed_terracotta_north_1
execute if entity @s[tag=east] if block ~1 ~-1 ~ minecraft:black_glazed_terracotta[facing=south] run tag @s add black_glazed_terracotta_south_1
execute if entity @s[tag=east] if block ~1 ~-1 ~ minecraft:black_glazed_terracotta[facing=east] run tag @s add black_glazed_terracotta_east_1
execute if entity @s[tag=east] if block ~1 ~-1 ~ minecraft:black_glazed_terracotta[facing=west] run tag @s add black_glazed_terracotta_west_1
...
execute if entity @s[tag=west] if block ~-1 ~-1 ~ minecraft:black_glazed_terracotta[facing=north] run tag @s add black_glazed_terracotta_north_1
execute if entity @s[tag=west] if block ~-1 ~-1 ~ minecraft:black_glazed_terracotta[facing=south] run tag @s add black_glazed_terracotta_south_1
execute if entity @s[tag=west] if block ~-1 ~-1 ~ minecraft:black_glazed_terracotta[facing=east] run tag @s add black_glazed_terracotta_east_1
execute if entity @s[tag=west] if block ~-1 ~-1 ~ minecraft:black_glazed_terracotta[facing=west] run tag @s add black_glazed_terracotta_west_1
...
execute if entity @s[tag=north] if block ~ ~-1 ~-1 minecraft:black_glazed_terracotta[facing=north] run tag @s add black_glazed_terracotta_north_1
execute if entity @s[tag=north] if block ~ ~-1 ~-1 minecraft:black_glazed_terracotta[facing=south] run tag @s add black_glazed_terracotta_south_1
execute if entity @s[tag=north] if block ~ ~-1 ~-1 minecraft:black_glazed_terracotta[facing=east] run tag @s add black_glazed_terracotta_east_1
execute if entity @s[tag=north] if block ~ ~-1 ~-1 minecraft:black_glazed_terracotta[facing=west] run tag @s add black_glazed_terracotta_west_1
...
execute if entity @s[tag=south] if block ~ ~-1 ~1 minecraft:black_glazed_terracotta[facing=north] run tag @s add black_glazed_terracotta_north_1
execute if entity @s[tag=south] if block ~ ~-1 ~1 minecraft:black_glazed_terracotta[facing=south] run tag @s add black_glazed_terracotta_south_1
execute if entity @s[tag=south] if block ~ ~-1 ~1 minecraft:black_glazed_terracotta[facing=east] run tag @s add black_glazed_terracotta_east_1
execute if entity @s[tag=south] if block ~ ~-1 ~1 minecraft:black_glazed_terracotta[facing=west] run tag @s add black_glazed_terracotta_west_1
# Delete this
