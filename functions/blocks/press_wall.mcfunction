...
execute if entity @s[tag=north,tag=extend] run function medabots_server:blocks/press_wall/extend/north
execute if entity @s[tag=south,tag=extend] run function medabots_server:blocks/press_wall/extend/south
execute if entity @s[tag=east,tag=extend] run function medabots_server:blocks/press_wall/extend/east
execute if entity @s[tag=west,tag=extend] run function medabots_server:blocks/press_wall/extend/west
execute if entity @s[tag=north,tag=retract] run function medabots_server:blocks/press_wall/retract/north
execute if entity @s[tag=south,tag=retract] run function medabots_server:blocks/press_wall/retract/south
execute if entity @s[tag=east,tag=retract] run function medabots_server:blocks/press_wall/retract/east
execute if entity @s[tag=west,tag=retract] run function medabots_server:blocks/press_wall/retract/west
