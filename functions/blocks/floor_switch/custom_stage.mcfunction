...
execute if entity @s[scores={FloorSwitchTime=1..},tag=!negative] at @e[tag=me,limit=1] run tag @e[tag=!fan,tag=!door,distance=..0.7,tag=!enabled] add enabled
execute if entity @s[scores={FloorSwitchTime=1..},tag=!negative] at @e[tag=me,limit=1] run tag @e[tag=door,distance=..0.7,tag=!open] add open
...
execute if entity @s[scores={FloorSwitchTime=..0},tag=negative] at @e[tag=me,limit=1] run tag @e[tag=!fan,tag=!door,distance=..0.7,tag=!enabled] add enabled
execute if entity @s[scores={FloorSwitchTime=..0},tag=negative] at @e[tag=me,limit=1] run tag @e[tag=door,distance=..0.7,tag=!open] add open
...
execute if entity @s[scores={FloorSwitchTime=..0},tag=!negative] at @e[tag=me,limit=1] run tag @e[tag=!fan,tag=!door,distance=..0.7,tag=enabled] remove enabled
execute if entity @s[scores={FloorSwitchTime=..0},tag=!negative] at @e[tag=me,limit=1] run tag @e[tag=door,distance=..0.7,tag=open] remove open
...
execute if entity @s[scores={FloorSwitchTime=1..},tag=negative] at @e[tag=me,limit=1] run tag @e[tag=!fan,tag=!door,distance=..0.7,tag=enabled] remove enabled
execute if entity @s[scores={FloorSwitchTime=1..},tag=negative] at @e[tag=me,limit=1] run tag @e[tag=door,distance=..0.7,tag=open] remove open
