...
execute if entity @s[tag=!slow,tag=!fast,tag=!20_medallar_cents,tag=!10_medallar_cents,tag=!6_medallar_cents,tag=!4_medallar_cents,tag=!2_medallar_cents,tag=!1_medallar_cent] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal
execute if entity @s[tag=!slow,tag=!fast,tag=1_medallar_cent] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal/1_medallar_cent
execute if entity @s[tag=!slow,tag=!fast,tag=2_medallar_cents] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal/2_medallar_cents
execute if entity @s[tag=!slow,tag=!fast,tag=4_medallar_cents] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal/4_medallar_cents
execute if entity @s[tag=!slow,tag=!fast,tag=6_medallar_cents] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal/6_medallar_cents
execute if entity @s[tag=!slow,tag=!fast,tag=10_medallar_cents] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal/10_medallar_cents
execute if entity @s[tag=!slow,tag=!fast,tag=20_medallar_cents] positioned ~ ~-1.3999 ~ run function medabots_server:spawn_entities/guard/normal/20_medallar_cents
