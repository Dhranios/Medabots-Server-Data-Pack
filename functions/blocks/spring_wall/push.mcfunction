...
execute if block ~ ~ ~ minecraft:piston[facing=east] positioned ~1 ~-0.3 ~ run teleport @e[tag=round_stone,type=minecraft:area_effect_cloud,distance=..1] ~1 ~ ~
execute if block ~ ~ ~ minecraft:piston[facing=east] positioned ~1 ~-0.3 ~ run teleport @e[tag=ice_block,type=minecraft:area_effect_cloud,distance=..1] ~1 ~ ~
execute if block ~ ~ ~ minecraft:piston[facing=south] positioned ~ ~-0.3 ~1 run teleport @e[tag=round_stone,type=minecraft:area_effect_cloud,distance=..1] ~ ~ ~1
execute if block ~ ~ ~ minecraft:piston[facing=south] positioned ~ ~-0.3 ~1 run teleport @e[tag=ice_block,type=minecraft:area_effect_cloud,distance=..1] ~ ~ ~1
execute if block ~ ~ ~ minecraft:piston[facing=west] positioned ~-1 ~-0.3 ~ run teleport @e[tag=round_stone,type=minecraft:area_effect_cloud,distance=..1] ~-1 ~ ~
execute if block ~ ~ ~ minecraft:piston[facing=west] positioned ~-1 ~-0.3 ~ run teleport @e[tag=ice_block,type=minecraft:area_effect_cloud,distance=..1] ~-1 ~ ~
execute if block ~ ~ ~ minecraft:piston[facing=north] positioned ~ ~-0.3 ~-1 run teleport @e[tag=round_stone,type=minecraft:area_effect_cloud,distance=..1] ~ ~ ~-1
execute if block ~ ~ ~ minecraft:piston[facing=north] positioned ~ ~-0.3 ~-1 run teleport @e[tag=ice_block,type=minecraft:area_effect_cloud,distance=..1] ~ ~ ~-1
