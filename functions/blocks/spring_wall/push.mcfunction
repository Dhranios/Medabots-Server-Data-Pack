...
execute if block ~ ~ ~ minecraft:piston[facing=east] positioned ~1 ~-0.3 ~ run scoreboard players set @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] Moving 1
...
execute if block ~ ~ ~ minecraft:piston[facing=south] positioned ~ ~-0.3 ~1 run scoreboard players set @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] Moving 2
...
execute if block ~ ~ ~ minecraft:piston[facing=west] positioned ~-1 ~-0.3 ~ run scoreboard players set @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] Moving 3
...
execute if block ~ ~ ~ minecraft:piston[facing=north] positioned ~ ~-0.3 ~-1 run scoreboard players set @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] Moving 4
execute if block ~ ~ ~ minecraft:piston[facing=east] positioned ~1 ~-0.3 ~ run tag @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] add spring_wall_pushed
execute if block ~ ~ ~ minecraft:piston[facing=south] positioned ~ ~-0.3 ~1 run tag @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] add spring_wall_pushed
execute if block ~ ~ ~ minecraft:piston[facing=west] positioned ~-1 ~-0.3 ~ run tag @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] add spring_wall_pushed
execute if block ~ ~ ~ minecraft:piston[facing=north] positioned ~ ~-0.3 ~-1 run tag @e[tag=bomb,type=minecraft:area_effect_cloud,distance=..1] add spring_wall_pushed
