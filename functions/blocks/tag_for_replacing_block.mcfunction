...
execute if block ~ ~-1 ~ minecraft:smooth_stone_slab[type=double] run tag @s add double_smooth_stone_slab
...
execute if block ~ ~-1 ~ minecraft:black_glazed_terracotta[facing=north] run tag @s add north_black_glazed_terracotta
