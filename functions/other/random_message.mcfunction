...
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=1] run tellraw @a {"translate":"medabots_server:message.random.1","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=2] run tellraw @a {"translate":"medabots_server:message.random.2","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=3] run tellraw @a {"translate":"medabots_server:message.random.3","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=4] run tellraw @a {"translate":"medabots_server:message.random.4","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=5] run tellraw @a {"translate":"medabots_server:message.random.5","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=6] run tellraw @a {"translate":"medabots_server:message.random.6","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=7] run tellraw @a {"translate":"medabots_server:message.random.7","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=8] run tellraw @a {"translate":"medabots_server:message.random.8","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=9] run tellraw @a {"translate":"medabots_server:message.random.9","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=10] run tellraw @a {"translate":"medabots_server:message.random.10","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=11] run tellraw @a {"translate":"medabots_server:message.random.11","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=12] run tellraw @a {"translate":"medabots_server:message.random.12","color":"gold"}
execute as @e[type=minecraft:area_effect_cloud,scores={RandomMessage=1},tag=13] run tellraw @a {"translate":"medabots_server:message.random.13","color":"gold"}
