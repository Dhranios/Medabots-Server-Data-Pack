...
# Moderators
execute if entity @s[scores={TaskCheck=5}] run tellraw @a[team=Moderator] {"translate":"medabots_server:message.pending_tasks.done","with":[{"selector":"@s"},"Palace of Twilight needs building."]}
execute if entity @s[scores={TaskCheck=5}] run data merge block -292 18 -60 {auto:0b}
execute if entity @s[scores={TaskCheck=6}] run tellraw @a[team=Moderator] {"translate":"medabots_server:message.pending_tasks.done","with":[{"selector":"@s"},"Mt. Battle's mountain look needs (a lot of) work."]}
...
execute if entity @s[scores={TaskCheck=9}] run tellraw @a[team=Moderator] {"translate":"medabots_server:message.pending_tasks.done","with":[{"selector":"@s"},"Re-create Ricco Harbor."]}
...
execute if entity @s[scores={TaskCheck=16}] run tellraw @a[team=Moderator] {"translate":"medabots_server:message.pending_tasks.done","with":[{"selector":"@s"},"A list of all enemy medabots' medals needs to be shared."]}
