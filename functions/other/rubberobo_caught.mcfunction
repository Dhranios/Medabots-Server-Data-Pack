...
execute if entity @s[tag=drop_money] run playsound medabots_server:entity.rubberobo.death neutral @a ~ ~ ~ 1
...
execute at @s[tag=drop_money] run playsound medabots_server:entity.rubberobo.respawn neutral @a ~ ~ ~ 1