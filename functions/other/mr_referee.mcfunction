...
execute if entity @s[scores={Dialog=2}] run stopsound @a[tag=waiting_for_referee] music
execute if entity @s[scores={Dialog=2}] run playsound medabots_server:music.entity.mr_referee music @a[tag=waiting_for_referee] ~ ~ ~ 5
execute if entity @s[scores={Dialog=2}] run scoreboard players set @a[tag=waiting_for_referee] Music 193
...
execute if entity @s[scores={Dialog=194}] as @a[tag=hostile,tag=!dead,scores={Battle=2}] if score @s Stage = @e[distance=..0.1,limit=1] Stage run stopsound @s music medabots_server:music.entity.mr_referee
execute if entity @s[scores={Dialog=193}] as @e[tag=hostile,tag=!dead,scores={Battle=2}] unless entity @s[type=!minecraft:player,type=!minecraft:skeleton] if score @s Stage = @e[distance=..0.1,limit=1] Stage run scoreboard players set @s Battle 1
...
scoreboard players set @s[scores={Dialog=194}] RobattleMusic 0
